...
function Yv() {
    ...
    return Qo.Fragment = t, Qo.jsx = l, Qo.jsxs = l, Qo
}
var zp;

function Jv() {
    return zp || (zp = 1, iu.exports = Yv()), iu.exports
}
var B = Jv(),
    ou = {
        exports: {}
...
function Xv() {
    ...
    function P(M, z, Y) {
        this.props = M, this.context = z, this.refs = b, this.updater = Y || U
    }
    P.prototype.isReactComponent = {}, P.prototype.setState = function(M, z) {
    ...
    var K = k.prototype = new X;
    K.constructor = k, H(K, P.prototype), K.isPureReactComponent = !0;
    ...
    function Be(M, z) {
        return typeof M == "object" && M !== null && M.key != null ? Ge("" + M.key) : z.toString(36)
    }
    ...
    function st(M) {
        switch (M.status) {
            ...
            case "rejected":
                throw M.reason;
            default:
                switch (typeof M.status == "string" ? M.then(te, te) : (M.status = "pending", M.then(function(z) {
            ...
            case "object":
                switch (M.$$typeof) {
                    ...
                    case t:
                        ...
                        break;
                    case v:
                        return _e = M._init, L(_e(M._payload), z, Y, Z, ae)
                }
        }
        if (_e) return ae = ae(M), _e = Z === "" ? "." + Be(M, 0) : Z, ee(ae) ? (Y = "", _e != null && (Y = _e.replace(Ee, "$&/") + "/"), L(ae, z, Y, "", function(to) {
            return to
        })) : ae != null && (Ce(ae) && (ae = de(ae, Y + (ae.key == null || M && M.key === ae.key ? "" : ("" + ae.key).replace(Ee, "$&/") + "/") + _e)), z.push(ae)), 1;
        _e = 0;
        var it = Z === "" ? "." : Z + ":";
        if (ee(M))
            for (var Ve = 0; Ve < M.length; Ve++) Z = M[Ve], ue = it + Be(Z, Ve), _e += L(Z, z, Y, ue, ae);
        else if (Ve = C(M), typeof Ve == "function")
            for (M = Ve.call(M), Ve = 0; !(Z = M.next()).done;) Z = Z.value, ue = it + Be(Z, Ve++), _e += L(Z, z, Y, ue, ae);
        else if (ue === "object") {
            if (typeof M.then == "function") return L(st(M), z, Y, Z, ae);
    ...
    function O(M, z, Y) {
        ...
        var Z = [],
            ae = 0;
        return L(M, Z, "", "", function(ue) {
            return z.call(Y, ue, ae++)
        }), Z
    }
    ...
    return le.Activity = S, le.Children = xe, le.Component = P, le.Fragment = l, le.Profiler = u, le.PureComponent = k, le.StrictMode = a, le.Suspense = y, le.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = F, le.__COMPILER_RUNTIME = {
        __proto__: null,
        c: function(M) {
        ...
        return null
    }, le.cloneElement = function(M, z, Y) {
        if (M == null) throw Error("The argument must be a React element, but you passed " + M + ".");
        var Z = H({}, M.props),
            ae = M.key;
        if (z != null)
            for (ue in z.key !== void 0 && (ae = "" + z.key), z) !he.call(z, ue) || ue === "key" || ue === "__self" || ue === "__source" || ue === "ref" && z.ref === void 0 || (Z[ue] = z[ue]);
        var ue = arguments.length - 2;
        if (ue === 1) Z.children = Y;
        else if (1 < ue) {
            for (var _e = Array(ue), it = 0; it < ue; it++) _e[it] = arguments[it + 2];
            Z.children = _e
        }
    ...
    }, le.createElement = function(M, z, Y) {
        var Z, ae = {},
            ue = null;
        if (z != null)
            for (Z in z.key !== void 0 && (ue = "" + z.key), z) he.call(z, Z) && Z !== "key" && Z !== "__self" && Z !== "__source" && (ae[Z] = z[Z]);
        var _e = arguments.length - 2;
        if (_e === 1) ae.children = Y;
        else if (1 < _e) {
            for (var it = Array(_e), Ve = 0; Ve < _e; Ve++) it[Ve] = arguments[Ve + 2];
            ae.children = it
        }
        if (M && M.defaultProps)
        ...
        try {
            ...
            z !== null && Y.types !== null && (z.types = Y.types), F.T = z
        }
    }, le.unstable_useCacheRefresh = function() {
        return F.H.useCacheRefresh()
    }, le.use = function(M) {
        return F.H.use(M)
    }, le.useActionState = function(M, z, Y) {
        return F.H.useActionState(M, z, Y)
    }, le.useCallback = function(M, z) {
        return F.H.useCallback(M, z)
    }, le.useContext = function(M) {
        return F.H.useContext(M)
    }, le.useDebugValue = function() {}, le.useDeferredValue = function(M, z) {
        return F.H.useDeferredValue(M, z)
    }, le.useEffect = function(M, z) {
        return F.H.useEffect(M, z)
    }, le.useEffectEvent = function(M) {
        return F.H.useEffectEvent(M)
    }, le.useId = function() {
        return F.H.useId()
    }, le.useImperativeHandle = function(M, z, Y) {
        return F.H.useImperativeHandle(M, z, Y)
    }, le.useInsertionEffect = function(M, z) {
        return F.H.useInsertionEffect(M, z)
    }, le.useLayoutEffect = function(M, z) {
        return F.H.useLayoutEffect(M, z)
    }, le.useMemo = function(M, z) {
        return F.H.useMemo(M, z)
    }, le.useOptimistic = function(M, z) {
        return F.H.useOptimistic(M, z)
    }, le.useReducer = function(M, z, Y) {
        return F.H.useReducer(M, z, Y)
    }, le.useRef = function(M) {
        return F.H.useRef(M)
    }, le.useState = function(M) {
        return F.H.useState(M)
    }, le.useSyncExternalStore = function(M, z, Y) {
        return F.H.useSyncExternalStore(M, z, Y)
...
function Ru() {
    return Bp || (Bp = 1, ou.exports = Xv()), ou.exports
}
var jo = Ru();
const Kv = Nh(jo);
var lu = {
    ...
    return kp || (kp = 1, (function(i) {
        function t(L, O) {
            ...
            e: for (; 0 < ie;) {
                var Me = ie - 1 >>> 1,
                    xe = L[Me];
                if (0 < u(xe, O)) L[Me] = O, L[ie] = xe, ie = Me;
                else break e
            }
        }
        ...
        function a(L) {
            ...
            if (ie !== O) {
                L[0] = ie;
                e: for (var Me = 0, xe = L.length, M = xe >>> 1; Me < M;) {
                    var z = 2 * (Me + 1) - 1,
                        Y = L[z],
                        Z = z + 1,
                        ae = L[Z];
                    if (0 > u(Y, ie)) Z < xe && 0 > u(ae, Y) ? (L[Me] = ae, L[Z] = ie, Me = Z) : (L[Me] = Y, L[z] = ie, Me = z);
                    else if (Z < xe && 0 > u(ae, ie)) L[Me] = ae, L[Z] = ie, Me = Z;
                    else break e
                }
            }
            return O
        ...
        function u(L, O) {
            var ie = L.sortIndex - O.sortIndex;
            return ie !== 0 ? ie : L.id - O.id
        }
        ...
        function K(L) {
            for (var O = l(h); O !== null;) {
                ...
                else if (O.startTime <= L) a(h), O.sortIndex = O.expirationTime, t(y, O);
                else break;
                O = l(h)
            }
        }
        ...
        function ee(L) {
            if (H = !1, K(L), !U)
                if (l(y) !== null) U = !0, te || (te = !0, Ge());
                else {
                    var O = l(h);
                    O !== null && st(ee, O.startTime - L)
                }
        }
        var te = !1,
            F = -1,
        ...
        function de() {
            return b ? !0 : !(i.unstable_now() - W < he)
        }
            ...
            if (b = !1, te) {
                ...
                try {
                    e: {
                        ...
                        try {
                            t: {
                                for (K(L), S = l(y); S !== null && !(S.expirationTime > L && de());) {
                                    var Me = S.callback;
                                    if (typeof Me == "function") {
                                        S.callback = null, E = S.priorityLevel;
                                        var xe = Me(S.expirationTime <= L);
                                        if (L = i.unstable_now(), typeof xe == "function") {
                                            S.callback = xe, K(L), O = !0;
                                            break t
                                        }
                                        S === l(y) && a(y), K(L)
                                    } else a(y);
                                ...
                                if (S !== null) O = !0;
                                    ...
                                    var M = l(h);
                                    M !== null && st(ee, M.startTime - L), O = !1
                                }
                            }
                            break e
                        }
        ...
        i.unstable_IdlePriority = 5, i.unstable_ImmediatePriority = 1, i.unstable_LowPriority = 4, i.unstable_NormalPriority = 3, i.unstable_Profiling = null, i.unstable_UserBlockingPriority = 2, i.unstable_cancelCallback = function(L) {
            ...
            0 > L || 125 < L ? console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported") : he = 0 < L ? Math.floor(1e3 / L) : 5
            ...
            b = !0
        }, i.unstable_runWithPriority = function(L, O) {
            switch (L) {
                case 1:
                case 2:
                case 3:
        ...
        }, i.unstable_scheduleCallback = function(L, O, ie) {
            var Me = i.unstable_now();
            switch (typeof ie == "object" && ie !== null ? (ie = ie.delay, ie = typeof ie == "number" && 0 < ie ? Me + ie : Me) : ie = Me, L) {
                case 1:
                    var xe = -1;
                    break;
                case 2:
            ...
            return xe = ie + xe, L = {
                ...
                expirationTime: xe,
                sortIndex: -1
            }, ie > Me ? (L.sortIndex = ie, t(h, L), l(y) === null && L === l(h) && (H ? (X(F), F = -1) : H = !0, st(ee, ie - Me))) : (L.sortIndex = xe, t(y, L), U || C || (U = !0, te || (te = !0, Ge()))), L
        }, i.unstable_shouldYield = de, i.unstable_wrapCallback = function(L) {
            var O = E;
            return function() {
                var ie = E;
                E = O;
...
function Zv() {
    return Op || (Op = 1, au.exports = Qv()), au.exports
}
var ru = {
        exports: {}
    },
...
function $v() {
    ...
    return tt.__DOM_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = a, tt.createPortal = function(y, h) {
...
function Wv() {
    ...
    return i(), ru.exports = $v(), ru.exports
}
/**
 * @license React
...
function jv() {
    ...
    function Y(e, n) {
        xe++, Me[xe] = e.current, e.current = n
    }
    var Z = M(null),
        ae = M(null),
        ue = M(null),
    ...
    function it(e, n) {
        switch (Y(ue, n), Y(ae, e), Y(Z, null), n.nodeType) {
            case 9:
            case 11:
                e = (e = n.documentElement) && (e = e.namespaceURI) ? sp(e) : 0;
                break;
            default:
                if (e = n.tagName, n = n.namespaceURI) n = sp(n), e = rp(n, e);
                else switch (e) {
                    case "svg":
                        e = 1;
                        break;
    ...
    function tl(e) {
        ae.current === e && (z(Z), z(ae)), _e.current === e && (z(_e), Yo._currentValue = ie)
    }
    var za, Hu;
            ...
            var s = {
                DetermineComponentFrameRoot: function() {
                    try {
                        ...
                        if (w && x && typeof w.stack == "string") return [w.stack, x.stack]
                    }
                    return [null, null]
                }
            };
...
` + A[s].replace(" at new ", " at ");
            ...
            Pa = !1, Error.prepareStackTrace = o
        }
        return (o = e ? e.displayName || e.name : "") ? kn(o) : ""
    }
    ...
    function _g(e, n) {
        switch (e.tag) {
            ...
            case 16:
                return kn("Lazy");
            case 13:
                return e.child !== n && n !== null ? kn("Suspense Fallback") : kn("Suspense");
            case 19:
    ...
    function qu(e) {
        try {
            var n = "",
                o = null;
            do n += _g(e, o), o = e, e = e.return; while (e);
            return n
        } catch (s) {
            return `
...
` + s.stack
    ...
    var ka = Object.prototype.hasOwnProperty,
        ...
        Fa = i.unstable_cancelCallback,
        Cg = i.unstable_shouldYield,
        Ag = i.unstable_requestPaint,
        ht = i.unstable_now,
        Rg = i.unstable_getCurrentPriorityLevel,
        Vu = i.unstable_ImmediatePriority,
        zu = i.unstable_UserBlockingPriority,
        nl = i.unstable_NormalPriority,
        Mg = i.unstable_LowPriority,
        Pu = i.unstable_IdlePriority,
        Ng = i.log,
        Ig = i.unstable_setDisableYieldValue,
        no = null,
        gt = null;

    function hn(e) {
        if (typeof Ng == "function" && Ig(e), gt && typeof gt.setStrictMode == "function") try {
            gt.setStrictMode(no, e)
        } catch {}
    }
    var yt = Math.clz32 ? Math.clz32 : Ug,
        Dg = Math.log,
        xg = Math.LN2;

    function Ug(e) {
        return e >>>= 0, e === 0 ? 32 : 31 - (Dg(e) / xg | 0) | 0
    }
    var il = 256,
        ol = 262144,
        ll = 4194304;
    ...
    function al(e, n, o) {
        ...
        e = e.warmLanes;
        var _ = s & 134217727;
        return _ !== 0 ? (s = _ & ~p, s !== 0 ? d = On(s) : (T &= _, T !== 0 ? d = On(T) : o || (o = _ & ~e, o !== 0 && (d = On(o))))) : (_ = s & ~p, _ !== 0 ? d = On(_) : T !== 0 ? d = On(T) : o || (o = s & ~e, o !== 0 && (d = On(o)))), d === 0 ? 0 : n !== 0 && n !== d && (n & p) === 0 && (p = d & -d, o = n & -n, p >= o || p === 32 && (o & 4194048) !== 0) ? n : d
    }
    ...
    function bg(e, n, o, s, d, p) {
        ...
        for (o = T & ~o; 0 < o;) {
            ...
            var x = D[G];
            if (x !== null)
                for (D[G] = null, G = 0; G < x.length; G++) {
                    var w = x[G];
                    w !== null && (w.lane &= -536870913)
                }
            o &= ~V
        }
        s !== 0 && ku(e, s, 0), p !== 0 && d === 0 && e.tag !== 0 && (e.suspendedLanes |= p & ~(T & ~n))
    }
    ...
    function Fu(e, n) {
        var o = n & -n;
        return o = (o & 42) !== 0 ? 1 : Ja(o), (o & (e.suspendedLanes | n)) !== 0 ? 0 : o
    }
    ...
    var gn = Math.random().toString(36).slice(2),
        Ze = "__reactFiber$" + gn,
        rt = "__reactProps$" + gn,
        ui = "__reactContainer$" + gn,
        Ka = "__reactEvents$" + gn,
        Lg = "__reactListeners$" + gn,
        Gg = "__reactHandles$" + gn,
        Xu = "__reactResources$" + gn,
        lo = "__reactMarker$" + gn;

    function Qa(e) {
        delete e[Ze], delete e[rt], delete e[Ka], delete e[Lg], delete e[Gg]
    }
    ...
    function Fn(e, n) {
        pi(e, n), pi(e + "Capture", n)
    }

    function pi(e, n) {
        for (Qu[e] = n, e = 0; e < n.length; e++) Ku.add(n[e])
    }
    ...
    function qg(e) {
        return ka.call($u, e) ? !0 : ka.call(Zu, e) ? !1 : Hg.test(e) ? $u[e] = !0 : (Zu[e] = !0, !1)
    }
    ...
    function ju(e) {
        ...
        var o = n.getValue(),
            s = "";
        return e && (s = Wu(e) ? e.checked ? "true" : "false" : e.value), e = s, e !== o ? (n.setValue(e), !0) : !1
    }
    ...
    function Mt(e) {
        return e.replace(zg, function(n) {
            return "\\" + n.charCodeAt(0).toString(16) + " "
        })
    }

    function $a(e, n, o, s, d, p, T, _) {
        e.name = "", T != null && typeof T != "function" && typeof T != "symbol" && typeof T != "boolean" ? e.type = T : e.removeAttribute("type"), n != null ? T === "number" ? (n === 0 && e.value === "" || e.value != n) && (e.value = "" + Rt(n)) : e.value !== "" + Rt(n) && (e.value = "" + Rt(n)) : T !== "submit" && T !== "reset" || e.removeAttribute("value"), n != null ? Wa(e, T, Rt(n)) : o != null ? Wa(e, T, Rt(o)) : s != null && e.removeAttribute("value"), d == null && p != null && (e.defaultChecked = !!p), d != null && (e.checked = d && typeof d != "function" && typeof d != "symbol"), _ != null && typeof _ != "function" && typeof _ != "symbol" && typeof _ != "boolean" ? e.name = "" + Rt(_) : e.removeAttribute("name")
    }

    function ec(e, n, o, s, d, p, T, _) {
        if (p != null && typeof p != "function" && typeof p != "symbol" && typeof p != "boolean" && (e.type = p), n != null || o != null) {
            if (!(p !== "submit" && p !== "reset" || n != null)) {
                Za(e);
                return
            }
            o = o != null ? "" + Rt(o) : "", n = n != null ? "" + Rt(n) : o, _ || n === e.value || (e.value = n), e.defaultValue = n
        }
        s = s ?? d, s = typeof s != "function" && typeof s != "symbol" && !!s, e.checked = _ ? e.checked : !!s, e.defaultChecked = !!s, T != null && typeof T != "function" && typeof T != "symbol" && typeof T != "boolean" && (e.name = T), Za(e)
    }

    function Wa(e, n, o) {
        n === "number" && ul(e.ownerDocument) === e || e.defaultValue === "" + o || (e.defaultValue = "" + o)
    }
    ...
    function tc(e, n, o) {
        if (n != null && (n = "" + Rt(n), n !== e.value && (e.value = n), o == null)) {
    ...
    function nc(e, n, o, s) {
        ...
        o = Rt(n), e.defaultValue = o, s = e.textContent, s === o && s !== "" && s !== null && (e.value = s), Za(e)
    }
    ...
    function ic(e, n, o) {
        var s = n.indexOf("--") === 0;
        o == null || typeof o == "boolean" || o === "" ? s ? e.setProperty(n, "") : n === "float" ? e.cssFloat = "" : e[n] = "" : s ? e.setProperty(n, o) : typeof o != "number" || o === 0 || Pg.has(n) ? n === "float" ? e.cssFloat = o : e[n] = ("" + o).trim() : e[n] = o + "px"
    }
    ...
    function oc(e, n, o) {
        ...
        if (e = e.style, o != null) {
            ...
            for (var d in n) s = n[d], n.hasOwnProperty(d) && o[d] !== s && ic(e, d, s)
        } else
            for (var p in n) n.hasOwnProperty(p) && ic(e, p, n[p])
    }
    ...
    function lc(e) {
        ...
        if (n && (e = n.stateNode)) {
            ...
            e: switch (e = n.stateNode, n.type) {
                case "input":
                    if ($a(e, o.value, o.defaultValue, o.defaultValue, o.checked, o.defaultChecked, o.type, o.name), n = o.name, o.type === "radio" && n != null) {
                        for (o = e; o.parentNode;) o = o.parentNode;
                        for (o = o.querySelectorAll('input[name="' + Mt("" + n) + '"][type="radio"]'), n = 0; n < o.length; n++) {
                            var s = o[n];
                            if (s !== e && s.form === e.form) {
                                var d = s[rt] || null;
                                if (!d) throw Error(a(90));
                                $a(s, d.value, d.defaultValue, d.defaultValue, d.checked, d.defaultChecked, d.type, d.name)
                            }
                        }
                        for (n = 0; n < o.length; n++) s = o[n], s.form === e.form && ju(s)
                    }
                    break e;
                case "textarea":
                    tc(e, o.value, o.defaultValue);
                    break e;
                case "select":
                    n = o.value, n != null && mi(e, !!o.multiple, n, !1)
            }
        }
    }
    var ns = !1;
    ...
    function ac(e, n, o) {
        ...
        try {
            ...
            if (ns = !1, (gi !== null || yi !== null) && ($l(), gi && (n = gi, e = yi, yi = gi = null, lc(n), e)))
                for (n = 0; n < e.length; n++) lc(e[n])
        }
    }
    ...
    function sc() {
        ...
        var e, n = os,
            o = n.length,
            s, d = "value" in yn ? yn.value : yn.textContent,
            p = d.length;
        for (e = 0; e < o && n[e] === d[e]; e++);
        var T = o - e;
        for (s = 1; s <= T && n[o - s] === d[p - s]; s++);
        return fl = d.slice(e, 1 < s ? 1 - s : void 0)
    }
    ...
    function ut(e) {
        function n(o, s, d, p, T) {
            ...
            return this.isDefaultPrevented = (p.defaultPrevented != null ? p.defaultPrevented : p.returnValue === !1) ? pl : rc, this.isPropagationStopped = rc, this
        }
        return S(n.prototype, {
            preventDefault: function() {
                this.defaultPrevented = !0;
                var o = this.nativeEvent;
                o && (o.preventDefault ? o.preventDefault() : typeof o.returnValue != "unknown" && (o.returnValue = !1), this.isDefaultPrevented = pl)
            },
            stopPropagation: function() {
                var o = this.nativeEvent;
                o && (o.stopPropagation ? o.stopPropagation() : typeof o.cancelBubble != "unknown" && (o.cancelBubble = !0), this.isPropagationStopped = pl)
            },
            persist: function() {},
            isPersistent: pl
        }), n
    ...
    var Yn = {
        ...
        ls, as, co, hl = S({}, uo, {
            ...
            movementX: function(e) {
                return "movementX" in e ? e.movementX : (e !== co && (co && e.type === "mousemove" ? (ls = e.screenX - co.screenX, as = e.screenY - co.screenY) : as = ls = 0, co = e), ls)
            },
    ...
    function ty(e) {
        ...
        return n.getModifierState ? n.getModifierState(e) : (e = ey[e]) ? !!n[e] : !1
    }
    ...
    var ny = S({}, uo, {
            key: function(e) {
                ...
                return e.type === "keypress" ? (e = dl(e), e === 13 ? "Enter" : String.fromCharCode(e)) : e.type === "keydown" || e.type === "keyup" ? jg[e.keyCode] || "Unidentified" : ""
            },
            code: 0,
            location: 0,
            ctrlKey: 0,
        ...
        dy = ut(fy),
        py = [9, 13, 27, 32],
        us = Qt && "CompositionEvent" in window,
        fo = null;
    Qt && "documentMode" in document && (fo = document.documentMode);
    var my = Qt && "TextEvent" in window && !fo,
        dc = Qt && (!us || fo && 8 < fo && 11 >= fo),
        pc = " ",
        mc = !1;
    ...
    function hy(e, n) {
        switch (e) {
            case "compositionend":
                return gc(n);
            case "keypress":
                return n.which !== 32 ? null : (mc = !0, pc);
            case "textInput":
                return e = n.data, e === pc && mc ? null : e;
            default:
                return null
        }
    }
    ...
    function gy(e, n) {
        if (vi) return e === "compositionend" || !us && hc(e, n) ? (e = sc(), fl = os = yn = null, vi = !1, e) : null;
        switch (e) {
            case "paste":
                return null;
            case "keypress":
                ...
                return null;
            case "compositionend":
                return dc && n.locale !== "ko" ? null : n.data;
            default:
                return null
        }
    }
    ...
    function vc(e, n, o, s) {
        gi ? yi ? yi.push(s) : yi = [s] : gi = s, n = oa(n, "onChange"), 0 < n.length && (o = new ml("onChange", "change", null, o, s), e.push({
            event: o,
            listeners: n
        }))
    }
    ...
    if (Qt) {
        ...
        if (Qt) {
            ...
            if (!fs) {
                ...
                Ec.setAttribute("oninput", "return;"), fs = typeof Ec.oninput == "function"
            }
            cs = fs
        } else cs = !1;
        Sc = cs && (!document.documentMode || 9 < document.documentMode)
    }

    function _c() {
        po && (po.detachEvent("onpropertychange", Cc), mo = po = null)
    }

    function Cc(e) {
        if (e.propertyName === "value" && gl(mo)) {
            var n = [];
            vc(n, mo, e, ts(e)), ac(vy, n)
        }
    }

    function Ty(e, n, o) {
        e === "focusin" ? (_c(), po = n, mo = o, po.attachEvent("onpropertychange", Cc)) : e === "focusout" && _c()
    }

    function Sy(e) {
        if (e === "selectionchange" || e === "keyup" || e === "keydown") return gl(mo)
    }
    ...
    var vt = typeof Object.is == "function" ? Object.is : Cy;
    ...
    function ho(e, n) {
        ...
        for (s = 0; s < o.length; s++) {
            var d = o[s];
            if (!ka.call(n, d) || !vt(e[d], n[d])) return !1
        }
        return !0
    }
    ...
    function Mc(e, n) {
        return e && n ? e === n ? !0 : e && e.nodeType === 3 ? !1 : n && n.nodeType === 3 ? Mc(e, n.parentNode) : "contains" in e ? e.contains(n) : e.compareDocumentPosition ? !!(e.compareDocumentPosition(n) & 16) : !1 : !1
    }

    function Nc(e) {
        e = e != null && e.ownerDocument != null && e.ownerDocument.defaultView != null ? e.ownerDocument.defaultView : window;
        for (var n = ul(e.document); n instanceof e.HTMLIFrameElement;) {
            try {
    ...
    var Ay = Qt && "documentMode" in document && 11 >= document.documentMode,
        Ti = null,
        ps = null,
        go = null,
        ms = !1;
    ...
    function Ic(e, n, o) {
        ...
        ms || Ti == null || Ti !== ul(s) || (s = Ti, "selectionStart" in s && ds(s) ? s = {
        ...
        }), go && ho(go, s) || (go = s, s = oa(ps, "onSelect"), 0 < s.length && (n = new ml("onSelect", "select", null, n, o), e.push({
            event: n,
            listeners: s
        }), n.target = Ti)))
    }
    ...
    var Si = {
        ...
        hs = {},
        Dc = {};
    Qt && (Dc = document.createElement("div").style, "AnimationEvent" in window || (delete Si.animationend.animation, delete Si.animationiteration.animation, delete Si.animationstart.animation), "TransitionEvent" in window || delete Si.transitionend.transition);
    ...
    function Xn(e) {
        ...
        var n = Si[e],
            o;
        for (o in n)
            if (n.hasOwnProperty(o) && o in Dc) return hs[e] = n[o];
        return e
    }
    var xc = Xn("animationend"),
        Uc = Xn("animationiteration"),
        wc = Xn("animationstart"),
        Ry = Xn("transitionrun"),
        My = Xn("transitionstart"),
        Ny = Xn("transitioncancel"),
        bc = Xn("transitionend"),
        Lc = new Map,
    ...
    function Tl(e, n, o, s) {
        Nt[Ei++] = e, Nt[Ei++] = n, Nt[Ei++] = o, Nt[Ei++] = s, ys |= s, e.lanes |= s, e = e.alternate, e !== null && (e.lanes |= s)
    }

    function vs(e, n, o, s) {
        return Tl(e, n, o, s), Sl(e)
    }

    function Kn(e, n) {
        return Tl(e, null, null, n), Sl(e)
    }
    ...
    function Gc(e, n, o) {
        ...
        return e.tag === 3 ? (p = e.stateNode, d && n !== null && (d = 31 - yt(o), e = p.hiddenUpdates, s = e[d], s === null ? e[d] = [n] : s.push(n), n.lane = o | 536870912), p) : null
    }

    function Sl(e) {
        if (50 < Vo) throw Vo = 0, Nr = null, Error(a(185));
    ...
    function El(e, n, o, s, d, p) {
        var T = 0;
        if (s = e, typeof e == "function") Ts(e) && (T = 1);
        else if (typeof e == "string") T = bv(e, o, Z.current) ? 26 : e === "html" || e === "head" || e === "body" ? 27 : 5;
        else e: switch (e) {
            case W:
                return e = Tt(31, o, n, d), e.elementType = W, e.lanes = p, e;
            case H:
                return Qn(o.children, d, p, n);
            case b:
                T = 8, d |= 24;
                break;
            case P:
                return e = Tt(12, o, n, d | 2), e.elementType = P, e.lanes = p, e;
            case ee:
                return e = Tt(13, o, n, d), e.elementType = ee, e.lanes = p, e;
            case te:
                return e = Tt(19, o, n, d), e.elementType = te, e.lanes = p, e;
            default:
        ...
        return n = Tt(T, o, n, d), n.elementType = e, n.type = s, n.lanes = p, n
    }
    ...
    function qc(e) {
        var n = Tt(18, null, null, 0);
        return n.stateNode = e, n
    }

    function Es(e, n, o) {
        return n = Tt(4, e.children !== null ? e.children : [], e.key, n), n.lanes = o, n.stateNode = {
    ...
    function $t(e, n) {
        Ci[Ai++] = yo, Ci[Ai++] = _l, _l = e, yo = n
    }

    function zc(e, n, o) {
        Dt[xt++] = Ot, Dt[xt++] = Ft, Dt[xt++] = vn, vn = e;
        var s = Ot;
        e = Ft;
        var d = 32 - yt(s) - 1;
        s &= ~(1 << d), o += 1;
        ...
        if (30 < p) {
            var T = d - d % 5;
            p = (s & (1 << T) - 1).toString(32), s >>= T, d -= T, Ot = 1 << 32 - yt(n) + d | o << d | s, Ft = p + e
        } else Ot = 1 << p | o << d | s, Ft = e
    }

    function _s(e) {
        e.return !== null && ($t(e, 1), zc(e, 1, 0))
    }

    function Cs(e) {
        for (; e === _l;) _l = Ci[--Ai], Ci[Ai] = null, yo = Ci[--Ai], Ci[Ai] = null;
        for (; e === vn;) vn = Dt[--xt], Dt[xt] = null, Ft = Dt[--xt], Dt[xt] = null, Ot = Dt[--xt], Dt[xt] = null
    }

    function Pc(e, n) {
        Dt[xt++] = Ot, Dt[xt++] = Ft, Dt[xt++] = vn, Ot = n.id, Ft = n.overflow, vn = e
    }
    var $e = null,
        we = null,
        ge = !1,
    ...
    function Bc(e) {
        ...
        switch (n[Ze] = e, n[rt] = s, o) {
            ...
            case "video":
            case "audio":
                for (o = 0; o < Po.length; o++) fe(Po[o], n);
                break;
            case "source":
                fe("error", n);
                break;
            ...
            case "details":
                ...
                break;
            case "input":
                fe("invalid", n), ec(n, s.value, s.defaultValue, s.checked, s.defaultChecked, s.type, s.name, !0);
                break;
            case "select":
                fe("invalid", n);
                break;
            case "textarea":
                fe("invalid", n), nc(n, s.value, s.defaultValue, s.children)
        }
        o = s.children, typeof o != "string" && typeof o != "number" && typeof o != "bigint" || n.textContent === "" + o || s.suppressHydrationWarning === !0 || lp(n.textContent, o) ? (s.popover != null && (fe("beforetoggle", n), fe("toggle", n)), s.onScroll != null && fe("scroll", n), s.onScrollEnd != null && fe("scrollend", n), s.onClick != null && (n.onclick = Kt), n = !0) : n = !1, n || Sn(e, !0)
    }
    ...
    function Ri(e) {
        if (e !== $e) return !1;
        if (!ge) return kc(e), ge = !0, !1;
        var n = e.tag,
            o;
        if ((o = n !== 3 && n !== 27) && ((o = n === 5) && (o = e.type, o = !(o !== "form" && o !== "button") || kr(e.type, e.memoizedProps)), o = !o), o && we && Sn(e), kc(e), n === 13) {
            if (e = e.memoizedState, e = e !== null ? e.dehydrated : null, !e) throw Error(a(317));
            we = mp(e)
        } else if (n === 31) {
            if (e = e.memoizedState, e = e !== null ? e.dehydrated : null, !e) throw Error(a(317));
            we = mp(e)
        } else n === 27 ? (n = we, Ln(e.type) ? (e = Xr, Xr = null, we = e) : we = n) : we = $e ? bt(e.stateNode.nextSibling) : null;
        return !0
    }
    ...
    function Rs() {
        var e = Tn;
        return e !== null && (pt === null ? pt = e : pt.push.apply(pt, e), Tn = null), e
    }
    ...
    function En(e, n, o) {
        Y(Ms, n._currentValue), n._currentValue = o
    }
            ...
            if (p !== null) {
                ...
                e: for (; p !== null;) {
                    ...
                    for (var A = 0; A < n.length; A++)
                        if (_.context === n[A]) {
                            p.lanes |= o, _ = p.alternate, _ !== null && (_.lanes |= o), Ns(p.return, o, e), s || (T = null);
                            break e
                        } p = _.next
                }
            } else if (d.tag === 18) {
                if (T = d.return, T === null) throw Error(a(341));
                T.lanes |= o, p = T.alternate, p !== null && (p.lanes |= o), Ns(T, o, e), T = null
            } else T = d.child;
    ...
    function Mi(e, n, o, s) {
        ...
        for (var d = n, p = !1; d !== null;) {
            ...
            if (d.tag === 10) {
                ...
                if (T = T.memoizedProps, T !== null) {
                    var _ = d.type;
                    vt(d.pendingProps.value, T.value) || (e !== null ? e.push(_) : e = [_])
                }
        ...
        e !== null && Is(n, e, o, s), n.flags |= 262144
    }
    ...
    function Wn(e) {
        $n = e, Wt = null, e = e.dependencies, e !== null && (e.firstContext = null)
    }
    ...
    function To(e) {
        e.refCount--, e.refCount === 0 && xy(Uy, function() {
            e.controller.abort()
        })
    }
    var So = null,
    ...
    var Yc = L.S;
    L.S = function(e, n) {
        Dd = ht(), typeof n == "object" && n !== null && typeof n.then == "function" && wy(e, n), Yc !== null && Yc(e, n)
    };
    var jn = M(null);
    ...
    function Rl(e, n) {
        n === null ? Y(jn, jn.current) : Y(jn, n.pool)
    }
    ...
    function Kc(e, n, o) {
        switch (o = e[o], o === void 0 ? e.push(n) : o !== n && (n.then(Kt, Kt), n = o), n.status) {
            case "fulfilled":
                return n.value;
            case "rejected":
                throw e = n.reason, Zc(e), e;
            default:
                if (typeof n.status == "string") n.then(Kt, Kt);
                else {
                    if (e = Ue, e !== null && 100 < e.shellSuspendCounter) throw Error(a(482));
    ...
    function ei(e) {
        try {
            ...
            throw o !== null && typeof o == "object" && typeof o.then == "function" ? (ti = o, Di) : o
        }
    }
    var ti = null;

    function Qc() {
        if (ti === null) throw Error(a(459));
        var e = ti;
        return ti = null, e
    }
    ...
    function Il(e) {
        var n = Eo;
        return Eo += 1, xi === null && (xi = []), Kc(xi, e, n)
    }
    ...
    function $c(e) {
        function n(N, R) {
            if (e) {
                var I = N.deletions;
                I === null ? (N.deletions = [R], N.flags |= 16) : I.push(R)
            }
        }
        ...
        function s(N) {
            for (var R = new Map; N !== null;) N.key !== null ? R.set(N.key, N) : R.set(N.index, N), N = N.sibling;
            return R
        }

        function d(N, R) {
            return N = Zt(N, R), N.index = 0, N.sibling = null, N
        }

        function p(N, R, I) {
            return N.index = I, e ? (I = N.alternate, I !== null ? (I = I.index, I < R ? (N.flags |= 67108866, R) : I) : (N.flags |= 67108866, R)) : (N.flags |= 1048576, R)
        }
        ...
        function _(N, R, I, q) {
            return R === null || R.tag !== 6 ? (R = Ss(I, N.mode, q), R.return = N, R) : (R = d(R, I), R.return = N, R)
        }

        function A(N, R, I, q) {
            var j = I.type;
            return j === H ? G(N, R, I.props.children, q, I.key) : R !== null && (R.elementType === j || typeof j == "object" && j !== null && j.$$typeof === he && ei(j) === R.type) ? (R = d(R, I.props), _o(R, I), R.return = N, R) : (R = El(I.type, I.key, I.props, null, N.mode, q), _o(R, I), R.return = N, R)
        }

        function D(N, R, I, q) {
            return R === null || R.tag !== 4 || R.stateNode.containerInfo !== I.containerInfo || R.stateNode.implementation !== I.implementation ? (R = Es(I, N.mode, q), R.return = N, R) : (R = d(R, I.children || []), R.return = N, R)
        }

        function G(N, R, I, q, j) {
            return R === null || R.tag !== 7 ? (R = Qn(I, N.mode, q, j), R.return = N, R) : (R = d(R, I), R.return = N, R)
        }

        function V(N, R, I) {
            if (typeof R == "string" && R !== "" || typeof R == "number" || typeof R == "bigint") return R = Ss("" + R, N.mode, I), R.return = N, R;
            if (typeof R == "object" && R !== null) {
                switch (R.$$typeof) {
                    case C:
                        return I = El(R.type, R.key, R.props, null, N.mode, I), _o(I, R), I.return = N, I;
                    case U:
                        return R = Es(R, N.mode, I), R.return = N, R;
                    case he:
                        return R = ei(R), V(N, R, I)
                }
                if (st(R) || Ge(R)) return R = Qn(R, N.mode, I, null), R.return = N, R;
                if (typeof R.then == "function") return V(N, Il(R), I);
                if (R.$$typeof === k) return V(N, Al(N, R), I);
                Dl(N, R)
            }
            return null
        }
        ...
        function x(N, R, I, q) {
            ...
            if (typeof I == "string" && I !== "" || typeof I == "number" || typeof I == "bigint") return j !== null ? null : _(N, R, "" + I, q);
            if (typeof I == "object" && I !== null) {
                switch (I.$$typeof) {
                    case C:
                        return I.key === j ? A(N, R, I, q) : null;
                    case U:
                        return I.key === j ? D(N, R, I, q) : null;
                    case he:
                        return I = ei(I), x(N, R, I, q)
                }
                if (st(I) || Ge(I)) return j !== null ? null : G(N, R, I, q, null);
                if (typeof I.then == "function") return x(N, R, Il(I), q);
                if (I.$$typeof === k) return x(N, R, Al(N, I), q);
                Dl(N, I)
            }
            return null
        }

        function w(N, R, I, q, j) {
            if (typeof q == "string" && q !== "" || typeof q == "number" || typeof q == "bigint") return N = N.get(I) || null, _(R, N, "" + q, j);
            if (typeof q == "object" && q !== null) {
                switch (q.$$typeof) {
                    case C:
                        return N = N.get(q.key === null ? I : q.key) || null, A(R, N, q, j);
                    case U:
                        return N = N.get(q.key === null ? I : q.key) || null, D(R, N, q, j);
                    case he:
                        return q = ei(q), w(N, R, I, q, j)
                }
                if (st(q) || Ge(q)) return N = N.get(I) || null, G(R, N, q, j, null);
                if (typeof q.then == "function") return w(N, R, I, Il(q), j);
                if (q.$$typeof === k) return w(N, R, I, Al(R, q), j);
                Dl(R, q)
            }
            return null
        }
        ...
        function Q(N, R, I, q) {
            for (var j = null, ye = null, $ = R, re = R = 0, me = null; $ !== null && re < I.length; re++) {
                ...
                e && $ && ve.alternate === null && n(N, $), R = p(ve, R, re), ye === null ? j = ve : ye.sibling = ve, ye = ve, $ = me
            }
            if (re === I.length) return o(N, $), ge && $t(N, re), j;
            if ($ === null) {
                for (; re < I.length; re++) $ = V(N, I[re], q), $ !== null && (R = p($, R, re), ye === null ? j = $ : ye.sibling = $, ye = $);
                return ge && $t(N, re), j
            }
            for ($ = s($); re < I.length; re++) me = w($, N, re, I[re], q), me !== null && (e && me.alternate !== null && $.delete(me.key === null ? re : me.key), R = p(me, R, re), ye === null ? j = me : ye.sibling = me, ye = me);
            return e && $.forEach(function(zn) {
                return n(N, zn)
            }), ge && $t(N, re), j
        }
        ...
        function ne(N, R, I, q) {
            ...
            for (var j = null, ye = null, $ = R, re = R = 0, me = null, ve = I.next(); $ !== null && !ve.done; re++, ve = I.next()) {
                $.index > re ? (me = $, $ = null) : me = $.sibling;
                var zn = x(N, $, ve.value, q);
                if (zn === null) {
                    $ === null && ($ = me);
                    break
                }
                e && $ && zn.alternate === null && n(N, $), R = p(zn, R, re), ye === null ? j = zn : ye.sibling = zn, ye = zn, $ = me
            }
            if (ve.done) return o(N, $), ge && $t(N, re), j;
            if ($ === null) {
                for (; !ve.done; re++, ve = I.next()) ve = V(N, ve.value, q), ve !== null && (R = p(ve, R, re), ye === null ? j = ve : ye.sibling = ve, ye = ve);
                return ge && $t(N, re), j
            }
            for ($ = s($); !ve.done; re++, ve = I.next()) ve = w($, N, re, ve.value, q), ve !== null && (e && ve.alternate !== null && $.delete(ve.key === null ? re : ve.key), R = p(ve, R, re), ye === null ? j = ve : ye.sibling = ve, ye = ve);
            return e && $.forEach(function(Fv) {
                return n(N, Fv)
            }), ge && $t(N, re), j
        }
                        ...
                        e: {
                            for (var j = I.key; R !== null;) {
                                if (R.key === j) {
                                    if (j = I.type, j === H) {
                                        if (R.tag === 7) {
                                            o(N, R.sibling), q = d(R, I.props.children), q.return = N, N = q;
                                            break e
                                        }
                                    } else if (R.elementType === j || typeof j == "object" && j !== null && j.$$typeof === he && ei(j) === R.type) {
                                        o(N, R.sibling), q = d(R, I.props), _o(q, I), q.return = N, N = q;
                                        break e
                                    }
                                    o(N, R);
                                    break
                            ...
                            I.type === H ? (q = Qn(I.props.children, N.mode, q, I.key), q.return = N, N = q) : (q = El(I.type, I.key, I.props, null, N.mode, q), _o(q, I), q.return = N, N = q)
                        }
                        return T(N);
                    case U:
                        e: {
                            for (j = I.key; R !== null;) {
                                if (R.key === j)
                                    if (R.tag === 4 && R.stateNode.containerInfo === I.containerInfo && R.stateNode.implementation === I.implementation) {
                                        o(N, R.sibling), q = d(R, I.children || []), q.return = N, N = q;
                                        break e
                                    } else {
                                        o(N, R);
                                        break
                        ...
                        return T(N);
                    case he:
                        return I = ei(I), De(N, R, I, q)
                }
                if (st(I)) return Q(N, R, I, q);
                if (Ge(I)) {
                    if (j = Ge(I), typeof j != "function") throw Error(a(150));
                    return I = j.call(I), ne(N, R, I, q)
                }
                if (typeof I.then == "function") return De(N, R, Il(I), q);
                if (I.$$typeof === k) return De(N, R, Al(N, I), q);
                Dl(N, I)
            }
            return typeof I == "string" && I !== "" || typeof I == "number" || typeof I == "bigint" ? (I = "" + I, R !== null && R.tag === 6 ? (o(N, R.sibling), q = d(R, I), q.return = N, N = q) : (o(N, R), q = Ss(I, N.mode, q), q.return = N, N = q), T(N)) : o(N, R)
        }
        return function(N, R, I, q) {
            try {
                Eo = 0;
                var j = De(N, R, I, q);
                return xi = null, j
                ...
                if ($ === Di || $ === Ml) throw $;
                var ye = Tt(29, $, null, N.mode);
                return ye.lanes = q, ye.return = N, ye
            } finally {}
        }
    }
    var ni = $c(!0),
    ...
    function An(e, n, o) {
        ...
        if (s = s.shared, (Se & 2) !== 0) {
            var d = s.pending;
            return d === null ? n.next = n : (n.next = d.next, d.next = n), s.pending = n, n = Sl(e), Gc(e, null, o), n
        }
        return Tl(e, s, n, o), Sl(e)
    }

    function Co(e, n, o) {
        if (n = n.updateQueue, n !== null && (n = n.shared, (o & 4194048) !== 0)) {
            var s = n.lanes;
            s &= e.pendingLanes, o |= s, n.lanes = o, Ou(e, o)
        }
    }
    ...
    function Ro(e, n, o, s) {
        ...
        if (_ !== null) {
            ...
            var G = e.alternate;
            G !== null && (G = G.updateQueue, _ = G.lastBaseUpdate, _ !== T && (_ === null ? G.firstBaseUpdate = D : _.next = D, G.lastBaseUpdate = A))
        }
        if (p !== null) {
            var V = d.baseState;
            T = 0, G = D = A = null, _ = p;
                ...
                if (w ? (pe & x) === x : (s & x) === x) {
                    ...
                    e: {
                        ...
                        switch (ne.tag) {
                            ...
                            case 0:
                                if (Q = ne.payload, x = typeof Q == "function" ? Q.call(De, V, x) : Q, x == null) break e;
                                V = S({}, V, x);
                                break e;
                            case 2:
                                _n = !0
                    ...
                    x = _.callback, x !== null && (e.flags |= 64, w && (e.flags |= 8192), w = d.callbacks, w === null ? d.callbacks = [x] : w.push(x))
                } else w = {
                    lane: x,
                    tag: _.tag,
                    payload: _.payload,
                    callback: _.callback,
                    next: null
                }, G === null ? (D = G = w, A = V) : G = G.next = w, T |= x;
                if (_ = _.next, _ === null) {
                    if (_ = d.shared.pending, _ === null) break;
                    w = _, _ = w.next, w.next = null, d.lastBaseUpdate = w, d.shared.pending = null
                }
            } while (!0);
            G === null && (A = V), d.baseState = A, d.firstBaseUpdate = D, d.lastBaseUpdate = G, p === null && (d.shared.lanes = 0), Dn |= T, e.lanes = T, e.memoizedState = V
        }
    }
    ...
    function ef(e, n) {
        var o = e.callbacks;
        if (o !== null)
            for (e.callbacks = null, e = 0; e < o.length; e++) jc(o[e], n)
    }
    var Ui = M(null),
        xl = M(0);

    function tf(e, n) {
        e = un, Y(xl, e), Y(Ui, n), un = e | n.baseLanes
    }

    function qs() {
        Y(xl, un), Y(Ui, Ui.current)
    }

    function Vs() {
        un = xl.current, z(Ui), z(xl)
    }
    var St = M(null),
        wt = null;
    ...
    function Rn(e) {
        var n = e.alternate;
        Y(ze, ze.current & 1), Y(St, e), wt === null && (n === null || Ui.current !== null || n.memoizedState !== null) && (wt = e)
    }

    function zs(e) {
        Y(ze, ze.current), Y(St, e), wt === null && (wt = e)
    }

    function nf(e) {
        e.tag === 22 ? (Y(ze, ze.current), Y(St, e), wt === null && (wt = e)) : Mn()
    }

    function Mn() {
        Y(ze, ze.current), Y(St, St.current)
    }

    function Et(e) {
        z(St), wt === e && (wt = null), z(ze)
    }
    var ze = M(0);
    ...
    function Ul(e) {
        for (var n = e; n !== null;) {
            if (n.tag === 13) {
                ...
                if (o !== null && (o = o.dehydrated, o === null || Yr(o) || Jr(o))) return n
    ...
    function Ps(e, n) {
        ...
        for (var o = 0; o < n.length && o < e.length; o++)
            if (!vt(e[o], n[o])) return !1;
        return !0
    }

    function Bs(e, n, o, s, d, p) {
        return en = p, se = n, n.memoizedState = null, n.updateQueue = null, n.lanes = 0, L.H = e === null || e.memoizedState === null ? Pf : nr, ii = !1, p = o(s, d), ii = !1, wi && (p = lf(n, o, s, d)), of(e), p
    }

    function of(e) {
        L.H = Do;
        var n = Ne !== null && Ne.next !== null;
        if (en = 0, Oe = Ne = se = null, wl = !1, Mo = 0, bi = null, n) throw Error(a(300));
        e === null || Fe || (e = e.dependencies, e !== null && Cl(e) && (Fe = !0))
    }
    ...
    function lf(e, n, o, s) {
        ...
        var d = 0;
        do {
            if (wi && (bi = null), Mo = 0, wi = !1, 25 <= d) throw Error(a(301));
            if (d += 1, Oe = Ne = null, e.updateQueue != null) {
                var p = e.updateQueue;
    ...
    function Gy() {
        var e = L.H,
            n = e.useState()[0];
        return n = typeof n.then == "function" ? No(n) : n, e = e.useState()[0], (Ne !== null ? Ne.memoizedState : null) !== e && (se.flags |= 1024), n
    }
    ...
    function Fs(e) {
        ...
        en = 0, Oe = Ne = se = null, wi = !1, Mo = bl = 0, bi = null
    }
    ...
    function Pe() {
        ...
        var n = Oe === null ? se.memoizedState : Oe.next;
        if (n !== null) Oe = n, Ne = e;
        else {
    ...
    function No(e) {
        var n = Mo;
        return Mo += 1, bi === null && (bi = []), e = Kc(bi, e, n), n = se, (Oe === null ? n.memoizedState : Oe.next) === null && (n = n.alternate, L.H = n === null || n.memoizedState === null ? Pf : nr), e
    }

    function Gl(e) {
        if (e !== null && typeof e == "object") {
            if (typeof e.then == "function") return No(e);
            if (e.$$typeof === k) return We(e)
        }
    ...
    function Ys(e) {
        ...
        if (n == null && (n = {
                data: [],
                index: 0
            }), o === null && (o = Ll(), se.updateQueue = o), o.memoCache = n, o = n.data[n.index], o === void 0)
    ...
    function Js(e, n, o) {
        ...
        if (p = e.baseState, d === null) e.memoizedState = p;
            ...
            do {
                ...
                if (V !== D.lane ? (pe & V) === V : (en & V) === V) {
                    var x = D.revertLane;
                    if (x === 0) A !== null && (A = A.next = {
                        lane: 0,
                        revertLane: 0,
                        gesture: null,
                        action: D.action,
                        ...
                        eagerState: D.eagerState,
                        next: null
                    }, A === null ? (_ = A = V, T = p) : A = A.next = V, se.lanes |= x, Dn |= x;
                    V = D.action, ii && o(p, V), p = D.hasEagerState ? D.eagerState : o(p, V)
                } else x = {
                    lane: V,
                    revertLane: D.revertLane,
                    gesture: D.gesture,
                    ...
                    eagerState: D.eagerState,
                    next: null
                }, A === null ? (_ = A = x, T = p) : A = A.next = x, se.lanes |= V, Dn |= V;
                D = D.next
            } while (D !== null && D !== n);
            if (A === null ? T = p : A.next = _, !vt(p, e.memoizedState) && (Fe = !0, G && (o = Ii, o !== null))) throw o;
    ...
    function Xs(e) {
        ...
        if (d !== null) {
            ...
            vt(p, n.memoizedState) || (Fe = !0), n.memoizedState = p, n.baseQueue === null && (n.baseState = p), o.lastRenderedState = p
        }
        return [p, s]
    }
    ...
    function af(e, n, o) {
        ...
        var T = !vt((Ne || d).memoizedState, o);
        if (T && (d.memoizedState = o, Fe = !0), d = d.queue, Zs(uf.bind(null, s, d, e), [e]), d.getSnapshot !== n || T || Oe !== null && Oe.memoizedState.tag & 1) {
            if (s.flags |= 2048, Li(9, {
                    destroy: void 0
                }, rf.bind(null, s, d, o, n), null), Ue === null) throw Error(a(349));
            p || (en & 127) !== 0 || sf(s, n, o)
        }
        return o
    }
    ...
    function sf(e, n, o) {
        e.flags |= 16384, e = {
            getSnapshot: n,
            value: o
        }, n = se.updateQueue, n === null ? (n = Ll(), se.updateQueue = n, n.stores = [e]) : (o = n.stores, o === null ? n.stores = [e] : o.push(e))
    }

    function rf(e, n, o, s) {
        n.value = o, n.getSnapshot = s, cf(n) && ff(e)
    }
    ...
    function df(e, n, o, s) {
        return e.baseState = o, Js(e, Ne, typeof s == "function" ? s : tn)
    }

    function Hy(e, n, o, s, d) {
        ...
        if (e = n.action, e !== null) {
            ...
            L.T !== null ? o(!0) : p.isTransition = !1, s(p), o = n.pending, o === null ? (p.next = n.pending = p, pf(n, p)) : (p.next = o.next, n.pending = o.next = p)
        }
    }
    ...
    function pf(e, n) {
        ...
        if (n.isTransition) {
            ...
            try {
                var _ = o(d, s),
                    A = L.S;
                A !== null && A(T, _), mf(e, n, _)
            } catch (D) {
                Qs(e, n, D)
            } finally {
                p !== null && T.types !== null && (p.types = T.types), L.T = p
            }
        } else try {
            p = o(d, s), mf(e, n, p)
        } catch (D) {
    ...
    function hf(e, n, o) {
        n.status = "fulfilled", n.value = o, gf(n), e.state = o, n = e.pending, n !== null && (o = n.next, o === n ? e.pending = null : (o = o.next, n.next = o, pf(e, o)))
    }
    ...
    function Qs(e, n, o) {
        ...
        if (e.pending = null, s !== null) {
            s = s.next;
            do n.status = "rejected", n.reason = o, gf(n), n = n.next; while (n !== s)
        }
        e.action = null
    }
    ...
    function vf(e, n) {
                ...
                e: {
                    ...
                    if (ge) {
                        if (we) {
                            ...
                            if (d) {
                                we = bt(d.nextSibling), s = d.data === "F!";
                                break e
                            }
                        }
                        Sn(s)
        ...
        return o = ot(), o.memoizedState = o.baseState = n, s = {
            pending: null,
            lanes: 0,
            dispatch: null,
            lastRenderedReducer: yf,
            lastRenderedState: n
        }, o.queue = s, o = qf.bind(null, se, s), s.dispatch = o, s = Ks(!1), p = tr.bind(null, se, !1, s.queue), s = ot(), d = {
            state: n,
            dispatch: null,
            action: e,
            pending: null
        }, s.queue = d, o = Hy.bind(null, se, d, p, o), d.dispatch = o, s.memoizedState = e, [n, o, !1]
    }
    ...
    function Sf(e, n, o) {
        if (n = Js(e, n, yf)[0], e = Hl(tn)[0], typeof n == "object" && n !== null && typeof n.then == "function") try {
            var s = No(n)
        } catch (T) {
            throw T === Di ? Ml : T
        } else s = n;
        ...
        var d = n.queue,
            p = d.dispatch;
        return o !== n.memoizedState && (se.flags |= 2048, Li(9, {
            destroy: void 0
        }, qy.bind(null, d, o), null)), [s, p, e]
    }
    ...
    function Li(e, n, o, s) {
        return e = {
            ...
            inst: n,
            next: null
        }, n = se.updateQueue, n === null && (n = Ll(), se.updateQueue = n), o = n.lastEffect, o === null ? n.lastEffect = e.next = e : (s = o.next, o.next = e, e.next = s, n.lastEffect = e), e
    }
    ...
    function ql(e, n, o, s) {
        var d = ot();
        se.flags |= e, d.memoizedState = Li(1 | n, {
            destroy: void 0
        }, o, s === void 0 ? null : s)
    }
    ...
    function Vl(e, n, o, s) {
        ...
        Ne !== null && s !== null && Ps(s, Ne.memoizedState.deps) ? d.memoizedState = Li(n, p, o, s) : (se.flags |= e, d.memoizedState = Li(1 | n, p, o, s))
    }
    ...
    function Vy(e) {
        ...
        if (n === null) n = Ll(), se.updateQueue = n, n.events = [e];
        else {
            var o = n.events;
    ...
    function If(e, n, o) {
        o = o != null ? o.concat([e]) : null, Vl(4, 4, Nf.bind(null, n, e), o)
    }
    ...
    function Df(e, n) {
        ...
        return n !== null && Ps(n, s[1]) ? s[0] : (o.memoizedState = [e, n], e)
    }
    ...
    function Ws(e, n, o) {
        return o === void 0 || (en & 1073741824) !== 0 && (pe & 261930) === 0 ? e.memoizedState = n : (e.memoizedState = o, e = Ud(), se.lanes |= e, Dn |= e, o)
    }

    function Uf(e, n, o, s) {
        return vt(o, n) ? o : Ui.current !== null ? (e = Ws(e, o, s), vt(e, n) || (Fe = !0), e) : (en & 42) === 0 || (en & 1073741824) !== 0 && (pe & 261930) === 0 ? (Fe = !0, e.memoizedState = o) : (e = Ud(), se.lanes |= e, Dn |= e, n)
    }

    function wf(e, n, o, s, d) {
        var p = O.p;
        O.p = p !== 0 && 8 > p ? p : 8;
        var T = L.T,
            _ = {};
        ...
        try {
            ...
            O.p = p, T !== null && _.types !== null && (T.types = _.types), L.T = T
        }
    }
    ...
    function js(e, n, o, s) {
        ...
        var d = bf(e).queue;
        wf(e, d, n, ie, o === null ? zy : function() {
            return Lf(e), o(s)
        })
    }
    ...
    function Lf(e) {
        var n = bf(e);
        n.next === null && (n = e.alternate.memoizedState), Io(e, n.next.queue, {}, At())
    }
    ...
    function By(e, n, o) {
        ...
        o = {
            ...
            eagerState: null,
            next: null
        }, zl(e) ? Vf(n, o) : (o = vs(e, n, o, s), o !== null && (mt(o, e, s), zf(o, n, s)))
    }
        ...
        if (zl(e)) Vf(n, d);
            ...
            if (e.lanes === 0 && (p === null || p.lanes === 0) && (p = n.lastRenderedReducer, p !== null)) try {
                var T = n.lastRenderedState,
                    _ = p(T, o);
                if (d.hasEagerState = !0, d.eagerState = _, vt(_, T)) return Tl(e, n, d, 0), Ue === null && vl(), !1
            } catch {} finally {}
            if (o = vs(e, n, d, s), o !== null) return mt(o, e, s), zf(o, n, s), !0
        }
        return !1
    }
    ...
    function tr(e, n, o, s) {
        ...
        } else n = vs(e, o, s, 2), n !== null && mt(n, e, 2)
    }
    ...
    var Pf = {
            ...
            useImperativeHandle: function(e, n, o) {
                o = o != null ? o.concat([e]) : null, ql(4194308, 4, Nf.bind(null, n, e), o)
            },
            ...
            useReducer: function(e, n, o) {
                ...
                return s.memoizedState = s.baseState = d, e = {
                    ...
                    lastRenderedState: d
                }, s.queue = e, e = e.dispatch = By.bind(null, se, e), [s.memoizedState, e]
            },
            useRef: function(e) {
                var n = ot();
                return e = {
            ...
            useTransition: function() {
                var e = Ks(!1);
                return e = wf.bind(null, se, e.queue, !0, !1), ot().memoizedState = e, [!1, e]
            },
            useSyncExternalStore: function(e, n, o) {
                ...
                if (ge) {
                    ...
                    if (o = n(), Ue === null) throw Error(a(349));
                    (pe & 127) !== 0 || sf(s, n, o)
                }
                d.memoizedState = o;
                var p = {
                ...
                return d.queue = p, Cf(uf.bind(null, s, p, e), [e]), s.flags |= 2048, Li(9, {
                    destroy: void 0
                }, rf.bind(null, s, p, o, n), null), o
            },
            useId: function() {
                var e = ot(),
                ...
                if (ge) {
                    var o = Ft,
                        s = Ot;
                    o = (s & ~(1 << 32 - yt(s) - 1)).toString(32) + o, n = "_" + n + "R_" + o, o = bl++, 0 < o && (n += "H" + o.toString(32)), n += "_"
                } else o = Ly++, n = "_" + n + "r_" + o.toString(32) + "_";
            ...
            useOptimistic: function(e) {
                ...
                return n.queue = o, n = tr.bind(null, se, !0, o), o.dispatch = n, [e, n]
            },
            useMemoCache: Ys,
            useCacheRefresh: function() {
                return ot().memoizedState = Py.bind(null, se)
            },
        ...
        nr = {
            ...
            useDeferredValue: function(e, n) {
                var o = Pe();
                return Uf(o, Ne.memoizedState, e, n)
            },
            useTransition: function() {
                var e = Hl(tn)[0],
                    n = Pe().memoizedState;
                return [typeof e == "boolean" ? e : No(e), n]
            },
    ...
    var Bf = {
        ...
        useDeferredValue: function(e, n) {
            var o = Pe();
            return Ne === null ? Ws(o, e, n) : Uf(o, Ne.memoizedState, e, n)
        },
        useTransition: function() {
            var e = Xs(tn)[0],
                n = Pe().memoizedState;
        ...
        useOptimistic: function(e, n) {
            var o = Pe();
            return Ne !== null ? df(o, Ne, e, n) : (o.baseState = e, [e, o.queue.dispatch])
        },
        useMemoCache: Ys,
        useCacheRefresh: Hf
    };
    Bf.useEffectEvent = Af;
    ...
    var or = {
        enqueueSetState: function(e, n, o) {
            ...
            var s = At(),
                d = Cn(s);
            d.payload = n, o != null && (d.callback = o), n = An(e, d, s), n !== null && (mt(n, e, s), Co(n, e, s))
        },
        enqueueReplaceState: function(e, n, o) {
            e = e._reactInternals;
            var s = At(),
                d = Cn(s);
            d.tag = 1, d.payload = n, o != null && (d.callback = o), n = An(e, d, s), n !== null && (mt(n, e, s), Co(n, e, s))
        },
        enqueueForceUpdate: function(e, n) {
            e = e._reactInternals;
            var o = At(),
                s = Cn(o);
            s.tag = 2, n != null && (s.callback = n), n = An(e, s, o), n !== null && (mt(n, e, o), Co(n, e, o))
        }
    };

    function kf(e, n, o, s, d, p, T) {
        return e = e.stateNode, typeof e.shouldComponentUpdate == "function" ? e.shouldComponentUpdate(s, p, T) : n.prototype && n.prototype.isPureReactComponent ? !ho(o, s) || !ho(d, p) : !0
    }

    function Of(e, n, o, s) {
        e = n.state, typeof n.componentWillReceiveProps == "function" && n.componentWillReceiveProps(o, s), typeof n.UNSAFE_componentWillReceiveProps == "function" && n.UNSAFE_componentWillReceiveProps(o, s), n.state !== e && or.enqueueReplaceState(n, n.state, null)
    }
    ...
    function lr(e, n, o) {
        return o = Cn(o), o.tag = 3, o.payload = {
            element: null
        }, o.callback = function() {
            Pl(e, n)
        }, o
    ...
    function Qf(e, n, o, s) {
        ...
        T !== null && typeof T.componentDidCatch == "function" && (e.callback = function() {
            Xf(n, o, s), typeof d != "function" && (xn === null ? xn = new Set([this]) : xn.add(this));
            var _ = s.stack;
    ...
    function ky(e, n, o, s, d) {
        if (o.flags |= 32768, s !== null && typeof s == "object" && typeof s.then == "function") {
            if (n = o.alternate, n !== null && Mi(n, o, d, !0), o = St.current, o !== null) {
                switch (o.tag) {
                    case 31:
                    case 13:
                        return wt === null ? Wl() : o.alternate === null && qe === 0 && (qe = 3), o.flags &= -257, o.flags |= 65536, o.lanes = d, s === Nl ? o.flags |= 16384 : (n = o.updateQueue, n === null ? o.updateQueue = new Set([s]) : n.add(s), xr(e, s, d)), !1;
                    case 22:
                        return o.flags |= 65536, s === Nl ? o.flags |= 16384 : (n = o.updateQueue, n === null ? (n = {
                            transitions: null,
                            markerInstances: null,
                            retryQueue: new Set([s])
                        }, o.updateQueue = n) : (o = n.retryQueue, o === null ? n.retryQueue = new Set([s]) : o.add(s)), xr(e, s, d)), !1
                }
                throw Error(a(435, o.tag))
            }
            return xr(e, s, d), Wl(), !1
        }
        if (ge) return n = St.current, n !== null ? ((n.flags & 65536) === 0 && (n.flags |= 256), n.flags |= 65536, n.lanes = d, s !== As && (e = Error(a(422), {
            cause: s
        }), vo(It(e, o)))) : (s !== As && (n = Error(a(423), {
            cause: s
        }), vo(It(n, o))), e = e.current.alternate, e.flags |= 65536, d &= -d, e.lanes |= d, s = It(s, o), d = lr(e.stateNode, s, d), Gs(e, d), qe !== 4 && (qe = 2)), !1;
        var p = Error(a(520), {
            cause: s
        });
        if (p = It(p, o), qo === null ? qo = [p] : qo.push(p), qe !== 4 && (qe = 2), n === null) return !0;
        s = It(s, o), o = n;
        do {
            switch (o.tag) {
                case 3:
                    return o.flags |= 65536, e = d & -d, o.lanes |= e, e = lr(o.stateNode, s, e), Gs(o, e), !1;
                case 1:
                    if (n = o.type, p = o.stateNode, (o.flags & 128) === 0 && (typeof n.getDerivedStateFromError == "function" || p !== null && typeof p.componentDidCatch == "function" && (xn === null || !xn.has(p)))) return o.flags |= 65536, d &= -d, o.lanes |= d, d = Kf(d), Qf(d, e, o, s), Gs(o, d), !1
            }
            o = o.return
        } while (o !== null);
        return !1
    ...
    function je(e, n, o, s) {
        n.child = e === null ? Wc(n, null, o, s) : ni(n, e.child, o, s)
    }

    function Zf(e, n, o, s, d) {
        o = o.render;
        var p = n.ref;
        if ("ref" in s) {
            var T = {};
        ...
        return Wn(n), s = Bs(e, n, o, T, p, d), _ = ks(), e !== null && !Fe ? (Os(e, n, d), nn(e, n, d)) : (ge && _ && _s(n), n.flags |= 1, je(e, n, s, d), n.child)
    }

    function $f(e, n, o, s, d) {
        if (e === null) {
            var p = o.type;
            return typeof p == "function" && !Ts(p) && p.defaultProps === void 0 && o.compare === null ? (n.tag = 15, n.type = p, Wf(e, n, p, s, d)) : (e = El(o.type, null, s, n, n.mode, d), e.ref = n.ref, e.return = n, n.child = e)
        }
        if (p = e.child, !mr(e, d)) {
            var T = p.memoizedProps;
            if (o = o.compare, o = o !== null ? o : ho, o(T, s) && e.ref === n.ref) return nn(e, n, d)
        }
        return n.flags |= 1, e = Zt(p, s), e.ref = n.ref, e.return = n, n.child = e
    }

    function Wf(e, n, o, s, d) {
        if (e !== null) {
            var p = e.memoizedProps;
            if (ho(p, s) && e.ref === n.ref)
                if (Fe = !1, n.pendingProps = s = p, mr(e, d))(e.flags & 131072) !== 0 && (Fe = !0);
    ...
    function jf(e, n, o, s) {
        ...
        if (e === null && n.stateNode === null && (n.stateNode = {
            ...
            if ((o & 536870912) !== 0) n.memoizedState = {
                baseLanes: 0,
                cachePool: null
            }, e !== null && Rl(n, p !== null ? p.cachePool : null), p !== null ? tf(n, p) : qs(), nf(n);
            else return s = n.lanes = 536870912, ed(e, n, p !== null ? p.baseLanes | o : o, o, s)
        } else p !== null ? (Rl(n, p.cachePool), tf(n, p), Mn(), n.memoizedState = null) : (e !== null && Rl(n, null), qs(), Mn());
        return je(e, n, d, o), n.child
    }
    ...
    function ed(e, n, o, s, d) {
        ...
        return p = p === null ? null : {
            ...
            baseLanes: o,
            cachePool: p
        }, e !== null && Rl(n, null), qs(), nf(n), e !== null && Mi(e, n, s, !0), n.childLanes = d, null
    }
    ...
    function td(e, n, o) {
        return ni(n, e.child, null, o), e = Bl(n, n.pendingProps), e.flags |= 2, Et(n), n.memoizedState = null, e
    }
    ...
    function Oy(e, n, o) {
        ...
        if (n.flags &= -129, e === null) {
            if (ge) {
                if (s.mode === "hidden") return e = Bl(n, s), n.lanes = 536870912, xo(null, e);
                if (zs(n), (e = we) ? (e = pp(e, Ut), e = e !== null && e.data === "&" ? e : null, e !== null && (n.memoizedState = {
                        dehydrated: e,
                        treeContext: vn !== null ? {
                            id: Ot,
                            overflow: Ft
                    ...
                    }, o = qc(e), o.return = n, n.child = o, $e = n, we = null)) : e = null, e === null) throw Sn(n);
        ...
        if (p !== null) {
            var T = p.dehydrated;
            if (zs(n), d)
                if (n.flags & 256) n.flags &= -257, n = td(e, n, o);
                else if (n.memoizedState !== null) n.child = e.child, n.flags |= 128, n = null;
            else throw Error(a(558));
            else if (Fe || Mi(e, n, o, !1), d = (o & e.childLanes) !== 0, Fe || d) {
                if (s = Ue, s !== null && (T = Fu(s, o), T !== 0 && T !== p.retryLane)) throw p.retryLane = T, Kn(e, T), mt(s, e, T), ar;
                Wl(), n = td(e, n, o)
            } else e = p.treeContext, we = bt(T.nextSibling), $e = n, ge = !0, Tn = null, Ut = !1, e !== null && Pc(n, e), n = Bl(n, s), n.flags |= 4096;
            return n
        }
        return e = Zt(e.child, {
            mode: s.mode,
    ...
    function sr(e, n, o, s, d) {
        return Wn(n), o = Bs(e, n, o, s, void 0, d), s = ks(), e !== null && !Fe ? (Os(e, n, d), nn(e, n, d)) : (ge && s && _s(n), n.flags |= 1, je(e, n, o, d), n.child)
    }

    function nd(e, n, o, s, d, p) {
        return Wn(n), n.updateQueue = null, o = lf(n, s, o, d), of(e), s = ks(), e !== null && !Fe ? (Os(e, n, p), nn(e, n, p)) : (ge && s && _s(n), n.flags |= 1, je(e, n, o, p), n.child)
    }

    function id(e, n, o, s, d) {
        if (Wn(n), n.stateNode === null) {
            var p = _i,
                T = o.contextType;
            typeof T == "object" && T !== null && (p = We(T)), p = new o(s, p), n.memoizedState = p.state !== null && p.state !== void 0 ? p.state : null, p.updater = or, n.stateNode = p, p._reactInternals = n, p = n.stateNode, p.props = s, p.state = n.memoizedState, p.refs = {}, bs(n), T = o.contextType, p.context = typeof T == "object" && T !== null ? We(T) : _i, p.state = n.memoizedState, T = o.getDerivedStateFromProps, typeof T == "function" && (ir(n, o, T, s), p.state = n.memoizedState), typeof o.getDerivedStateFromProps == "function" || typeof p.getSnapshotBeforeUpdate == "function" || typeof p.UNSAFE_componentWillMount != "function" && typeof p.componentWillMount != "function" || (T = p.state, typeof p.componentWillMount == "function" && p.componentWillMount(), typeof p.UNSAFE_componentWillMount == "function" && p.UNSAFE_componentWillMount(), T !== p.state && or.enqueueReplaceState(p, p.state, null), Ro(n, s, p, d), Ao(), p.state = n.memoizedState), typeof p.componentDidMount == "function" && (n.flags |= 4194308), s = !0
        } else if (e === null) {
            p = n.stateNode;
            ...
            var D = p.context,
                G = o.contextType;
            T = _i, typeof G == "object" && G !== null && (T = We(G));
            var V = o.getDerivedStateFromProps;
            G = typeof V == "function" || typeof p.getSnapshotBeforeUpdate == "function", _ = n.pendingProps !== _, G || typeof p.UNSAFE_componentWillReceiveProps != "function" && typeof p.componentWillReceiveProps != "function" || (_ || D !== T) && Of(n, p, s, T), _n = !1;
            var x = n.memoizedState;
            p.state = x, Ro(n, s, p, d), Ao(), D = n.memoizedState, _ || x !== D || _n ? (typeof V == "function" && (ir(n, o, V, s), D = n.memoizedState), (A = _n || kf(n, o, A, s, x, D, T)) ? (G || typeof p.UNSAFE_componentWillMount != "function" && typeof p.componentWillMount != "function" || (typeof p.componentWillMount == "function" && p.componentWillMount(), typeof p.UNSAFE_componentWillMount == "function" && p.UNSAFE_componentWillMount()), typeof p.componentDidMount == "function" && (n.flags |= 4194308)) : (typeof p.componentDidMount == "function" && (n.flags |= 4194308), n.memoizedProps = s, n.memoizedState = D), p.props = s, p.state = D, p.context = T, s = A) : (typeof p.componentDidMount == "function" && (n.flags |= 4194308), s = !1)
        } else {
            p = n.stateNode, Ls(e, n), T = n.memoizedProps, G = oi(o, T), p.props = G, V = n.pendingProps, x = p.context, D = o.contextType, A = _i, typeof D == "object" && D !== null && (A = We(D)), _ = o.getDerivedStateFromProps, (D = typeof _ == "function" || typeof p.getSnapshotBeforeUpdate == "function") || typeof p.UNSAFE_componentWillReceiveProps != "function" && typeof p.componentWillReceiveProps != "function" || (T !== V || x !== A) && Of(n, p, s, A), _n = !1, x = n.memoizedState, p.state = x, Ro(n, s, p, d), Ao();
            var w = n.memoizedState;
            T !== V || x !== w || _n || e !== null && e.dependencies !== null && Cl(e.dependencies) ? (typeof _ == "function" && (ir(n, o, _, s), w = n.memoizedState), (G = _n || kf(n, o, G, s, x, w, A) || e !== null && e.dependencies !== null && Cl(e.dependencies)) ? (D || typeof p.UNSAFE_componentWillUpdate != "function" && typeof p.componentWillUpdate != "function" || (typeof p.componentWillUpdate == "function" && p.componentWillUpdate(s, w, A), typeof p.UNSAFE_componentWillUpdate == "function" && p.UNSAFE_componentWillUpdate(s, w, A)), typeof p.componentDidUpdate == "function" && (n.flags |= 4), typeof p.getSnapshotBeforeUpdate == "function" && (n.flags |= 1024)) : (typeof p.componentDidUpdate != "function" || T === e.memoizedProps && x === e.memoizedState || (n.flags |= 4), typeof p.getSnapshotBeforeUpdate != "function" || T === e.memoizedProps && x === e.memoizedState || (n.flags |= 1024), n.memoizedProps = s, n.memoizedState = w), p.props = s, p.state = w, p.context = A, s = G) : (typeof p.componentDidUpdate != "function" || T === e.memoizedProps && x === e.memoizedState || (n.flags |= 4), typeof p.getSnapshotBeforeUpdate != "function" || T === e.memoizedProps && x === e.memoizedState || (n.flags |= 1024), s = !1)
        }
        return p = s, kl(e, n), s = (n.flags & 128) !== 0, p || s ? (p = n.stateNode, o = s && typeof o.getDerivedStateFromError != "function" ? null : p.render(), n.flags |= 1, e !== null && s ? (n.child = ni(n, e.child, null, d), n.child = ni(n, null, o, d)) : je(e, n, o, d), n.memoizedState = p.state, e = n.child) : e = nn(e, n, d), e
    }

    function od(e, n, o, s) {
        return Zn(), n.flags |= 256, je(e, n, o, s), n.child
    }
    var rr = {
        dehydrated: null,
        treeContext: null,
    ...
    function cr(e, n, o) {
        return e = e !== null ? e.childLanes & ~o : 0, n && (e |= Ct), e
    }
    ...
    function ld(e, n, o) {
        ...
        if ((T = p) || (T = e !== null && e.memoizedState === null ? !1 : (ze.current & 2) !== 0), T && (d = !0, n.flags &= -129), T = (n.flags & 32) !== 0, n.flags &= -33, e === null) {
            if (ge) {
                if (d ? Rn(n) : Mn(), (e = we) ? (e = pp(e, Ut), e = e !== null && e.data !== "&" ? e : null, e !== null && (n.memoizedState = {
                        dehydrated: e,
                        treeContext: vn !== null ? {
                            id: Ot,
                            overflow: Ft
                ...
                return Jr(e) ? n.lanes = 32 : n.lanes = 536870912, null
            }
            var _ = s.children;
            return s = s.fallback, d ? (Mn(), d = n.mode, _ = Ol({
                mode: "hidden",
                children: _
            }, d), s = Qn(s, d, o, null), _.return = n, s.return = n, _.sibling = s, n.child = _, s = n.child, s.memoizedState = ur(o), s.childLanes = cr(e, T, o), n.memoizedState = rr, xo(null, s)) : (Rn(n), fr(n, _))
        }
        var A = e.memoizedState;
        if (A !== null && (_ = A.dehydrated, _ !== null)) {
            if (p) n.flags & 256 ? (Rn(n), n.flags &= -257, n = dr(e, n, o)) : n.memoizedState !== null ? (Mn(), n.child = e.child, n.flags |= 128, n = null) : (Mn(), _ = s.fallback, d = n.mode, s = Ol({
                mode: "visible",
                children: s.children
            }, d), _ = Qn(_, d, o, null), _.flags |= 2, s.return = n, _.return = n, s.sibling = _, n.child = s, ni(n, e.child, null, o), s = n.child, s.memoizedState = ur(o), s.childLanes = cr(e, T, o), n.memoizedState = rr, n = xo(null, s));
            else if (Rn(n), Jr(_)) {
                if (T = _.nextSibling && _.nextSibling.dataset, T) var D = T.dgst;
                T = D, s = Error(a(419)), s.stack = "", s.digest = T, vo({
                    value: s,
                    source: null,
                    stack: null
                }), n = dr(e, n, o)
            } else if (Fe || Mi(e, n, o, !1), T = (o & e.childLanes) !== 0, Fe || T) {
                if (T = Ue, T !== null && (s = Fu(T, o), s !== 0 && s !== A.retryLane)) throw A.retryLane = s, Kn(e, s), mt(T, e, s), ar;
                Yr(_) || Wl(), n = dr(e, n, o)
            } else Yr(_) ? (n.flags |= 192, n.child = e.child, n = null) : (e = A.treeContext, we = bt(_.nextSibling), $e = n, ge = !0, Tn = null, Ut = !1, e !== null && Pc(n, e), n = fr(n, s.children), n.flags |= 4096);
            return n
        }
        return d ? (Mn(), _ = s.fallback, d = n.mode, A = e.child, D = A.sibling, s = Zt(A, {
            mode: "hidden",
            children: s.children
        }), s.subtreeFlags = A.subtreeFlags & 65011712, D !== null ? _ = Zt(D, _) : (_ = Qn(_, d, o, null), _.flags |= 2), _.return = n, s.return = n, s.sibling = _, n.child = s, xo(null, s), s = n.child, _ = e.child.memoizedState, _ === null ? _ = ur(o) : (d = _.cachePool, d !== null ? (A = ke._currentValue, d = d.parent !== A ? {
            parent: A,
            pool: A
        } : d) : d = Jc(), _ = {
            baseLanes: _.baseLanes | o,
            cachePool: d
        }), s.memoizedState = _, s.childLanes = cr(e, T, o), n.memoizedState = rr, xo(e.child, s)) : (Rn(n), o = e.child, e = o.sibling, o = Zt(o, {
            mode: "visible",
            children: s.children
    ...
    function Ol(e, n) {
        return e = Tt(22, e, null, n), e.lanes = 0, e
    }

    function dr(e, n, o) {
        return ni(n, e.child, null, o), e = fr(n, n.pendingProps.children), e.flags |= 2, n.memoizedState = null, e
    }

    function ad(e, n, o) {
        e.lanes |= n;
        var s = e.alternate;
        s !== null && (s.lanes |= n), Ns(e.return, n, o)
    }
    ...
    function sd(e, n, o) {
        ...
        var T = ze.current,
            _ = (T & 2) !== 0;
        if (_ ? (T = T & 1 | 2, n.flags |= 128) : T &= 1, Y(ze, T), je(e, n, s, o), s = ge ? yo : 0, !_ && e !== null && (e.flags & 128) !== 0) e: for (e = n.child; e !== null;) {
        ...
        switch (d) {
            case "forwards":
                for (o = n.child, d = null; o !== null;) e = o.alternate, e !== null && Ul(e) === null && (d = o), o = o.sibling;
                o = d, o === null ? (d = n.child, n.child = null) : (d = o.sibling, o.sibling = null), pr(n, !1, d, o, p, s);
                break;
            case "backwards":
    ...
    function nn(e, n, o) {
        if (e !== null && (n.dependencies = e.dependencies), Dn |= n.lanes, (o & n.childLanes) === 0)
            if (e !== null) {
                if (Mi(e, n, o, !1), (o & n.childLanes) === 0) return null
            } else return null;
        if (e !== null && n.child !== e.child) throw Error(a(153));
        if (n.child !== null) {
            for (e = n.child, o = Zt(e, e.pendingProps), n.child = o, o.return = n; e.sibling !== null;) e = e.sibling, o = o.sibling = Zt(e, e.pendingProps), o.return = n;
            o.sibling = null
        }
        return n.child
    }
    ...
    function mr(e, n) {
        return (e.lanes & n) !== 0 ? !0 : (e = e.dependencies, !!(e !== null && Cl(e)))
    }

    function Fy(e, n, o) {
        switch (n.tag) {
            case 3:
                it(n, n.stateNode.containerInfo), En(n, ke, e.memoizedState.cache), Zn();
                break;
            case 27:
            case 5:
                to(n);
            ...
            case 4:
                ...
                break;
            case 10:
                En(n, n.type, n.memoizedProps.value);
                break;
            case 31:
                if (n.memoizedState !== null) return n.flags |= 128, zs(n), null;
                break;
            case 13:
                var s = n.memoizedState;
                if (s !== null) return s.dehydrated !== null ? (Rn(n), n.flags |= 128, null) : (o & n.child.childLanes) !== 0 ? ld(e, n, o) : (Rn(n), e = nn(e, n, o), e !== null ? e.sibling : null);
                Rn(n);
                break;
            case 19:
                var d = (e.flags & 128) !== 0;
                if (s = (o & n.childLanes) !== 0, s || (Mi(e, n, o, !1), s = (o & n.childLanes) !== 0), d) {
                    if (s) return sd(e, n, o);
                    n.flags |= 128
                }
                if (d = n.memoizedState, d !== null && (d.rendering = null, d.tail = null, d.lastEffect = null), Y(ze, ze.current), s) break;
                return null;
            case 22:
                return n.lanes = 0, jf(e, n, o, n.pendingProps);
            case 24:
                En(n, ke, e.memoizedState.cache)
        }
        return nn(e, n, o)
    }
    ...
    function rd(e, n, o) {
        if (e !== null)
            if (e.memoizedProps !== n.pendingProps) Fe = !0;
                ...
                if (!mr(e, o) && (n.flags & 128) === 0) return Fe = !1, Fy(e, n, o);
                Fe = (e.flags & 131072) !== 0
            }
        else Fe = !1, ge && (n.flags & 1048576) !== 0 && zc(n, yo, n.index);
        switch (n.lanes = 0, n.tag) {
            case 16:
                e: {
                    var s = n.pendingProps;
                    if (e = ei(n.elementType), n.type = e, typeof e == "function") Ts(e) ? (s = oi(e, s), n.tag = 1, n = id(null, n, e, s, o)) : (n.tag = 0, n = sr(null, n, e, s, o));
                    else {
                        if (e != null) {
                            var d = e.$$typeof;
                            if (d === K) {
                                n.tag = 11, n = Zf(null, n, e, s, o);
                                break e
                            } else if (d === F) {
                                n.tag = 14, n = $f(null, n, e, s, o);
                                break e
                            }
                        }
                ...
                return n;
            case 0:
                return sr(e, n, n.type, n.pendingProps, o);
            case 1:
                return s = n.type, d = oi(s, n.pendingProps), id(e, n, s, d, o);
            case 3:
                e: {
                    if (it(n, n.stateNode.containerInfo), e === null) throw Error(a(387));s = n.pendingProps;
                    var p = n.memoizedState;d = p.element,
                    Ls(e, n),
                    Ro(n, s, null, o);
                    var T = n.memoizedState;
                    if (s = T.cache, En(n, ke, s), s !== p.cache && Is(n, [ke], o, !0), Ao(), s = T.element, p.isDehydrated)
                        if (p = {
                                element: s,
                                isDehydrated: !1,
                                cache: T.cache
                        ...
                        d = It(Error(a(424)), n), vo(d), n = od(e, n, s, o);
                        break e
                    } else {
                        ...
                        for (we = bt(e.firstChild), $e = n, ge = !0, Tn = null, Ut = !0, o = Wc(n, null, s, o), n.child = o; o;) o.flags = o.flags & -3 | 4096, o = o.sibling
                    } else {
                        if (Zn(), s === d) {
                            n = nn(e, n, o);
                            break e
                ...
                return n;
            case 26:
                return kl(e, n), e === null ? (o = Tp(n.type, null, n.pendingProps, null)) ? n.memoizedState = o : ge || (o = n.type, e = n.pendingProps, s = la(ue.current).createElement(o), s[Ze] = n, s[rt] = e, et(s, o, e), Xe(s), n.stateNode = s) : n.memoizedState = Tp(n.type, e.memoizedProps, n.pendingProps, e.memoizedState), null;
            case 27:
                return to(n), e === null && ge && (s = n.stateNode = gp(n.type, n.pendingProps, ue.current), $e = n, Ut = !0, d = we, Ln(n.type) ? (Xr = d, we = bt(s.firstChild)) : we = d), je(e, n, n.pendingProps.children, o), kl(e, n), e === null && (n.flags |= 4194304), n.child;
            case 5:
                return e === null && ge && ((d = s = we) && (s = Sv(s, n.type, n.pendingProps, Ut), s !== null ? (n.stateNode = s, $e = n, we = bt(s.firstChild), Ut = !1, d = !0) : d = !1), d || Sn(n)), to(n), d = n.type, p = n.pendingProps, T = e !== null ? e.memoizedProps : null, s = p.children, kr(d, p) ? s = null : T !== null && kr(d, T) && (n.flags |= 32), n.memoizedState !== null && (d = Bs(e, n, Gy, null, null, o), Yo._currentValue = d), kl(e, n), je(e, n, s, o), n.child;
            case 6:
                return e === null && ge && ((e = o = we) && (o = Ev(o, n.pendingProps, Ut), o !== null ? (n.stateNode = o, $e = n, we = null, e = !0) : e = !1), e || Sn(n)), null;
            case 13:
                return ld(e, n, o);
            case 4:
                return it(n, n.stateNode.containerInfo), s = n.pendingProps, e === null ? n.child = ni(n, null, s, o) : je(e, n, s, o), n.child;
            case 11:
                return Zf(e, n, n.type, n.pendingProps, o);
            case 7:
                return je(e, n, n.pendingProps, o), n.child;
            case 8:
                return je(e, n, n.pendingProps.children, o), n.child;
            case 12:
                return je(e, n, n.pendingProps.children, o), n.child;
            case 10:
                return s = n.pendingProps, En(n, n.type, s.value), je(e, n, s.children, o), n.child;
            case 9:
                return d = n.type._context, s = n.pendingProps.children, Wn(n), d = We(d), s = s(d), n.flags |= 1, je(e, n, s, o), n.child;
            case 14:
                return $f(e, n, n.type, n.pendingProps, o);
            case 15:
                return Wf(e, n, n.type, n.pendingProps, o);
            case 19:
                return sd(e, n, o);
            case 31:
                return Oy(e, n, o);
            case 22:
                return jf(e, n, o, n.pendingProps);
            case 24:
                return Wn(n), s = We(ke), e === null ? (d = Us(), d === null && (d = Ue, p = Ds(), d.pooledCache = p, p.refCount++, p !== null && (d.pooledCacheLanes |= o), d = p), n.memoizedState = {
                    parent: s,
                    cache: d
                }, bs(n), En(n, ke, d)) : ((e.lanes & o) !== 0 && (Ls(e, n), Ro(n, null, null, o), Ao()), d = e.memoizedState, p = n.memoizedState, d.parent !== s ? (d = {
                    parent: s,
                    cache: s
                }, n.memoizedState = d, n.lanes === 0 && (n.memoizedState = n.updateQueue.baseState = d), En(n, ke, s)) : (s = p.cache, En(n, ke, s), s !== d.cache && Is(n, [ke], o, !0))), je(e, n, n.pendingProps.children, o), n.child;
            case 29:
    ...
    function ud(e, n) {
        ...
        else if (e.flags |= 16777216, !Ap(n))
            if (Gd()) e.flags |= 8192;
            else throw ti = Nl, ws
    }

    function Fl(e, n) {
        n !== null && (e.flags |= 4), e.flags & 16384 && (n = e.tag !== 22 ? Bu() : 536870912, e.lanes |= n, Vi |= n)
    }
    ...
    function Yy(e, n, o) {
        ...
        switch (Cs(n), n.tag) {
            ...
            case 1:
                return be(n), null;
            case 3:
                return o = n.stateNode, s = null, e !== null && (s = e.memoizedState.cache), n.memoizedState.cache !== s && (n.flags |= 2048), jt(ke), Ve(), o.pendingContext && (o.context = o.pendingContext, o.pendingContext = null), (e === null || e.child === null) && (Ri(n) ? on(n) : e === null || e.memoizedState.isDehydrated && (n.flags & 256) === 0 || (n.flags |= 1024, Rs())), be(n), null;
            case 26:
                var d = n.type,
                    p = n.memoizedState;
                return e === null ? (on(n), p !== null ? (be(n), ud(n, p)) : (be(n), hr(n, d, null, s, o))) : p ? p !== e.memoizedState ? (on(n), be(n), ud(n, p)) : (be(n), n.flags &= -16777217) : (e = e.memoizedProps, e !== s && on(n), be(n), hr(n, d, e, s, o)), null;
            case 27:
                if (tl(n), o = ue.current, d = n.type, e !== null && n.stateNode != null) e.memoizedProps !== s && on(n);
                else {
                    if (!s) {
                        if (n.stateNode === null) throw Error(a(166));
                        return be(n), null
                    }
                    e = Z.current, Ri(n) ? Bc(n) : (e = gp(d, s, o), n.stateNode = e, on(n))
                }
                return be(n), null;
            case 5:
                if (tl(n), d = n.type, e !== null && n.stateNode != null) e.memoizedProps !== s && on(n);
                else {
                    if (!s) {
                        if (n.stateNode === null) throw Error(a(166));
                        return be(n), null
                    }
                    if (p = Z.current, Ri(n)) Bc(n);
                    else {
                        var T = la(ue.current);
                        switch (p) {
                            case 1:
                ...
                return be(n), hr(n, n.type, e === null ? null : e.memoizedProps, n.pendingProps, o), null;
            case 6:
                if (e && n.stateNode != null) e.memoizedProps !== s && on(n);
                else {
                    if (typeof s != "string" && n.stateNode === null) throw Error(a(166));
                    if (e = ue.current, Ri(n)) {
                        if (e = n.stateNode, o = n.memoizedProps, s = null, d = $e, d !== null) switch (d.tag) {
                            case 27:
                            case 5:
                                s = d.memoizedProps
                        }
                        e[Ze] = n, e = !!(e.nodeValue === o || s !== null && s.suppressHydrationWarning === !0 || lp(e.nodeValue, o)), e || Sn(n, !0)
                    } else e = la(e).createTextNode(s), e[Ze] = n, n.stateNode = e
                }
                return be(n), null;
            case 31:
                if (o = n.memoizedState, e === null || e.memoizedState !== null) {
                    if (s = Ri(n), o !== null) {
                        ...
                        be(n), e = !1
                    } else o = Rs(), e !== null && e.memoizedState !== null && (e.memoizedState.hydrationErrors = o), e = !0;
            ...
            case 13:
                if (s = n.memoizedState, e === null || e.memoizedState !== null && e.memoizedState.dehydrated !== null) {
                    if (d = Ri(n), s !== null && s.dehydrated !== null) {
                        if (e === null) {
                        ...
                        be(n), d = !1
                    } else d = Rs(), e !== null && e.memoizedState !== null && (e.memoizedState.hydrationErrors = d), d = !0;
                    if (!d) return n.flags & 256 ? (Et(n), n) : (Et(n), null)
                }
                return Et(n), (n.flags & 128) !== 0 ? (n.lanes = o, n) : (o = s !== null, e = e !== null && e.memoizedState !== null, o && (s = n.child, d = null, s.alternate !== null && s.alternate.memoizedState !== null && s.alternate.memoizedState.cachePool !== null && (d = s.alternate.memoizedState.cachePool.pool), p = null, s.memoizedState !== null && s.memoizedState.cachePool !== null && (p = s.memoizedState.cachePool.pool), p !== d && (s.flags |= 2048)), o !== e && o && (n.child.flags |= 8192), Fl(n, n.updateQueue), be(n), null);
            case 4:
                return Ve(), e === null && qr(n.stateNode.containerInfo), be(n), null;
            case 10:
                return jt(n.type), be(n), null;
            case 19:
                if (z(ze), s = n.memoizedState, s === null) return be(n), null;
                    ...
                    if (d) Uo(s, !1);
                        ...
                        if (qe !== 0 || e !== null && (e.flags & 128) !== 0)
                            for (e = n.child; e !== null;) {
                                if (p = Ul(e), p !== null) {
                                    for (n.flags |= 128, Uo(s, !1), e = p.updateQueue, n.updateQueue = e, Fl(n, e), n.subtreeFlags = 0, e = o, o = n.child; o !== null;) Hc(o, e), o = o.sibling;
                                    return Y(ze, ze.current & 1 | 2), ge && $t(n, s.treeForkCount), n.child
                                }
                                e = e.sibling
                            }
                        s.tail !== null && ht() > Ql && (n.flags |= 128, d = !0, Uo(s, !1), n.lanes = 4194304)
                    }
                else {
                    if (!d)
                        if (e = Ul(p), e !== null) {
                            if (n.flags |= 128, d = !0, e = e.updateQueue, n.updateQueue = e, Fl(n, e), Uo(s, !0), s.tail === null && s.tailMode === "hidden" && !p.alternate && !ge) return be(n), null
                        } else 2 * ht() - s.renderingStartTime > Ql && o !== 536870912 && (n.flags |= 128, d = !0, Uo(s, !1), n.lanes = 4194304);
                    s.isBackwards ? (p.sibling = n.child, n.child = p) : (e = s.last, e !== null ? e.sibling = p : n.child = p, s.last = p)
                }
                return s.tail !== null ? (e = s.tail, s.rendering = e, s.tail = e.sibling, s.renderingStartTime = ht(), e.sibling = null, o = ze.current, Y(ze, d ? o & 1 | 2 : o & 1), ge && $t(n, s.treeForkCount), e) : (be(n), null);
            case 22:
            case 23:
                return Et(n), Vs(), s = n.memoizedState !== null, e !== null ? e.memoizedState !== null !== s && (n.flags |= 8192) : s && (n.flags |= 8192), s ? (o & 536870912) !== 0 && (n.flags & 128) === 0 && (be(n), n.subtreeFlags & 6 && (n.flags |= 8192)) : be(n), o = n.updateQueue, o !== null && Fl(n, o.retryQueue), o = null, e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (o = e.memoizedState.cachePool.pool), s = null, n.memoizedState !== null && n.memoizedState.cachePool !== null && (s = n.memoizedState.cachePool.pool), s !== o && (n.flags |= 2048), e !== null && z(jn), null;
            case 24:
                return o = null, e !== null && (o = e.memoizedState.cache), n.memoizedState.cache !== o && (n.flags |= 2048), jt(ke), be(n), null;
            case 25:
                return null;
            case 30:
                return null
    ...
    function Jy(e, n) {
        switch (Cs(n), n.tag) {
            ...
            case 3:
                return jt(ke), Ve(), e = n.flags, (e & 65536) !== 0 && (e & 128) === 0 ? (n.flags = e & -65537 | 128, n) : null;
            case 26:
            case 27:
            case 5:
                return tl(n), null;
            case 31:
                if (n.memoizedState !== null) {
                    if (Et(n), n.alternate === null) throw Error(a(340));
                    Zn()
                }
                return e = n.flags, e & 65536 ? (n.flags = e & -65537 | 128, n) : null;
            case 13:
            ...
            case 4:
                return Ve(), null;
            case 10:
                return jt(n.type), null;
            case 22:
            case 23:
                return Et(n), Vs(), e !== null && z(jn), e = n.flags, e & 65536 ? (n.flags = e & -65537 | 128, n) : null;
            case 24:
                return jt(ke), null;
            case 25:
                return null;
    ...
    function dd(e, n, o) {
        o.props = oi(e.type, e.memoizedProps), o.state = e.memoizedState;
        try {
    ...
    function vr(e, n, o) {
        var s = e.tag;
        if (s === 5 || s === 6) e = e.stateNode, n ? (o.nodeType === 9 ? o.body : o.nodeName === "HTML" ? o.ownerDocument.body : o).insertBefore(e, n) : (n = o.nodeType === 9 ? o.body : o.nodeName === "HTML" ? o.ownerDocument.body : o, n.appendChild(e), o = o._reactRootContainer, o != null || n.onclick !== null || (n.onclick = Kt));
        else if (s !== 4 && (s === 27 && Ln(e.type) && (o = e.stateNode, n = null), e = e.child, e !== null))
            for (vr(e, n, o), e = e.sibling; e !== null;) vr(e, n, o), e = e.sibling
    }

    function Yl(e, n, o) {
        var s = e.tag;
        if (s === 5 || s === 6) e = e.stateNode, n ? o.insertBefore(e, n) : o.appendChild(e);
        else if (s !== 4 && (s === 27 && Ln(e.type) && (o = e.stateNode), e = e.child, e !== null))
            for (Yl(e, n, o), e = e.sibling; e !== null;) Yl(e, n, o), e = e.sibling
    }
    ...
    function Xy(e, n) {
        if (e = e.containerInfo, Pr = da, e = Nc(e), ds(e)) {
            if ("selectionStart" in e) var o = {
                ...
                if (s && s.rangeCount !== 0) {
                    ...
                    var T = 0,
                        ...
                        x = null;
                    t: for (;;) {
                        for (var w; V !== o || d !== 0 && V.nodeType !== 3 || (_ = T + d), V !== p || s !== 0 && V.nodeType !== 3 || (A = T + s), V.nodeType === 3 && (T += V.nodeValue.length), (w = V.firstChild) !== null;) x = V, V = w;
                        for (;;) {
                            if (V === e) break t;
                            if (x === o && ++D === d && (_ = T), x === p && ++G === s && (A = T), (w = V.nextSibling) !== null) break;
                            V = x, x = V.parentNode
                        }
                        V = w
                    }
        ...
        for (Br = {
            ...
            if (n = Ke, e = n.child, (n.subtreeFlags & 1028) !== 0 && e !== null) e.return = n, Ke = e;
            else
                for (; Ke !== null;) {
                    switch (n = Ke, p = n.alternate, e = n.flags, n.tag) {
                        case 0:
                        ...
                        case 3:
                            if ((e & 1024) !== 0) {
                                if (e = n.stateNode.containerInfo, o = e.nodeType, o === 9) Fr(e);
    ...
    function yd(e, n, o) {
        ...
        switch (o.tag) {
            ...
            case 1:
                if (sn(e, o), s & 4)
                    if (e = o.stateNode, n === null) try {
                        ...
                        var d = oi(o.type, n.memoizedProps);
                        n = n.memoizedState;
                        try {
                ...
                s & 64 && fd(o), s & 512 && bo(o, o.return);
                break;
            case 3:
                if (sn(e, o), s & 64 && (e = o.updateQueue, e !== null)) {
            ...
            case 26:
            case 5:
                sn(e, o), n === null && s & 4 && pd(o), s & 512 && bo(o, o.return);
                break;
            case 12:
                sn(e, o);
                break;
            case 31:
                ...
                break;
            case 13:
                sn(e, o), s & 4 && Ed(e, o), s & 64 && (e = o.memoizedState, e !== null && (e = e.dehydrated, e !== null && (o = nv.bind(null, o), _v(e, o))));
                break;
            case 22:
                if (s = o.memoizedState !== null || ln, !s) {
                    n = n !== null && n.memoizedState !== null || Ye, d = ln;
                    var p = Ye;
                    ln = s, (Ye = n) && !p ? rn(e, o, (o.subtreeFlags & 8772) !== 0) : sn(e, o), ln = d, Ye = p
                }
                break;
            case 30:
                break;
    ...
    function vd(e) {
        var n = e.alternate;
        n !== null && (e.alternate = null, vd(n)), e.child = null, e.deletions = null, e.sibling = null, e.tag === 5 && (n = e.stateNode, n !== null && Qa(n)), e.stateNode = null, e.return = null, e.dependencies = null, e.memoizedProps = null, e.memoizedState = null, e.pendingProps = null, e.stateNode = null, e.updateQueue = null
    }
    var Le = null,
        ct = !1;

    function an(e, n, o) {
        for (o = o.child; o !== null;) Td(e, n, o), o = o.sibling
    }

    function Td(e, n, o) {
        if (gt && typeof gt.onCommitFiberUnmount == "function") try {
            gt.onCommitFiberUnmount(no, o)
        } catch {}
        switch (o.tag) {
            case 26:
                Ye || Yt(o, n), an(e, n, o), o.memoizedState ? o.memoizedState.count-- : o.stateNode && (o = o.stateNode, o.parentNode.removeChild(o));
                break;
            case 27:
                Ye || Yt(o, n);
                var s = Le,
                    d = ct;
                Ln(o.type) && (Le = o.stateNode, ct = !1), an(e, n, o), ko(o.stateNode), Le = s, ct = d;
                break;
            case 5:
                Ye || Yt(o, n);
            case 6:
                if (s = Le, d = ct, Le = null, an(e, n, o), Le = s, ct = d, Le !== null)
                    if (ct) try {
                ...
                break;
            case 18:
                Le !== null && (ct ? (e = Le, fp(e.nodeType === 9 ? e.body : e.nodeName === "HTML" ? e.ownerDocument.body : e, o.stateNode), Ji(e)) : fp(Le, o.stateNode));
                break;
            case 4:
                s = Le, d = ct, Le = o.stateNode.containerInfo, ct = !0, an(e, n, o), Le = s, ct = d;
                break;
            case 0:
            case 11:
            case 14:
            case 15:
                Nn(2, o, n), Ye || Nn(4, o, n), an(e, n, o);
                break;
            case 1:
                Ye || (Yt(o, n), s = o.stateNode, typeof s.componentWillUnmount == "function" && dd(o, n, s)), an(e, n, o);
                break;
            case 21:
                an(e, n, o);
                break;
            case 22:
                Ye = (s = Ye) || o.memoizedState !== null, an(e, n, o), Ye = s;
                break;
            default:
                an(e, n, o)
        }
    ...
    function Ky(e) {
        switch (e.tag) {
            ...
            case 19:
                var n = e.stateNode;
                return n === null && (n = e.stateNode = new gd), n;
            case 22:
                return e = e.stateNode, n = e._retryCache, n === null && (n = e._retryCache = new gd), n;
            default:
    ...
    function ft(e, n) {
        ...
        if (o !== null)
            for (var s = 0; s < o.length; s++) {
                ...
                Td(p, T, d), Le = null, ct = !1, p = d.alternate, p !== null && (p.return = null), d.return = null
            }
    ...
    function _d(e, n) {
        ...
        switch (e.tag) {
            ...
            case 14:
            case 15:
                ft(n, e), dt(e), s & 4 && (Nn(3, e, e.return), wo(3, e), Nn(5, e, e.return));
                break;
            case 1:
                ft(n, e), dt(e), s & 512 && (Ye || o === null || Yt(o, o.return)), s & 64 && ln && (e = e.updateQueue, e !== null && (s = e.callbacks, s !== null && (o = e.shared.hiddenCallbacks, e.shared.hiddenCallbacks = o === null ? s : o.concat(s))));
                break;
            case 26:
                var d = Vt;
                if (ft(n, e), dt(e), s & 512 && (Ye || o === null || Yt(o, o.return)), s & 4) {
                            ...
                            if (e.stateNode === null) {
                                e: {
                                    ...
                                    d = d.ownerDocument || d;t: switch (s) {
                                        case "title":
                                            p = d.getElementsByTagName("title")[0], (!p || p[lo] || p[Ze] || p.namespaceURI === "http://www.w3.org/2000/svg" || p.hasAttribute("itemprop")) && (p = d.createElement(s), d.head.insertBefore(p, d.querySelector("head > title"))), et(p, s, o), p[Ze] = e, Xe(p), s = p;
                                            break e;
                                        case "link":
                                            var T = _p("link", "href", d).get(s + (o.href || ""));
                                            if (T) {
                                            ...
                                            p = d.createElement(s), et(p, s, o), d.head.appendChild(p);
                                            break;
                                        case "meta":
                                            if (T = _p("meta", "content", d).get(s + (o.content || ""))) {
                    ...
                    else Cp(d, e.type, e.stateNode);
                    else e.stateNode = Ep(d, s, e.memoizedProps);
                    else p !== s ? (p === null ? o.stateNode !== null && (o = o.stateNode, o.parentNode.removeChild(o)) : p.count--, s === null ? Cp(d, e.type, e.stateNode) : Ep(d, s, e.memoizedProps)) : s === null && e.stateNode !== null && gr(e, e.memoizedProps, o.memoizedProps)
                }
                break;
            case 27:
                ft(n, e), dt(e), s & 512 && (Ye || o === null || Yt(o, o.return)), o !== null && s & 4 && gr(e, e.memoizedProps, o.memoizedProps);
                break;
            case 5:
                if (ft(n, e), dt(e), s & 512 && (Ye || o === null || Yt(o, o.return)), e.flags & 32) {
                    d = e.stateNode;
                    try {
                        hi(d, "")
                    } catch (Q) {
                ...
                s & 4 && e.stateNode != null && (d = e.memoizedProps, gr(e, d, o !== null ? o.memoizedProps : d)), s & 1024 && (Tr = !0);
                break;
            case 6:
                if (ft(n, e), dt(e), s & 4) {
                ...
                break;
            case 3:
                if (ra = null, d = Vt, Vt = aa(n.containerInfo), ft(n, e), Vt = d, dt(e), s & 4 && o !== null && o.memoizedState.isDehydrated) try {
                    Ji(n.containerInfo)
                } catch (Q) {
                    Re(e, e.return, Q)
                }
                ...
                break;
            case 4:
                s = Vt, Vt = aa(e.stateNode.containerInfo), ft(n, e), dt(e), Vt = s;
                break;
            case 12:
                ft(n, e), dt(e);
                break;
            case 31:
                ft(n, e), dt(e), s & 4 && (s = e.updateQueue, s !== null && (e.updateQueue = null, Jl(e, s)));
                break;
            case 13:
                ft(n, e), dt(e), e.child.flags & 8192 && e.memoizedState !== null != (o !== null && o.memoizedState !== null) && (Kl = ht()), s & 4 && (s = e.updateQueue, s !== null && (e.updateQueue = null, Jl(e, s)));
                break;
            case 22:
                ...
                var A = o !== null && o.memoizedState !== null,
                    D = ln,
                    G = Ye;
                if (ln = D || d, Ye = G || A, ft(n, e), Ye = G, ln = D, dt(e), s & 8192) e: for (n = e.stateNode, n._visibility = d ? n._visibility & -2 : n._visibility | 1, d && (o === null || A || ln || Ye || li(e)), o = null, n = e;;) {
                    if (n.tag === 5 || n.tag === 26) {
                        if (o === null) {
                            A = o = n;
                            try {
                                if (p = A.stateNode, d) T = p.style, typeof T.setProperty == "function" ? T.setProperty("display", "none", "important") : T.display = "none";
                                    ...
                                    _.style.display = x == null || typeof x == "boolean" ? "" : ("" + x).trim()
                                }
                            } catch (Q) {
                                Re(A, A.return, Q)
                            }
                ...
                s & 4 && (s = e.updateQueue, s !== null && (o = s.retryQueue, o !== null && (s.retryQueue = null, Jl(e, o))));
                break;
            case 19:
                ft(n, e), dt(e), s & 4 && (s = e.updateQueue, s !== null && (e.updateQueue = null, Jl(e, s)));
                break;
    ...
    function Cd(e) {
        if (e.subtreeFlags & 1024)
            for (e = e.child; e !== null;) {
                var n = e;
                Cd(n), n.tag === 5 && n.flags & 1024 && n.stateNode.reset(), e = e.sibling
            }
    }

    function sn(e, n) {
        if (n.subtreeFlags & 8772)
            for (n = n.child; n !== null;) yd(e, n.alternate, n), n = n.sibling
    }
    ...
    function li(e) {
        for (e = e.child; e !== null;) {
            ...
            switch (n.tag) {
                ...
                case 14:
                case 15:
                    Nn(4, n, n.return), li(n);
                    break;
                case 1:
                    Yt(n, n.return);
                    var o = n.stateNode;
                    typeof o.componentWillUnmount == "function" && dd(n, n.return, o), li(n);
                    break;
                case 27:
                    ko(n.stateNode);
                case 26:
        ...
        for (o = o && (n.subtreeFlags & 8772) !== 0, n = n.child; n !== null;) {
            ...
            switch (p.tag) {
                ...
                case 15:
                    ...
                    break;
                case 1:
                    if (rn(d, p, o), s = p, d = s.stateNode, typeof d.componentDidMount == "function") try {
                        d.componentDidMount()
                    } catch (D) {
                        Re(s, s.return, D)
                    }
                    if (s = p, d = s.updateQueue, d !== null) {
                        ...
                        try {
                            ...
                            if (A !== null)
                                for (d.shared.hiddenCallbacks = null, d = 0; d < A.length; d++) jc(A[d], _)
                        } catch (D) {
                            Re(s, s.return, D)
                        }
                    }
                    o && T & 64 && fd(p), bo(p, p.return);
                    break;
                case 27:
                    hd(p);
                case 26:
                case 5:
                    rn(d, p, o), o && s === null && T & 4 && pd(p), bo(p, p.return);
                    break;
                case 12:
                    rn(d, p, o);
                    break;
                case 31:
                    rn(d, p, o), o && T & 4 && Sd(d, p);
                    break;
                case 13:
                    rn(d, p, o), o && T & 4 && Ed(d, p);
                    break;
                case 22:
                    p.memoizedState === null && rn(d, p, o), bo(p, p.return);
                    break;
                case 30:
                    break;
                default:
    ...
    function Sr(e, n) {
        var o = null;
        e !== null && e.memoizedState !== null && e.memoizedState.cachePool !== null && (o = e.memoizedState.cachePool.pool), e = null, n.memoizedState !== null && n.memoizedState.cachePool !== null && (e = n.memoizedState.cachePool.pool), e !== o && (e != null && e.refCount++, o != null && To(o))
    }

    function Er(e, n) {
        e = null, n.alternate !== null && (e = n.alternate.memoizedState.cache), n = n.memoizedState.cache, n !== e && (n.refCount++, e != null && To(e))
    }

    function zt(e, n, o, s) {
        if (n.subtreeFlags & 10256)
            for (n = n.child; n !== null;) Ad(e, n, o, s), n = n.sibling
    }
    ...
    function Ad(e, n, o, s) {
        ...
        switch (n.tag) {
            ...
            case 11:
            case 15:
                zt(e, n, o, s), d & 2048 && wo(9, n);
                break;
            case 1:
                zt(e, n, o, s);
                break;
            case 3:
                zt(e, n, o, s), d & 2048 && (e = null, n.alternate !== null && (e = n.alternate.memoizedState.cache), n = n.memoizedState.cache, n !== e && (n.refCount++, e != null && To(e)));
                break;
            case 12:
                if (d & 2048) {
                    zt(e, n, o, s), e = n.stateNode;
                    try {
            ...
            case 23:
                break;
            case 22:
                p = n.stateNode, T = n.alternate, n.memoizedState !== null ? p._visibility & 2 ? zt(e, n, o, s) : Lo(e, n) : p._visibility & 2 ? zt(e, n, o, s) : (p._visibility |= 2, Gi(e, n, o, s, (n.subtreeFlags & 10256) !== 0 || !1)), d & 2048 && Sr(T, n);
                break;
            case 24:
                zt(e, n, o, s), d & 2048 && Er(n.alternate, n);
                break;
            default:
                zt(e, n, o, s)
        }
    ...
    function Gi(e, n, o, s, d) {
        for (d = d && ((n.subtreeFlags & 10256) !== 0 || !1), n = n.child; n !== null;) {
            ...
            switch (T.tag) {
                ...
                case 22:
                    var G = T.stateNode;
                    T.memoizedState !== null ? G._visibility & 2 ? Gi(p, T, _, A, d) : Lo(p, T) : (G._visibility |= 2, Gi(p, T, _, A, d)), d && D & 2048 && Sr(T.alternate, T);
                    break;
                case 24:
                    Gi(p, T, _, A, d), d && D & 2048 && Er(T.alternate, T);
                    break;
                default:
                    Gi(p, T, _, A, d)
            }
    ...
    function Lo(e, n) {
        if (n.subtreeFlags & 10256)
            for (n = n.child; n !== null;) {
                ...
                switch (s.tag) {
                    case 22:
                        Lo(o, s), d & 2048 && Sr(s.alternate, s);
                        break;
                    case 24:
                        Lo(o, s), d & 2048 && Er(s.alternate, s);
                        break;
                    default:
                        Lo(o, s)
                }
    ...
    function Hi(e, n, o) {
        if (e.subtreeFlags & Go)
            for (e = e.child; e !== null;) Rd(e, n, o), e = e.sibling
    }

    function Rd(e, n, o) {
        switch (e.tag) {
            case 26:
                Hi(e, n, o), e.flags & Go && e.memoizedState !== null && Lv(o, Vt, e.memoizedState, e.memoizedProps);
                break;
            case 5:
                Hi(e, n, o);
                break;
            ...
            case 4:
                var s = Vt;
                Vt = aa(e.stateNode.containerInfo), Hi(e, n, o), Vt = s;
                break;
            case 22:
                e.memoizedState === null && (s = e.alternate, s !== null && s.memoizedState !== null ? (s = Go, Go = 16777216, Hi(e, n, o), Go = s) : Hi(e, n, o));
                break;
            default:
                Hi(e, n, o)
        }
    ...
    function Nd(e) {
        switch (e.tag) {
            ...
            case 11:
            case 15:
                Ho(e), e.flags & 2048 && Nn(9, e, e.return);
                break;
            case 3:
                Ho(e);
                break;
            ...
            case 22:
                var n = e.stateNode;
                e.memoizedState !== null && n._visibility & 2 && (e.return === null || e.return.tag !== 13) ? (n._visibility &= -3, Xl(e)) : Ho(e);
                break;
            default:
                Ho(e)
        }
        ...
        for (; Ke !== null;) {
            ...
            switch (o.tag) {
                ...
                case 22:
                    ...
                    break;
                case 24:
                    To(o.memoizedState.cache)
            }
            if (s = o.child, s !== null) s.return = o, Ke = s;
    ...
    function At() {
        return (Se & 2) !== 0 && pe !== 0 ? pe & -pe : L.T !== null ? br() : Yu()
    }
    ...
    function Ud() {
        if (Ct === 0)
            if ((pe & 536870912) === 0 || ge) {
                var e = ol;
                ol <<= 1, (ol & 3932160) === 0 && (ol = 262144), Ct = e
            } else Ct = 536870912;
        return e = St.current, e !== null && (e.flags |= 32), Ct
    }

    function mt(e, n, o) {
        (e === Ue && (Ae === 2 || Ae === 9) || e.cancelPendingCommit !== null) && (Pi(e, 0), wn(e, pe, Ct, !1)), oo(e, o), ((Se & 2) === 0 || e !== Ue) && (e === Ue && ((Se & 2) === 0 && (ai |= o), qe === 4 && wn(e, pe, Ct, !1)), Jt(e))
    }

    function wd(e, n, o) {
        if ((Se & 6) !== 0) throw Error(a(327));
        var s = !o && (n & 127) === 0 && (n & e.expiredLanes) === 0 || io(e, n),
            d = s ? jy(e, n) : Dr(e, n, !0),
            p = s;
        do {
            if (d === 0) {
                ...
                if (o = e.current.alternate, p && !$y(o)) {
                    d = Dr(e, n, !1), p = !1;
                    continue
                }
                if (d === 2) {
                    ...
                    if (T !== 0) {
                        ...
                        e: {
                            ...
                            if (A && (Pi(_, T).flags |= 256), T = Dr(_, T, !1), T !== 2) {
                                if (_r && !A) {
                                    _.errorRecoveryDisabledLanes |= p, ai |= p, d = 4;
                                    break e
                                }
                                p = pt, pt = d, p !== null && (pt === null ? pt = p : pt.push.apply(pt, p))
                            }
                            d = T
                        }
                        if (p = !1, d !== 2) continue
                ...
                e: {
                    ...
                    if ((n & 62914560) === n && (d = Kl + 300 - ht(), 10 < d)) {
                        if (wn(s, n, Ct, !In), al(s, 0, !0) !== 0) break e;
                        cn = n, s.timeoutHandle = up(bd.bind(null, s, o, pt, Zl, Ar, n, Ct, ai, Vi, In, p, "Throttled", -0, 0), d);
                        break e
                    }
                    bd(s, o, pt, Zl, Ar, n, Ct, ai, Vi, In, p, null, -0, 0)
                }
            }
            break
        } while (!0);
    ...
    function bd(e, n, o, s, d, p, T, _, A, D, G, V, x, w) {
        if (e.timeoutHandle = -1, V = n.subtreeFlags, V & 8192 || (V & 16785408) === 16785408) {
            V = {
                stylesheets: null,
                count: 0,
                imgCount: 0,
            ...
            var Q = (p & 62914560) === p ? Kl - ht() : (p & 4194048) === p ? Dd - ht() : 0;
            if (Q = Gv(V, Q), Q !== null) {
                cn = p, e.cancelPendingCommit = Q(Bd.bind(null, e, n, p, o, s, d, T, _, A, G, V, null, x, w)), wn(e, p, T, !D);
                return
            }
        }
        Bd(e, n, p, o, s, d, T, _, A)
    }
    ...
    function wn(e, n, o, s) {
        n &= ~Cr, n &= ~ai, e.suspendedLanes |= n, e.pingedLanes &= ~n, s && (e.warmLanes |= n), s = e.expirationTimes;
        for (var d = n; 0 < d;) {
            var p = 31 - yt(d),
                T = 1 << p;
            s[p] = -1, d &= ~T
    ...
    function $l() {
        return (Se & 6) === 0 ? (zo(0), !1) : !0
    }

    function Ir() {
        if (ce !== null) {
            if (Ae === 0) var e = ce.return;
            else e = ce, Wt = $n = null, Fs(e), xi = null, Eo = 0, e = ce;
    ...
    function Pi(e, n) {
        ...
        o !== -1 && (e.timeoutHandle = -1, yv(o)), o = e.cancelPendingCommit, o !== null && (e.cancelPendingCommit = null, o()), cn = 0, Ir(), Ue = e, ce = o = Zt(e.current, null), pe = n, Ae = 0, _t = null, In = !1, qi = io(e, n), _r = !1, Vi = Ct = Cr = ai = Dn = qe = 0, pt = qo = null, Ar = !1, (n & 8) !== 0 && (n |= n & 32);
    ...
    function Ld(e, n) {
        se = null, L.H = Do, n === Di || n === Ml ? (n = Qc(), Ae = 3) : n === ws ? (n = Qc(), Ae = 4) : Ae = n === ar ? 8 : n !== null && typeof n == "object" && typeof n.then == "function" ? 6 : 1, _t = n, ce === null && (qe = 1, Pl(e, It(n, e.current)))
    }

    function Gd() {
        var e = St.current;
        return e === null ? !0 : (pe & 4194048) === pe ? wt === null : (pe & 62914560) === pe || (pe & 536870912) !== 0 ? e === wt : !1
    }
    ...
    function Wl() {
        qe = 4, In || (pe & 4194048) !== pe && St.current !== null || (qi = !0), (Dn & 134217727) === 0 && (ai & 134217727) === 0 || Ue === null || wn(Ue, pe, Ct, !1)
    }
    ...
    function Dr(e, n, o) {
        ...
        e: do try {
                if (Ae !== 0 && ce !== null) {
                    ...
                    switch (Ae) {
                        ...
                        case 6:
                            St.current === null && (n = !0);
                            var D = Ae;
                            if (Ae = 0, _t = null, Bi(e, _, A, D), o && qi) {
                                T = 0;
                                break e
                            }
                            break;
                        default:
                            D = Ae, Ae = 0, _t = null, Bi(e, _, A, D)
                    }
                }
                Wy(), T = qe;
                break
            ...
            while (!0);
            return n && e.shellSuspendCounter++, Wt = $n = null, Se = s, L.H = d, L.A = p, ce === null && (Ue = null, pe = 0, vl()), T
    }
    ...
    function jy(e, n) {
        ...
        var s = Hd(),
            d = qd();
        Ue !== e || pe !== n ? (Zl = null, Ql = ht() + 500, Pi(e, n)) : qi = io(e, n);
        e: do try {
                if (Ae !== 0 && ce !== null) {
                    n = ce;
                    var p = _t;
                    t: switch (Ae) {
                        ...
                        case 4:
                            ...
                            break e;
                        case 7:
                            Xc(p) ? (Ae = 0, _t = null, zd(n)) : (Ae = 0, _t = null, Bi(e, n, p, 7));
                            break;
                        case 5:
                            var T = null;
                            switch (ce.tag) {
                                ...
                                case 27:
                                    var _ = ce;
                                    if (T ? Ap(T) : _.stateNode.complete) {
                                        Ae = 0, _t = null;
                                        var A = _.sibling;
                                        if (A !== null) ce = A;
                                        else {
                                            var D = _.return;
                                            D !== null ? (ce = D, jl(D)) : ce = null
                                        }
                                        break t
                                    }
                            }
                            Ae = 0, _t = null, Bi(e, n, p, 5);
                            break;
                        case 6:
                            Ae = 0, _t = null, Bi(e, n, p, 6);
                            break;
                        case 8:
                            Ir(), qe = 6;
                            break e;
            ...
            while (!0);
            return Wt = $n = null, L.H = s, L.A = d, Se = o, ce !== null ? 0 : (Ue = null, pe = 0, vl(), qe)
    }

    function ev() {
        for (; ce !== null && !Cg();) Vd(ce)
    }

    function Vd(e) {
        var n = rd(e.alternate, e, un);
        e.memoizedProps = e.pendingProps, n === null ? jl(e) : ce = n
    }
    ...
    function zd(e) {
        ...
        switch (n.tag) {
            case 15:
            case 0:
                n = nd(o, n, n.pendingProps, n.type, void 0, pe);
                break;
            case 11:
                n = nd(o, n, n.pendingProps, n.type.render, n.ref, pe);
                break;
            case 5:
                Fs(n);
            default:
                cd(o, n), n = ce = Hc(n, un), n = rd(o, n, un)
        }
        e.memoizedProps = e.pendingProps, n === null ? jl(e) : ce = n
    }

    function Bi(e, n, o, s) {
        Wt = $n = null, Fs(n), xi = null, Eo = 0;
        var d = n.return;
        try {
            if (ky(e, d, n, o, pe)) {
                qe = 1, Pl(e, It(o, e.current)), ce = null;
                return
            }
        } catch (p) {
        ...
        n.flags & 32768 ? (ge || s === 1 ? e = !0 : qi || (pe & 536870912) !== 0 ? e = !1 : (In = e = !0, (s === 2 || s === 9 || s === 3 || s === 6) && (s = St.current, s !== null && s.tag === 13 && (s.flags |= 16384))), Pd(n, e)) : jl(n)
    }
    ...
    function Bd(e, n, o, s, d, p, T, _, A) {
        e.cancelPendingCommit = null;
        do ea(); while (Je !== 0);
        if ((Se & 6) !== 0) throw Error(a(327));
        if (n !== null) {
            if (n === e.current) throw Error(a(177));
            if (p = n.lanes | n.childLanes, p |= ys, bg(e, o, p, T, _, A), e === Ue && (ce = Ue = null, pe = 0), zi = n, Un = e, cn = o, Rr = p, Mr = d, xd = s, (n.subtreeFlags & 10256) !== 0 || (n.flags & 10256) !== 0 ? (e.callbackNode = null, e.callbackPriority = 0, ov(nl, function() {
                    return Jd(), null
                })) : (e.callbackNode = null, e.callbackPriority = 0), s = (n.flags & 13878) !== 0, (n.subtreeFlags & 13878) !== 0 || s) {
                s = L.T, L.T = null, d = O.p, O.p = 2, T = Se, Se |= 4;
                try {
                    Xy(e, n, o)
                } finally {
                    Se = T, O.p = d, L.T = s
        ...
        if (Je === 1) {
            ...
            if ((n.subtreeFlags & 13878) !== 0 || o) {
                ...
                try {
                    _d(n, e);
                    var p = Br,
                        T = Nc(e.containerInfo),
                        _ = p.focusedElem,
                        A = p.selectionRange;
                    if (T !== _ && _ && _.ownerDocument && Mc(_.ownerDocument.documentElement, _)) {
                        if (A !== null && ds(_)) {
                            var D = A.start,
                                G = A.end;
                            if (G === void 0 && (G = D), "selectionStart" in _) _.selectionStart = D, _.selectionEnd = Math.min(G, _.value.length);
                            else {
                                ...
                                if (x.getSelection) {
                                    var w = x.getSelection(),
                                        ...
                                        De = A.end === void 0 ? ne : Math.min(A.end, Q);
                                    !w.extend && ne > De && (T = De, De = ne, ne = T);
                                    var N = Rc(_, ne),
                                        R = Rc(_, De);
                                    if (N && R && (w.rangeCount !== 1 || w.anchorNode !== N.node || w.anchorOffset !== N.offset || w.focusNode !== R.node || w.focusOffset !== R.offset)) {
                                        var I = V.createRange();
                                        I.setStart(N.node, N.offset), w.removeAllRanges(), ne > De ? (w.addRange(I), w.extend(R.node, R.offset)) : (I.setEnd(R.node, R.offset), w.addRange(I))
                                    }
                                }
                            }
                        }
                        for (V = [], w = _; w = w.parentNode;) w.nodeType === 1 && V.push({
                            element: w,
                            left: w.scrollLeft,
                            top: w.scrollTop
                        });
                        for (typeof _.focus == "function" && _.focus(), _ = 0; _ < V.length; _++) {
                            var q = V[_];
    ...
    function Fd() {
        if (Je === 4 || Je === 3) {
            ...
            var e = Un,
                ...
                o = cn,
                s = xd;
            (n.subtreeFlags & 10256) !== 0 || (n.flags & 10256) !== 0 ? Je = 5 : (Je = 0, zi = Un = null, Yd(e, e.pendingLanes));
            var d = e.pendingLanes;
            if (d === 0 && (xn = null), Xa(o), n = n.stateNode, gt && typeof gt.onCommitFiberRoot == "function") try {
                gt.onCommitFiberRoot(no, n, void 0, (n.current.flags & 128) === 128)
            } catch {}
            if (s !== null) {
                n = L.T, d = O.p, O.p = 2, L.T = null;
                try {
            ...
            }(cn & 3) !== 0 && ea(), Jt(e), d = e.pendingLanes, (o & 261930) !== 0 && (d & 42) !== 0 ? e === Nr ? Vo++ : (Vo = 0, Nr = e) : Vo = 0, zo(0)
        }
    }

    function Yd(e, n) {
        (e.pooledCacheLanes &= n) === 0 && (n = e.pooledCache, n != null && (e.pooledCache = null, To(n)))
    }
    ...
    function Jd() {
        ...
        var o = Xa(cn),
            ...
            d = O.p;
        try {
            O.p = 32 > o ? 32 : o, L.T = null, o = Mr, Mr = null;
            var p = Un,
                T = cn;
            if (Je = 0, zi = Un = null, cn = 0, (Se & 6) !== 0) throw Error(a(331));
            var _ = Se;
            if (Se |= 4, Nd(p.current), Ad(p, p.current, T, o), Se = _, zo(0, !1), gt && typeof gt.onPostCommitFiberRoot == "function") try {
                gt.onPostCommitFiberRoot(no, p)
            } catch {}
            return !0
        } finally {
            O.p = d, L.T = s, Yd(e, n)
    ...
    function Xd(e, n, o) {
        n = It(o, n), n = lr(e.stateNode, n, 2), e = An(e, n, 2), e !== null && (oo(e, 2), Jt(e))
    }
        ...
        if (e.tag === 3) Xd(e, e, o);
            ...
            for (; n !== null;) {
                if (n.tag === 3) {
                    ...
                    var s = n.stateNode;
                    if (typeof n.type.getDerivedStateFromError == "function" || typeof s.componentDidCatch == "function" && (xn === null || !xn.has(s))) {
                        e = It(o, e), o = Kf(2), s = An(n, o, 2), s !== null && (Qf(o, s, n, e), oo(s, 2), Jt(s));
                        break
                    }
                }
                n = n.return
    ...
    function xr(e, n, o) {
        ...
        d.has(o) || (_r = !0, d.add(o), e = tv.bind(null, e, n, o), n.then(e, e))
    }

    function tv(e, n, o) {
        var s = e.pingCache;
        s !== null && s.delete(n), e.pingedLanes |= e.suspendedLanes & o, e.warmLanes &= ~o, Ue === e && (pe & o) === o && (qe === 4 || qe === 3 && (pe & 62914560) === pe && 300 > ht() - Kl ? (Se & 2) === 0 && Pi(e, 0) : Cr |= o, Vi === pe && (Vi = 0)), Jt(e)
    }

    function Kd(e, n) {
        n === 0 && (n = Bu()), e = Kn(e, n), e !== null && (oo(e, n), Jt(e))
    }

    function nv(e) {
        var n = e.memoizedState,
            o = 0;
        n !== null && (o = n.retryLane), Kd(e, o)
    }
    ...
    function Jt(e) {
        e !== ki && e.next === null && (ki === null ? ta = ki = e : ki = ki.next = e), na = !0, Ur || (Ur = !0, av())
    }
                    ...
                    if (e !== 0) {
                        ...
                        if (d === 0) var p = 0;
                            ...
                            var T = s.suspendedLanes,
                                _ = s.pingedLanes;
                            p = (1 << 31 - yt(42 | e) + 1) - 1, p &= d & ~(T & ~_), p = p & 201326741 ? p & 201326741 | 1 : p ? p | 2 : 0
                        }
                        p !== 0 && (o = !0, Wd(s, p))
                    } else p = pe, p = al(s, s === Ue ? p : 0, s.cancelPendingCommit !== null || s.timeoutHandle !== -1), (p & 3) === 0 || io(s, p) || (o = !0, Wd(s, p));
                    s = s.next
                }
            while (o);
            wr = !1
    ...
    function Qd() {
        ...
        var e = 0;
        bn !== 0 && gv() && (e = bn);
        for (var n = ht(), o = null, s = ta; s !== null;) {
            var d = s.next,
                p = Zd(s, n);
            p === 0 ? (s.next = null, o === null ? ta = d : o.next = d, d === null && (ki = o)) : (o = s, (e !== 0 || (p & 3) !== 0) && (na = !0)), s = d
        }
        Je !== 0 && Je !== 5 || zo(e), bn !== 0 && (bn = 0)
    }
    ...
    function Zd(e, n) {
        for (var o = e.suspendedLanes, s = e.pingedLanes, d = e.expirationTimes, p = e.pendingLanes & -62914561; 0 < p;) {
            var T = 31 - yt(p),
                _ = 1 << T,
                A = d[T];
            A === -1 ? ((_ & o) === 0 || (_ & s) !== 0) && (d[T] = wg(_, n)) : A <= n && (e.expiredLanes |= _), p &= ~_
        }
        if (n = Ue, o = pe, o = al(e, e === n ? o : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), s = e.callbackNode, o === 0 || e === n && (Ae === 2 || Ae === 9) || e.cancelPendingCommit !== null) return s !== null && s !== null && Fa(s), e.callbackNode = null, e.callbackPriority = 0;
        if ((o & 3) === 0 || io(e, o)) {
            if (n = o & -o, n === e.callbackPriority) return n;
            switch (s !== null && Fa(s), Xa(o)) {
                case 2:
                case 8:
                    o = zu;
                    break;
            ...
            return s = $d.bind(null, e), o = Oa(o, s), e.callbackPriority = n, e.callbackNode = o, n
        }
        return s !== null && s !== null && Fa(s), e.callbackPriority = 2, e.callbackNode = null, 2
    }

    function $d(e, n) {
        if (Je !== 0 && Je !== 5) return e.callbackNode = null, e.callbackPriority = 0, null;
        var o = e.callbackNode;
        if (ea() && e.callbackNode !== o) return null;
        var s = pe;
        return s = al(e, e === Ue ? s : 0, e.cancelPendingCommit !== null || e.timeoutHandle !== -1), s === 0 ? null : (wd(e, s, n), Zd(e, ht()), e.callbackNode != null && e.callbackNode === o ? $d.bind(null, e) : null)
    }
    ...
    function br() {
        if (bn === 0) {
            var e = Ni;
            e === 0 && (e = il, il <<= 1, (il & 261888) === 0 && (il = 256)), bn = e
        }
        return bn
    }
    ...
    function sv(e, n, o, s, d) {
        if (n === "submit" && o && o.stateNode === d) {
            var p = jd((d[rt] || null).action),
                T = s.submitter;
            T && (n = (n = T[rt] || null) ? jd(n.formAction) : T.getAttribute("formAction"), n !== null && (p = n, T = null));
            var _ = new ml("action", "action", null, s, d);
            e.push({
                event: _,
                listeners: [{
                    instance: null,
                    listener: function() {
                        ...
                        } else typeof p == "function" && (_.preventDefault(), A = T ? ep(d, T) : new FormData(d), js(o, {
                            pending: !0,
                            data: A,
                            method: d.method,
                            action: p
    ...
    for (var Lr = 0; Lr < gs.length; Lr++) {
        var Gr = gs[Lr],
            rv = Gr.toLowerCase(),
            uv = Gr[0].toUpperCase() + Gr.slice(1);
        qt(rv, "on" + uv)
    }
    qt(xc, "onAnimationEnd"), qt(Uc, "onAnimationIteration"), qt(wc, "onAnimationStart"), qt("dblclick", "onDoubleClick"), qt("focusin", "onFocus"), qt("focusout", "onBlur"), qt(Ry, "onTransitionRun"), qt(My, "onTransitionStart"), qt(Ny, "onTransitionCancel"), qt(bc, "onTransitionEnd"), pi("onMouseEnter", ["mouseout", "mouseover"]), pi("onMouseLeave", ["mouseout", "mouseover"]), pi("onPointerEnter", ["pointerout", "pointerover"]), pi("onPointerLeave", ["pointerout", "pointerover"]), Fn("onChange", "change click focusin focusout input keydown keyup selectionchange".split(" ")), Fn("onSelect", "focusout contextmenu dragend focusin keydown keyup mousedown mouseup selectionchange".split(" ")), Fn("onBeforeInput", ["compositionend", "keypress", "textInput", "paste"]), Fn("onCompositionEnd", "compositionend focusout keydown keypress keyup mousedown".split(" ")), Fn("onCompositionStart", "compositionstart focusout keydown keypress keyup mousedown".split(" ")), Fn("onCompositionUpdate", "compositionupdate focusout keydown keypress keyup mousedown".split(" "));
    var Po = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "),
        cv = new Set("beforetoggle cancel close invalid load scroll scrollend toggle".split(" ").concat(Po));
    ...
    function fe(e, n) {
        var o = n[Ka];
        o === void 0 && (o = n[Ka] = new Set);
        var s = e + "__bubble";
        o.has(s) || (np(n, e, 2, !1), o.add(s))
    }
    ...
    function qr(e) {
        if (!e[ia]) {
            e[ia] = !0, Ku.forEach(function(o) {
                o !== "selectionchange" && (cv.has(o) || Hr(o, !1, e), Hr(o, !0, e))
            });
            var n = e.nodeType === 9 ? e : e.ownerDocument;
            n === null || n[ia] || (n[ia] = !0, Hr("selectionchange", !1, n))
        }
    }
    ...
    function np(e, n, o, s) {
        ...
        o = d.bind(null, n, o, e), d = void 0, !is || n !== "touchstart" && n !== "touchmove" && n !== "wheel" || (d = !0), s ? d !== void 0 ? e.addEventListener(n, o, {
            capture: !0,
            passive: d
    ...
    function Vr(e, n, o, s, d) {
        ...
        ac(function() {
            ...
            e: {
                ...
                if (x !== void 0) {
                    ...
                    var ne = (n & 4) !== 0,
                        ...
                        N = ne ? x !== null ? x + "Capture" : null : x;
                    ne = [];
                    for (var R = D, I; R !== null;) {
                        var q = R;
                        if (I = q.stateNode, q = q.tag, q !== 5 && q !== 26 && q !== 27 || I === null || N === null || (q = so(R, N), q != null && ne.push(Bo(R, q, I))), De) break;
                        R = R.return
                    }
                    0 < ne.length && (x = new w(x, Q, null, o, G), V.push({
                        event: x,
                        listeners: ne
                    }))
                }
            ...
            if ((n & 7) === 0) {
                e: {
                    if (x = e === "mouseover" || e === "pointerover", w = e === "mouseout" || e === "pointerout", x && o !== es && (Q = o.relatedTarget || o.fromElement) && (ci(Q) || Q[ui])) break e;
                    if ((w || x) && (x = G.window === G ? G : (x = G.ownerDocument) ? x.defaultView || x.parentWindow : window, w ? (Q = o.relatedTarget || o.toElement, w = D, Q = Q ? ci(Q) : null, Q !== null && (De = f(Q), ne = Q.tag, Q !== De || ne !== 5 && ne !== 27 && ne !== 6) && (Q = null)) : (w = null, Q = D), w !== Q)) {
                        if (ne = uc, q = "onMouseLeave", N = "onMouseEnter", R = "mouse", (e === "pointerout" || e === "pointerover") && (ne = fc, q = "onPointerLeave", N = "onPointerEnter", R = "pointer"), De = w == null ? x : ao(w), I = Q == null ? x : ao(Q), x = new ne(q, R + "leave", w, o, G), x.target = De, x.relatedTarget = I, q = null, ci(G) === D && (ne = new ne(N, R + "enter", Q, o, G), ne.target = I, ne.relatedTarget = De, q = ne), De = q, w && Q) t: {
                            for (ne = fv, N = w, R = Q, I = 0, q = N; q; q = ne(q)) I++;q = 0;
                            for (var j = R; j; j = ne(j)) q++;
                            for (; 0 < I - q;) N = ne(N),
                            I--;
                            for (; 0 < q - I;) R = ne(R),
                            q--;
                        ...
                        w !== null && ip(V, x, w, ne, !1), Q !== null && De !== null && ip(V, De, Q, ne, !0)
                    }
                }
                e: {
                    if (x = D ? ao(D) : window, w = x.nodeName && x.nodeName.toLowerCase(), w === "select" || w === "input" && x.type === "file") var ye = Tc;
                    else if (yc(x))
                        if (Sc) ye = _y;
                        else {
                            ye = Sy;
                    ...
                    !w || w.toLowerCase() !== "input" || x.type !== "checkbox" && x.type !== "radio" ? D && ja(D.elementType) && (ye = Tc) : ye = Ey;
                    if (ye && (ye = ye(e, D))) {
                        vc(V, ye, o, G);
                        break e
                    }
                    $ && $(e, x, D),
                    e === "focusout" && D && x.type === "number" && D.memoizedProps.value != null && Wa(x, "number", x.value)
                }
                switch ($ = D ? ao(D) : window, e) {
                    case "focusin":
                        (yc($) || $.contentEditable === "true") && (Ti = $, ps = D, go = null);
                        break;
                    case "focusout":
                        go = ps = Ti = null;
                        break;
                ...
                else vi ? hc(e, o) && (me = "onCompositionEnd") : e === "keydown" && o.keyCode === 229 && (me = "onCompositionStart");me && (dc && o.locale !== "ko" && (vi || me !== "onCompositionStart" ? me === "onCompositionEnd" && vi && (re = sc()) : (yn = G, os = "value" in yn ? yn.value : yn.textContent, vi = !0)), $ = oa(D, me), 0 < $.length && (me = new cc(me, e, null, o, G), V.push({
                    event: me,
                    listeners: $
                }), re ? me.data = re : (re = gc(o), re !== null && (me.data = re)))),
                (re = my ? hy(e, o) : gy(e, o)) && (me = oa(D, "onBeforeInput"), 0 < me.length && ($ = new cc("onBeforeInput", "beforeinput", null, o, G), V.push({
                    event: $,
                    listeners: me
                }), $.data = re)),
                sv(V, e, D, o, G)
    ...
    function oa(e, n) {
        for (var o = n + "Capture", s = []; e !== null;) {
            var d = e,
                p = d.stateNode;
            if (d = d.tag, d !== 5 && d !== 26 && d !== 27 || p === null || (d = so(e, o), d != null && s.unshift(Bo(e, d, p)), d = so(e, n), d != null && s.push(Bo(e, d, p))), e.tag === 3) return s;
            e = e.return
        }
        return []
    }
    ...
    function ip(e, n, o, s, d) {
        for (var p = n._reactName, T = []; o !== null && o !== s;) {
            var _ = o,
                A = _.alternate,
                D = _.stateNode;
            if (_ = _.tag, A !== null && A === s) break;
            _ !== 5 && _ !== 26 && _ !== 27 || D === null || (A = D, d ? (D = so(o, p), D != null && T.unshift(Bo(o, D, A))) : d || (D = so(o, p), D != null && T.push(Bo(o, D, A)))), o = o.return
        }
        T.length !== 0 && e.push({
            event: n,
            listeners: T
...
`).replace(pv, "")
    ...
    function lp(e, n) {
        return n = op(n), op(e) === n
    }

    function Ie(e, n, o, s, d, p) {
        switch (o) {
            case "children":
                typeof s == "string" ? n === "body" || n === "textarea" && s === "" || hi(e, s) : (typeof s == "number" || typeof s == "bigint") && n !== "body" && hi(e, "" + s);
                break;
            case "className":
                rl(e, "class", s);
                break;
            ...
            case "formAction":
                if (typeof s == "function") {
                    ...
                    break
                } else typeof p == "function" && (o === "formAction" ? (n !== "input" && Ie(e, n, "name", d.name, d, null), Ie(e, n, "formEncType", d.formEncType, d, null), Ie(e, n, "formMethod", d.formMethod, d, null), Ie(e, n, "formTarget", d.formTarget, d, null)) : (Ie(e, n, "encType", d.encType, d, null), Ie(e, n, "method", d.method, d, null), Ie(e, n, "target", d.target, d, null)));
            ...
            case "xlinkHref":
                ...
                o = cl("" + s), e.setAttributeNS("http://www.w3.org/1999/xlink", "xlink:href", o);
                break;
            ...
            case "start":
                ...
                break;
            case "popover":
                fe("beforetoggle", e), fe("toggle", e), sl(e, "popover", s);
                break;
            case "xlinkActuate":
                Xt(e, "http://www.w3.org/1999/xlink", "xlink:actuate", s);
                break;
            case "xlinkArcrole":
                Xt(e, "http://www.w3.org/1999/xlink", "xlink:arcrole", s);
                break;
            case "xlinkRole":
                Xt(e, "http://www.w3.org/1999/xlink", "xlink:role", s);
                break;
            case "xlinkShow":
                Xt(e, "http://www.w3.org/1999/xlink", "xlink:show", s);
                break;
            case "xlinkTitle":
                Xt(e, "http://www.w3.org/1999/xlink", "xlink:title", s);
                break;
            case "xlinkType":
                Xt(e, "http://www.w3.org/1999/xlink", "xlink:type", s);
                break;
            case "xmlBase":
                Xt(e, "http://www.w3.org/XML/1998/namespace", "xml:base", s);
                break;
            case "xmlLang":
                Xt(e, "http://www.w3.org/XML/1998/namespace", "xml:lang", s);
                break;
            case "xmlSpace":
                Xt(e, "http://www.w3.org/XML/1998/namespace", "xml:space", s);
                break;
            case "is":
                sl(e, "is", s);
                break;
            ...
            case "textContent":
                break;
            default:
                (!(2 < o.length) || o[0] !== "o" && o[0] !== "O" || o[1] !== "n" && o[1] !== "N") && (o = Bg.get(o) || o, sl(e, o, s))
        }
    }

    function zr(e, n, o, s, d, p) {
        switch (o) {
            case "style":
                oc(e, s, p);
                break;
            case "dangerouslySetInnerHTML":
                ...
                break;
            case "children":
                typeof s == "string" ? hi(e, s) : (typeof s == "number" || typeof s == "bigint") && hi(e, "" + s);
                break;
            case "onScroll":
                s != null && fe("scroll", e);
                break;
            ...
            case "textContent":
                break;
            default:
                if (!Qu.hasOwnProperty(o)) e: {
                    if (o[0] === "o" && o[1] === "n" && (d = o.endsWith("Capture"), n = o.slice(2, d ? o.length - 7 : void 0), p = e[rt] || null, p = p != null ? p[o] : null, typeof p == "function" && e.removeEventListener(n, p, d), typeof s == "function")) {
                        typeof p != "function" && p !== null && (o in e ? e[o] = null : e.hasAttribute(o) && e.removeAttribute(o)), e.addEventListener(n, s, d);
                        break e
                    }
                    o in e ? e[o] = s : s === !0 ? e.setAttribute(o, "") : sl(e, o, s)
                }
        }
    }
        ...
        switch (n) {
            ...
            case "img":
                ...
                for (p in o)
                    ...
                    } d && Ie(e, n, "srcSet", o.srcSet, o, null), s && Ie(e, n, "src", o.src, o, null);
                return;
            case "input":
                fe("invalid", e);
                var _ = p = T = d = null,
            ...
            case "select":
                ...
                n = p, o = T, e.multiple = !!s, n != null ? mi(e, !!s, n, !1) : o != null && mi(e, !!s, o, !0);
                return;
            case "textarea":
            ...
            case "video":
            case "audio":
                for (s = 0; s < Po.length; s++) fe(Po[s], e);
                break;
            case "image":
                fe("error", e), fe("load", e);
                break;
            ...
            default:
                if (ja(n)) {
                    for (G in o) o.hasOwnProperty(G) && (s = o[G], s !== void 0 && zr(e, n, G, s, o, void 0));
                    return
                }
        }
        for (_ in o) o.hasOwnProperty(_) && (s = o[_], s != null && Ie(e, n, _, s, o, null))
    }
    ...
    function mv(e, n, o, s) {
        switch (n) {
            ...
            case "input":
                ...
                for (w in o) {
                    var V = o[w];
                    if (o.hasOwnProperty(w) && V != null) switch (w) {
                        case "checked":
                            break;
                        case "value":
                            break;
                        case "defaultValue":
                            A = V;
                        default:
                            s.hasOwnProperty(w) || Ie(e, n, w, null, s, V)
                    }
                }
                for (var x in s) {
                    var w = s[x];
                    if (V = o[x], s.hasOwnProperty(x) && (w != null || V != null)) switch (x) {
                        case "type":
                            p = w;
                            break;
                        case "name":
            ...
            case "select":
                ...
                for (p in o)
                    if (A = o[p], o.hasOwnProperty(p) && A != null) switch (p) {
                        ...
                        case "multiple":
                            w = A;
                        default:
                            s.hasOwnProperty(p) || Ie(e, n, p, null, s, A)
                    }
                for (d in s)
                ...
                n = _, o = T, s = w, x != null ? mi(e, !!o, x, !1) : !!s != !!o && (n != null ? mi(e, !!o, n, !0) : mi(e, !!o, o ? [] : "", !1));
                return;
            case "textarea":
                w = x = null;
                for (_ in o)
            ...
            case "option":
                for (var Q in o)
                    if (x = o[Q], o.hasOwnProperty(Q) && x != null && !s.hasOwnProperty(Q)) switch (Q) {
                        case "selected":
                            e.selected = !1;
                            break;
                        default:
                ...
                for (A in s)
                    if (x = s[A], w = o[A], s.hasOwnProperty(A) && x !== w && (x != null || w != null)) switch (A) {
                        case "selected":
            ...
            case "wbr":
            case "menuitem":
                for (var ne in o) x = o[ne], o.hasOwnProperty(ne) && x != null && !s.hasOwnProperty(ne) && Ie(e, n, ne, null, s, x);
                for (D in s)
                    if (x = s[D], w = o[D], s.hasOwnProperty(D) && x !== w && (x != null || w != null)) switch (D) {
                        case "children":
                        case "dangerouslySetInnerHTML":
                            if (x != null) throw Error(a(137, n));
                            break;
                        default:
                            Ie(e, n, D, x, s, w)
                    }
            ...
            default:
                if (ja(n)) {
                    for (var De in o) x = o[De], o.hasOwnProperty(De) && x !== void 0 && !s.hasOwnProperty(De) && zr(e, n, De, void 0, s, x);
                    for (G in s) x = s[G], w = o[G], !s.hasOwnProperty(G) || x === w || x === void 0 && w === void 0 || zr(e, n, G, x, s, w);
                    return
                }
        }
        for (var N in o) x = o[N], o.hasOwnProperty(N) && x != null && !s.hasOwnProperty(N) && Ie(e, n, N, null, s, x);
        for (V in s) x = s[V], w = o[V], !s.hasOwnProperty(V) || x === w || x == null && w == null || Ie(e, n, V, x, s, w)
    }
                ...
                if (p && _ && ap(T)) {
                    for (T = 0, _ = d.responseEnd, s += 1; s < o.length; s++) {
                        ...
                        var G = A.transferSize,
                            V = A.initiatorType;
                        G && ap(V) && (A = A.responseEnd, T += G * (A < _ ? 1 : (_ - D) / (A - D)))
                    }
    ...
    var up = typeof setTimeout == "function" ? setTimeout : void 0,
        ...
        vv = typeof queueMicrotask == "function" ? queueMicrotask : typeof cp < "u" ? function(e) {
            return cp.resolve(null).then(e).catch(Tv)
        } : up;
    ...
    function fp(e, n) {
        ...
        do {
            ...
            if (e.removeChild(o), d && d.nodeType === 8)
                if (o = d.data, o === "/$" || o === "/&") {
                    if (s === 0) {
                        e.removeChild(d), Ji(n);
                        return
                    }
                    s--
                } else if (o === "$" || o === "$?" || o === "$~" || o === "$!" || o === "&") s++;
            else if (o === "html") ko(e.ownerDocument.documentElement);
            else if (o === "head") {
                o = e.ownerDocument.head, ko(o);
                for (var p = o.firstChild; p;) {
                    var T = p.nextSibling,
                        _ = p.nodeName;
                    p[lo] || _ === "SCRIPT" || _ === "STYLE" || _ === "LINK" && p.rel.toLowerCase() === "stylesheet" || o.removeChild(p), p = T
                }
            } else o === "body" && ko(e.ownerDocument.body);
            o = d
        } while (o);
        Ji(n)
    }
    ...
    function Ev(e, n, o) {
        if (n === "") return null;
        for (; e.nodeType !== 3;)
            if ((e.nodeType !== 1 || e.nodeName !== "INPUT" || e.type !== "hidden") && !o || (e = bt(e.nextSibling), e === null)) return null;
        return e
    }
    ...
    function mp(e) {
        ...
        for (var n = 0; e;) {
            if (e.nodeType === 8) {
                var o = e.data;
                if (o === "/$" || o === "/&") {
                    if (n === 0) return bt(e.nextSibling);
                    n--
                } else o !== "$" && o !== "$!" && o !== "$?" && o !== "$~" && o !== "&" || n++
            }
            e = e.nextSibling
    ...
    function Av(e) {
        var n = fi(e);
        n !== null && n.tag === 5 && n.type === "form" ? Lf(n) : fn.r(e)
    }
    ...
    function vp(e, n, o) {
        ...
        if (s && typeof n == "string" && n) {
            var d = Mt(n);
            d = 'link[rel="' + e + '"][href="' + d + '"]', typeof o == "string" && (d += '[crossorigin="' + o + '"]'), yp.has(d) || (yp.add(d), e = {
                rel: e,
                crossOrigin: o,
                href: n
            }, s.querySelector(d) === null && (n = s.createElement("link"), et(n, "link", e), Xe(n), s.head.appendChild(n)))
        }
    }

    function Rv(e) {
        fn.D(e), vp("dns-prefetch", e, null)
    }

    function Mv(e, n) {
        fn.C(e, n), vp("preconnect", e, n)
    }
    ...
    function Nv(e, n, o) {
        ...
        if (s && e && n) {
            ...
            n === "image" && o && o.imageSrcSet ? (d += '[imagesrcset="' + Mt(o.imageSrcSet) + '"]', typeof o.imageSizes == "string" && (d += '[imagesizes="' + Mt(o.imageSizes) + '"]')) : d += '[href="' + Mt(e) + '"]';
            var p = d;
            switch (n) {
                case "style":
                    p = Fi(e);
            ...
            Lt.has(p) || (e = S({
                ...
                as: n
            }, o), Lt.set(p, e), s.querySelector(d) !== null || n === "style" && s.querySelector(Oo(p)) || n === "script" && s.querySelector(Fo(p)) || (n = s.createElement("link"), et(n, "link", e), Xe(n), s.head.appendChild(n)))
        }
    }
    ...
    function Iv(e, n) {
        ...
        if (o && e) {
            var s = n && typeof n.as == "string" ? n.as : "script",
                d = 'link[rel="modulepreload"][as="' + Mt(s) + '"][href="' + Mt(e) + '"]',
                p = d;
            switch (s) {
                case "audioworklet":
                case "paintworklet":
            ...
            if (!Lt.has(p) && (e = S({
                    rel: "modulepreload",
                    href: e
                }, n), Lt.set(p, e), o.querySelector(d) === null)) {
                switch (s) {
                    case "audioworklet":
                    case "paintworklet":
                    case "serviceworker":
                    ...
                    case "worker":
                    case "script":
                        if (o.querySelector(Fo(p))) return
                }
                s = o.createElement("link"), et(s, "link", e), Xe(s), o.head.appendChild(s)
            }
        }
    }
    ...
    function Dv(e, n, o) {
        ...
        if (s && e) {
            ...
            if (!T) {
                ...
                if (T = s.querySelector(Oo(p))) _.loading = 5;
                else {
                    e = S({
                        rel: "stylesheet",
                        href: e,
                    ...
                    Xe(A), et(A, "link", e), A._p = new Promise(function(D, G) {
                        A.onload = D, A.onerror = G
                    }), A.addEventListener("load", function() {
                        _.loading |= 1
                    }), A.addEventListener("error", function() {
                        _.loading |= 2
                    }), _.loading |= 4, sa(T, n, s)
                }
                T = {
                    type: "stylesheet",
                    instance: T,
    ...
    function xv(e, n) {
        ...
        var o = Oi;
        if (o && e) {
            var s = di(o).hoistableScripts,
                d = Yi(e),
                p = s.get(d);
            p || (p = o.querySelector(Fo(d)), p || (e = S({
                src: e,
                async: !0
            }, n), (n = Lt.get(d)) && Qr(e, n), p = o.createElement("script"), Xe(p), et(p, "link", e), o.head.appendChild(p)), p = {
                type: "script",
                instance: p,
                count: 1,
                state: null
    ...
    function Tp(e, n, o, s) {
        ...
        switch (e) {
            ...
            case "title":
                return null;
            case "style":
                return typeof o.precedence == "string" && typeof o.href == "string" ? (n = Fi(o.href), o = di(d).hoistableStyles, s = o.get(n), s || (s = {
                    type: "style",
                    instance: null,
                    count: 0,
                    state: null
            ...
            case "link":
                if (o.rel === "stylesheet" && typeof o.href == "string" && typeof o.precedence == "string") {
                    ...
                    if (T || (d = d.ownerDocument || d, T = {
                        ...
                        }, p.set(e, T), (p = d.querySelector(Oo(e))) && !p._p && (T.instance = p, T.state.loading = 5), Lt.has(e) || (o = {
                            rel: "preload",
                            as: "style",
                            href: o.href,
                        ...
                        }, Lt.set(e, o), p || wv(d, e, o, T.state))), n && s === null) throw Error(a(528, ""));
                    return T
                }
                if (n && s !== null) throw Error(a(529, ""));
                return null;
            case "script":
                return n = o.async, o = o.src, typeof o == "string" && n && typeof n != "function" && typeof n != "symbol" ? (n = Yi(o), o = di(d).hoistableScripts, s = o.get(n), s || (s = {
                    type: "script",
                    instance: null,
                    count: 0,
                    state: null
    ...
    function wv(e, n, o, s) {
        e.querySelector('link[rel="preload"][as="style"][' + n + "]") ? s.loading = 1 : (n = e.createElement("link"), s.preload = n, n.addEventListener("load", function() {
            ...
            return s.loading |= 2
        }), et(n, "link", o), Xe(n), e.head.appendChild(n))
    }
    ...
    function Ep(e, n, o) {
        if (n.count++, n.instance === null) switch (n.type) {
            case "style":
                ...
                return s = (e.ownerDocument || e).createElement("style"), Xe(s), et(s, "style", d), sa(s, o.precedence, e), n.instance = s;
            case "stylesheet":
                d = Fi(o.href);
                var p = e.querySelector(Oo(d));
                if (p) return n.state.loading |= 4, n.instance = p, Xe(p), p;
                s = Sp(o), (d = Lt.get(d)) && Kr(s, d), p = (e.ownerDocument || e).createElement("link"), Xe(p);
                var T = p;
                return T._p = new Promise(function(_, A) {
                    T.onload = _, T.onerror = A
                }), et(p, "link", s), n.state.loading |= 4, sa(p, o.precedence, e), n.instance = p;
            case "script":
                return p = Yi(o.src), (d = e.querySelector(Fo(p))) ? (n.instance = d, Xe(d), d) : (s = o, (d = Lt.get(p)) && (s = S({}, o), Qr(s, d)), e = e.ownerDocument || e, d = e.createElement("script"), Xe(d), et(d, "link", s), e.head.appendChild(d), n.instance = d);
            case "void":
                return null;
            default:
                throw Error(a(443, n.type))
        } else n.type === "stylesheet" && (n.state.loading & 4) === 0 && (s = n.instance, n.state.loading |= 4, sa(s, o.precedence, e));
        return n.instance
    }
    ...
    function _p(e, n, o) {
        if (ra === null) {
            var s = new Map,
                d = ra = new Map;
            d.set(o, s)
        } else d = ra, s = d.get(o), s || (s = new Map, d.set(o, s));
        if (s.has(e)) return s;
        for (s.set(e, null), o = o.getElementsByTagName(e), d = 0; d < o.length; d++) {
            var p = o[d];
            if (!(p[lo] || p[Ze] || e === "link" && p.getAttribute("rel") === "stylesheet") && p.namespaceURI !== "http://www.w3.org/2000/svg") {
    ...
    function Lv(e, n, o, s) {
        if (o.type === "stylesheet" && (typeof s.media != "string" || matchMedia(s.media).matches !== !1) && (o.state.loading & 4) === 0) {
            if (o.instance === null) {
                var d = Fi(s.href),
                    p = n.querySelector(Oo(d));
                if (p) {
                    n = p._p, n !== null && typeof n == "object" && typeof n.then == "function" && (e.count++, e = ua.bind(e), n.then(e, e)), o.state.loading |= 4, o.instance = p, Xe(p);
                    return
                }
                p = n.ownerDocument || n, s = Sp(s), (d = Lt.get(d)) && Kr(s, d), p = p.createElement("link"), Xe(p);
                var T = p;
                T._p = new Promise(function(_, A) {
                    T.onload = _, T.onerror = A
                }), et(p, "link", s), o.instance = p
            }
            e.stylesheets === null && (e.stylesheets = new Map), e.stylesheets.set(o, n), (n = o.state.preload) && (o.state.loading & 3) === 0 && (e.count++, o = ua.bind(e), n.addEventListener("load", o), n.addEventListener("error", o))
        }
    }
    var Zr = 0;

    function Gv(e, n) {
        return e.stylesheets && e.count === 0 && fa(e, e.stylesheets), 0 < e.count || 0 < e.imgCount ? function(o) {
            var s = setTimeout(function() {
                if (e.stylesheets && fa(e, e.stylesheets), e.unsuspend) {
                    var p = e.unsuspend;
                    e.unsuspend = null, p()
                }
            }, 6e4 + n);
            0 < e.imgBytes && Zr === 0 && (Zr = 62500 * hv());
            var d = setTimeout(function() {
                if (e.waitingForImages = !1, e.count === 0 && (e.stylesheets && fa(e, e.stylesheets), e.unsuspend)) {
                    var p = e.unsuspend;
                    e.unsuspend = null, p()
                }
            }, (e.imgBytes > Zr ? 50 : 800) + n);
    ...
    function fa(e, n) {
        e.stylesheets = null, e.unsuspend !== null && (e.count++, ca = new Map, n.forEach(Hv, e), ca = null, ua.call(e))
    }
    ...
    function Hv(e, n) {
        if (!(n.state.loading & 4)) {
            ...
            d = n.instance, T = d.getAttribute("data-precedence"), p = o.get(T) || s, p === s && o.set(null, d), o.set(T, d), this.count++, s = ua.bind(this), d.addEventListener("load", s), d.addEventListener("error", s), p ? p.parentNode.insertBefore(d, p.nextSibling) : (e = e.nodeType === 9 ? e.head : e, e.insertBefore(d, e.firstChild)), n.state.loading |= 4
        }
    }
    var Yo = {
        $$typeof: k,
    ...
    function Rp(e, n, o, s, d, p, T, _, A, D, G, V) {
        return e = new qv(e, n, o, T, A, D, G, V, _), n = 1, p === !0 && (n |= 24), p = Tt(3, null, null, n), e.current = p, p.stateNode = e, n = Ds(), n.refCount++, e.pooledCache = n, n.refCount++, p.memoizedState = {
            element: s,
            isDehydrated: o,
            cache: n
        }, bs(p), e
    ...
    function Np(e, n, o, s, d, p) {
        d = Mp(d), s.context === null ? s.context = d : s.pendingContext = d, s = Cn(n), s.payload = {
            element: o
        }, p = p === void 0 ? null : p, p !== null && (s.callback = p), o = An(e, s, n), o !== null && (mt(o, e, n), Co(o, e, n))
    }
    ...
    function Dp(e) {
        if (e.tag === 13 || e.tag === 31) {
            var n = Kn(e, 67108864);
            n !== null && mt(n, e, 67108864), $r(e, 67108864)
        }
    }
    ...
    function Wr(e, n, o, s) {
        if (da) {
            var d = jr(s);
            if (d === null) Vr(e, n, s, pa, o), wp(e, s);
            else if (Bv(d, e, n, o, s)) s.stopPropagation();
            else if (wp(e, s), n & 4 && -1 < Pv.indexOf(e)) {
                for (; d !== null;) {
                    var p = fi(d);
                    if (p !== null) switch (p.tag) {
                        case 3:
                            if (p = p.stateNode, p.current.memoizedState.isDehydrated) {
                                var T = On(p.pendingLanes);
                                if (T !== 0) {
                                    var _ = p;
                                    ...
                                    Jt(p), (Se & 6) === 0 && (Ql = ht() + 500, zo(0))
                                }
                            }
                            break;
                        case 31:
                        case 13:
                            _ = Kn(p, 2), _ !== null && mt(_, p, 2), $l(), $r(p, 2)
                    }
                    if (p = jr(s), p === null && Vr(e, n, s, pa, o), p === d) break;
                    d = p
                }
                d !== null && s.stopPropagation()
            } else Vr(e, n, s, null, o)
        }
    }
    ...
    var tu = !1,
        ...
        Xo = new Map,
        Vn = [],
        Pv = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(" ");
    ...
    function Ko(e, n, o, s, d, p) {
        return e === null || e.nativeEvent !== p ? (e = {
            ...
            nativeEvent: p,
            targetContainers: [d]
        }, n !== null && (n = fi(n), n !== null && Dp(n)), e) : (e.eventSystemFlags |= s, n = e.targetContainers, d !== null && n.indexOf(d) === -1 && n.push(d), e)
    }

    function Bv(e, n, o, s, d) {
        switch (n) {
            case "focusin":
                return Gn = Ko(Gn, e, n, o, s, d), !0;
            case "dragenter":
                return Hn = Ko(Hn, e, n, o, s, d), !0;
            case "mouseover":
                return qn = Ko(qn, e, n, o, s, d), !0;
            case "pointerover":
                var p = d.pointerId;
                return Jo.set(p, Ko(Jo.get(p) || null, e, n, o, s, d)), !0;
            case "gotpointercapture":
                return p = d.pointerId, Xo.set(p, Ko(Xo.get(p) || null, e, n, o, s, d)), !0
        }
        return !1
    }
    ...
    function bp(e) {
        ...
        if (n !== null) {
            ...
            if (o !== null) {
                if (n = o.tag, n === 13) {
                    if (n = m(o), n !== null) {
                        e.blockedOn = n, Ju(e.priority, function() {
                            xp(o)
                        });
                        return
                    }
    ...
    function ma(e) {
        ...
        for (var n = e.targetContainers; 0 < n.length;) {
            var o = jr(e.nativeEvent);
            if (o === null) {
                o = e.nativeEvent;
                var s = new o.constructor(o.type, o);
                es = s, o.target.dispatchEvent(s), es = null
            } else return n = fi(o), n !== null && Dp(n), e.blockedOn = o, !1;
            n.shift()
        }
        return !0
    }
    ...
    function kv() {
        tu = !1, Gn !== null && ma(Gn) && (Gn = null), Hn !== null && ma(Hn) && (Hn = null), qn !== null && ma(qn) && (qn = null), Jo.forEach(Lp), Xo.forEach(Lp)
    }

    function ha(e, n) {
        e.blockedOn === n && (e.blockedOn = null, tu || (tu = !0, i.unstable_scheduleCallback(i.unstable_NormalPriority, kv)))
    }
    var ga = null;

    function Gp(e) {
        ga !== e && (ga = e, i.unstable_scheduleCallback(i.unstable_NormalPriority, function() {
            ga === e && (ga = null);
            for (var n = 0; n < e.length; n += 3) {
                var o = e[n],
                    ...
                    d = e[n + 2];
                if (typeof s != "function") {
                    if (eu(s || o) === null) continue;
                    break
                }
                var p = fi(o);
                p !== null && (e.splice(n, 3), n -= 3, js(p, {
                    pending: !0,
                    data: d,
                    method: o.method,
                    action: s
    ...
    function Ji(e) {
        ...
        Gn !== null && ha(Gn, e), Hn !== null && ha(Hn, e), qn !== null && ha(qn, e), Jo.forEach(n), Xo.forEach(n);
        for (var o = 0; o < Vn.length; o++) {
            var s = Vn[o];
            s.blockedOn === e && (s.blockedOn = null)
        }
        for (; 0 < Vn.length && (o = Vn[0], o.blockedOn === null);) bp(o), o.blockedOn === null && Vn.shift();
        if (o = (e.ownerDocument || e).$$reactFormReplay, o != null)
            for (s = 0; s < o.length; s += 3) {
                var d = o[s],
                    p = o[s + 1],
                    T = d[rt] || null;
                if (typeof p == "function") T || Gp(o);
                else if (T) {
                    var _ = null;
                    if (p && p.hasAttribute("formAction")) {
                        if (d = p, T = p[rt] || null) _ = T.formAction;
                        else if (eu(d) !== null) continue
                    } else _ = T.action;
                    typeof _ == "function" ? o[s + 1] = _ : (o.splice(s, 3), s -= 3), Gp(o)
                }
            }
    }
    ...
    ya.prototype.render = nu.prototype.render = function(e) {
        var n = this._internalRoot;
        if (n === null) throw Error(a(409));
        var o = n.current,
            s = At();
        Np(o, s, e, n, null, null)
    }, ya.prototype.unmount = nu.prototype.unmount = function() {
        var e = this._internalRoot;
        if (e !== null) {
            this._internalRoot = null;
            var n = e.containerInfo;
            Np(e.current, 2, null, e, null, null), $l(), n[ui] = null
        }
    };
    ...
    ya.prototype.unstable_scheduleHydration = function(e) {
        if (e) {
            ...
            for (var o = 0; o < Vn.length && n !== 0 && n < Vn[o].priority; o++);
            Vn.splice(o, 0, e), o === 0 && bp(e)
        }
    };
    var qp = t.version;
    if (qp !== "19.2.3") throw Error(a(527, qp, "19.2.3"));
    ...
    if (typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u") {
        ...
        if (!va.isDisabled && va.supportsFiber) try {
            no = va.inject(Ov), gt = va
        } catch {}
    }
    return Zo.createRoot = function(e, n) {
        ...
        var o = !1,
            ...
            p = Yf,
            T = Jf;
        return n != null && (n.unstable_strictMode === !0 && (o = !0), n.identifierPrefix !== void 0 && (s = n.identifierPrefix), n.onUncaughtError !== void 0 && (d = n.onUncaughtError), n.onCaughtError !== void 0 && (p = n.onCaughtError), n.onRecoverableError !== void 0 && (T = n.onRecoverableError)), n = Rp(e, 1, !1, null, null, o, s, null, d, p, T, Hp), e[ui] = n.current, qr(e), new nu(n)
    }, Zo.hydrateRoot = function(e, n, o) {
        if (!u(e)) throw Error(a(299));
        var s = !1,
            d = "",
            p = Ff,
            ...
            _ = Jf,
            A = null;
        return o != null && (o.unstable_strictMode === !0 && (s = !0), o.identifierPrefix !== void 0 && (d = o.identifierPrefix), o.onUncaughtError !== void 0 && (p = o.onUncaughtError), o.onCaughtError !== void 0 && (T = o.onCaughtError), o.onRecoverableError !== void 0 && (_ = o.onRecoverableError), o.formState !== void 0 && (A = o.formState)), n = Rp(e, 1, !0, n, o ?? null, s, d, A, p, T, _, Hp), n.context = Mp(null), o = n.current, s = At(), s = Ja(s), d = Cn(s), d.callback = null, An(o, d, s), o = s, n.current.lanes = o, oo(n, o), Jt(n), e[ui] = n.current, qr(e), new ya(n)
    }, Zo.version = "19.2.3", Zo
}
var Xp;

function e0() {
    if (Xp) return lu.exports;
    Xp = 1;
    ...
    return i(), lu.exports = jv(), lu.exports
}
var t0 = e0();
const n0 = Nh(t0),
    i0 = () => B.jsx("nav", {
        className: "fixed top-6 right-12 z-50 hidden lg:block",
        children: B.jsxs("div", {
            className: "flex gap-8 items-center bg-white/40 backdrop-blur-md px-8 py-3 rounded-full border border-white/40 shadow-sm",
            children: [B.jsx("a", {
                href: "#",
                className: "text-[10px] font-bold tracking-widest text-slate-400 hover:text-pink-500 uppercase",
                children: "Share"
            }), B.jsx("a", {
                href: "#",
                className: "text-[10px] font-bold tracking-widest text-slate-400 hover:text-pink-500 uppercase",
                ...
                className: "px-6 py-2 bg-slate-900 text-white rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-slate-700 transition-all",
                children: "Contact"
            })]
        })
    });
...
function fu(i, t, l, a, u) {
    ...
    if (f.endsWith("[]")) {
        ...
        if (m in g && Array.isArray(g[m]))
            for (const y of g[m]) fu(y, t, l, a + 1, u)
    } else if (f === "*") {
...
function f0(i) {
    ...
    return m != null && c(t, ["response"], p0(m)), t
}
...
function d0(i) {
    ...
    return m != null && c(t, ["response"], m0(m)), t
}
...
function p0(i) {
    ...
    if (l != null) {
        let f = l;
        Array.isArray(f) && (f = f.map(m => h0(m))), c(t, ["generatedVideos"], f)
    }
...
function m0(i) {
    ...
    if (l != null) {
        let f = l;
        Array.isArray(f) && (f = f.map(m => g0(m))), c(t, ["generatedVideos"], f)
    }
    const a = r(i, ["raiMediaFilteredCount"]);
    a != null && c(t, ["raiMediaFilteredCount"], a);
    const u = r(i, ["raiMediaFilteredReasons"]);
...
function h0(i) {
    const t = {},
        l = r(i, ["video"]);
    return l != null && c(t, ["video"], _0(l)), t
}

function g0(i) {
    const t = {},
        l = r(i, ["_self"]);
    return l != null && c(t, ["video"], C0(l)), t
}
...
function T0(i) {
    ...
    f != null && c(t, ["error"], f);
    const m = r(i, ["response"]);
    return m != null && c(t, ["response"], S0(m)), t
}
...
function Ih(i) {
    ...
    f != null && c(t, ["error"], f);
    const m = r(i, ["response"]);
    return m != null && c(t, ["response"], E0(m)), t
}
...
class $o {
    get text() {
        ...
        for (const E of (y = (g = (m = (f = this.candidates) === null || f === void 0 ? void 0 : f[0]) === null || m === void 0 ? void 0 : m.content) === null || g === void 0 ? void 0 : g.parts) !== null && y !== void 0 ? y : []) {
            for (const [C, U] of Object.entries(E)) C !== "text" && C !== "thought" && C !== "thoughtSignature" && (U !== null || U !== void 0) && S.push(C);
...
class Na {
    _fromAPIResponse({
        ...
        let u;
        const f = t;
        return l ? u = d0(f) : u = f0(f), Object.assign(a, u), a
    }
}
class $m {}
class Wm {}
...
function xh(i) {
    return Array.isArray(i) ? i.map(t => Ia(t)) : [Ia(i)]
}
...
function bh(i) {
    ...
    return Array.isArray(i) ? i.map(t => nh(t)) : [nh(i)]
}
...
function Du(i, t) {
    ...
    return Array.isArray(t) ? t.map(l => nt(l)) : [nt(t)]
}

function Gt(i) {
    if (i == null || Array.isArray(i) && i.length === 0) throw new Error("contents are required");
    if (!Array.isArray(i)) {
        if (ih(i) || oh(i)) throw new Error("To specify functionCall or functionResponse parts, please wrap them in a Content object, specifying the role for them");
        return [nt(i)]
    }
    const t = [],
        l = [],
    ...
    for (const u of i) {
        ...
        if (f) t.push(u);
            ...
            if (ih(u) || oh(u)) throw new Error("To specify functionCall or functionResponse parts, please wrap them, and any other parts, in Content objects as appropriate, specifying the role for them");
            l.push(u)
        }
    }
    return a || t.push({
...
function q0(i, t) {
    ...
    if (l.length === 1) t.type = Object.values(Pn).includes(l[0].toUpperCase()) ? l[0].toUpperCase() : Pn.TYPE_UNSPECIFIED;
    else {
        t.anyOf = [];
        for (const a of l) t.anyOf.push({
            type: Object.values(Pn).includes(a.toUpperCase()) ? a.toUpperCase() : Pn.TYPE_UNSPECIFIED
        })
    }
}
...
function Zi(i) {
    ...
    const f = i.anyOf;
    f != null && f.length == 2 && (f[0].type === "null" ? (t.nullable = !0, i = f[1]) : f[1].type === "null" && (t.nullable = !0, i = f[0])), i.type instanceof Array && q0(i.type, t);
    for (const [m, g] of Object.entries(i))
        if (g != null)
            if (m == "type") {
                ...
                t.type = Object.values(Pn).includes(g.toUpperCase()) ? g.toUpperCase() : Pn.TYPE_UNSPECIFIED
            } else if (l.includes(m)) t[m] = Zi(g);
        ...
        const y = {};
        for (const [h, v] of Object.entries(g)) y[h] = Zi(v);
        t[m] = y
    } else {
...
function Wi(i) {
    if (i.functionDeclarations)
        for (const t of i.functionDeclarations) t.parameters && (Object.keys(t.parameters).includes("$schema") ? t.parametersJsonSchema || (t.parametersJsonSchema = t.parameters, delete t.parameters) : t.parameters = Zi(t.parameters)), t.response && (Object.keys(t.response).includes("$schema") ? t.responseJsonSchema || (t.responseJsonSchema = t.response, delete t.response) : t.response = Zi(t.response));
    return i
}
...
function Gh(i) {
    var t;
    let l;
    if (z0(i) && (l = i.name), !(B0(i) && (l = i.uri, l === void 0)) && !(P0(i) && (l = (t = i.video) === null || t === void 0 ? void 0 : t.uri, l === void 0))) {
...
function J0(i) {
    ...
    if (a != null) {
        let f = a;
        Array.isArray(f) && (f = f.map(m => MT(m))), c(t, ["inlinedResponses"], f)
    }
...
function Aa(i) {
    ...
    return h != null && c(t, ["dest"], J0(zh(h))), t
}
...
function Z0(i, t) {
    ...
    if (u != null) {
        let f = u;
        Array.isArray(f) && (f = f.map(m => RT(i, m))), c(l, ["requests", "requests"], f)
    }
    return l
}
...
function j0(i, t) {
    const l = {},
        a = r(t, ["name"]);
    return a != null && c(l, ["_url", "name"], eo(i, a)), l
}
...
function tT(i) {
    ...
    a != null && c(t, ["citationMetadata"], nT(a));
...
function Bh(i) {
    ...
    if (l != null) {
        let u = l;
        Array.isArray(u) && (u = u.map(f => bT(f))), c(t, ["parts"], u)
    }
    const a = r(i, ["role"]);
...
function oT(i, t) {
    ...
    const u = r(i, ["dest"]);
    return t !== void 0 && u != null && c(t, ["outputConfig"], K0(Y0(u))), l
}
...
function lh(i, t) {
    ...
    const u = r(t, ["src"]);
    u != null && c(l, ["batch", "inputConfig"], Z0(i, Vh(i, u)));
    const f = r(t, ["config"]);
    return f != null && iT(f, l), l
}
...
function lT(i, t) {
    ...
    const u = r(t, ["src"]);
    u != null && c(l, ["inputConfig"], $0(Vh(i, u)));
    const f = r(t, ["config"]);
...
function sT(i, t) {
    ...
    a != null && c(l, ["_url", "model"], Te(i, a));
    const u = r(t, ["src"]);
    u != null && c(l, ["batch", "inputConfig"], mT(i, u));
    const f = r(t, ["config"]);
    return f != null && aT(f, l), l
}
...
function dT(i, t) {
    ...
    const u = r(t, ["config"]);
    return u != null && (c(l, ["_self"], pT(u, l)), u0(l, {
...
function mT(i, t) {
    ...
    const u = r(t, ["inlinedRequests"]);
    return u != null && c(l, ["requests"], dT(i, u)), l
}
...
function vT(i, t, l) {
    ...
    l !== void 0 && u != null && c(l, ["systemInstruction"], Bh(nt(u)));
    ...
    U != null && c(a, ["frequencyPenalty"], U);
    const H = r(t, ["seed"]);
    H != null && c(a, ["seed"], H);
    const b = r(t, ["responseMimeType"]);
    b != null && c(a, ["responseMimeType"], b);
    const P = r(t, ["responseSchema"]);
    P != null && c(a, ["responseSchema"], xu(P));
    const X = r(t, ["responseJsonSchema"]);
    if (X != null && c(a, ["responseJsonSchema"], X), r(t, ["routingConfig"]) !== void 0) throw new Error("routingConfig parameter is not supported in Gemini API.");
    if (r(t, ["modelSelectionConfig"]) !== void 0) throw new Error("modelSelectionConfig parameter is not supported in Gemini API.");
    const k = r(t, ["safetySettings"]);
    if (l !== void 0 && k != null) {
        let Ee = k;
        Array.isArray(Ee) && (Ee = Ee.map(Be => LT(Be))), c(l, ["safetySettings"], Ee)
    }
    const K = r(t, ["tools"]);
    if (l !== void 0 && K != null) {
        let Ee = ji(K);
        Array.isArray(Ee) && (Ee = Ee.map(Be => HT(Wi(Be)))), c(l, ["tools"], Ee)
    }
    const ee = r(t, ["toolConfig"]);
    if (l !== void 0 && ee != null && c(l, ["toolConfig"], GT(ee)), r(t, ["labels"]) !== void 0) throw new Error("labels parameter is not supported in Gemini API.");
    const te = r(t, ["cachedContent"]);
    l !== void 0 && te != null && c(l, ["cachedContent"], mn(i, te));
    ...
    if (W != null && c(a, ["speechConfig"], Uu(W)), r(t, ["audioTimestamp"]) !== void 0) throw new Error("audioTimestamp parameter is not supported in Gemini API.");
    const de = r(t, ["thinkingConfig"]);
    de != null && c(a, ["thinkingConfig"], de);
    const Ce = r(t, ["imageConfig"]);
    Ce != null && c(a, ["imageConfig"], AT(Ce));
...
function TT(i) {
    ...
    if (a != null) {
        let y = a;
        Array.isArray(y) && (y = y.map(h => tT(h))), c(t, ["candidates"], y)
    }
...
function RT(i, t) {
    ...
    if (u != null) {
        let g = Gt(u);
        Array.isArray(g) && (g = g.map(y => Bh(y))), c(l, ["request", "contents"], g)
    }
    const f = r(t, ["metadata"]);
    f != null && c(l, ["metadata"], f);
    const m = r(t, ["config"]);
    return m != null && c(l, ["request", "generationConfig"], vT(i, m, r(l, ["request"], {}))), l
}

function MT(i) {
    const t = {},
        l = r(i, ["response"]);
    l != null && c(t, ["response"], TT(l));
    const a = r(i, ["error"]);
...
function DT(i) {
    const t = {},
        l = r(i, ["config"]);
    return l != null && NT(l, t), t
}

function xT(i) {
    const t = {},
        l = r(i, ["config"]);
    return l != null && IT(l, t), t
}
...
function UT(i) {
    ...
    if (u != null) {
        let f = u;
        Array.isArray(f) && (f = f.map(m => Aa(m))), c(t, ["batchJobs"], f)
    }
    return t
}
...
function wT(i) {
    ...
    if (u != null) {
        let f = u;
        Array.isArray(f) && (f = f.map(m => hu(m))), c(t, ["batchJobs"], f)
    }
    return t
}
...
function GT(i) {
    ...
    l != null && c(t, ["functionCallingConfig"], yT(l));
...
function HT(i) {
    ...
    g != null && c(t, ["googleMaps"], _T(g));
    const y = r(i, ["googleSearch"]);
    y != null && c(t, ["googleSearch"], CT(y));
...
class qT extends pn {
    constructor(t) {
        super(), this.apiClient = t, this.list = async (l = {}) => new ri(dn.PAGED_ITEM_BATCH_JOBS, a => this.listInternal(a), await this.listInternal(l), l), this.create = async l => (this.apiClient.isVertexAI() && (l.config = this.formatDestination(l.src, l.config)), this.createInternal(l)), this.createEmbeddings = async l => {
    ...
    async createInternal(t) {
        ...
        if (this.apiClient.isVertexAI()) {
            ...
            }).then(v => v.json()), m.then(v => hu(v))
        } else {
            const h = lh(this.apiClient, t);
...
function ah(i) {
    ...
    if (l != null) {
        let u = l;
        Array.isArray(u) && (u = u.map(f => sS(f))), c(t, ["parts"], u)
    }
    const a = r(i, ["role"]);
    return a != null && c(t, ["role"], a), t
}
...
function zT(i, t) {
    ...
    if (t !== void 0 && m != null) {
        let v = Gt(m);
        Array.isArray(v) && (v = v.map(S => ah(S))), c(t, ["contents"], v)
    }
    const g = r(i, ["systemInstruction"]);
    t !== void 0 && g != null && c(t, ["systemInstruction"], ah(nt(g)));
    const y = r(i, ["tools"]);
    if (t !== void 0 && y != null) {
        let v = y;
        Array.isArray(v) && (v = v.map(S => uS(S))), c(t, ["tools"], v)
    }
    const h = r(i, ["toolConfig"]);
    if (t !== void 0 && h != null && c(t, ["toolConfig"], rS(h)), r(i, ["kmsKeyName"]) !== void 0) throw new Error("kmsKeyName parameter is not supported in Gemini API.");
    return l
}
...
function PT(i, t) {
    ...
    const g = r(i, ["systemInstruction"]);
    t !== void 0 && g != null && c(t, ["systemInstruction"], nt(g));
    const y = r(i, ["tools"]);
    if (t !== void 0 && y != null) {
        let S = y;
        Array.isArray(S) && (S = S.map(E => cS(E))), c(t, ["tools"], S)
    }
    const h = r(i, ["toolConfig"]);
...
function BT(i, t) {
    const l = {},
        a = r(t, ["model"]);
    a != null && c(l, ["model"], Dh(i, a));
    const u = r(t, ["config"]);
    return u != null && zT(u, l), l
}
...
function kT(i, t) {
    ...
    a != null && c(l, ["model"], Dh(i, a));
    const u = r(t, ["config"]);
    return u != null && PT(u, l), l
}

function OT(i, t) {
    const l = {},
        a = r(t, ["name"]);
    return a != null && c(l, ["_url", "name"], mn(i, a)), l
}
...
function sS(i) {
    ...
    u != null && c(t, ["executableCode"], u);
    const f = r(i, ["fileData"]);
    f != null && c(t, ["fileData"], XT(f));
    const m = r(i, ["functionCall"]);
    m != null && c(t, ["functionCall"], KT(m));
    const g = r(i, ["functionResponse"]);
    g != null && c(t, ["functionResponse"], g);
    const y = r(i, ["inlineData"]);
    y != null && c(t, ["inlineData"], VT(y));
    const h = r(i, ["text"]);
    h != null && c(t, ["text"], h);
    const v = r(i, ["thought"]);
    v != null && c(t, ["thought"], v);
...
function rS(i) {
    const t = {},
        l = r(i, ["functionCallingConfig"]);
    l != null && c(t, ["functionCallingConfig"], QT(l));
    const a = r(i, ["retrievalConfig"]);
    return a != null && c(t, ["retrievalConfig"], a), t
}
...
function uS(i) {
    ...
    if (m != null && c(t, ["codeExecution"], m), r(i, ["enterpriseWebSearch"]) !== void 0) throw new Error("enterpriseWebSearch parameter is not supported in Gemini API.");
    const g = r(i, ["googleMaps"]);
    g != null && c(t, ["googleMaps"], jT(g));
    const y = r(i, ["googleSearch"]);
    y != null && c(t, ["googleSearch"], eS(y));
    const h = r(i, ["urlContext"]);
    return h != null && c(t, ["urlContext"], h), t
}
...
function cS(i) {
    ...
    if (l != null) {
        let S = l;
        Array.isArray(S) && (S = S.map(E => ZT(E))), c(t, ["functionDeclarations"], S)
    }
...
function pS(i, t) {
    const l = {},
        a = r(t, ["name"]);
    a != null && c(l, ["_url", "name"], mn(i, a));
    const u = r(t, ["config"]);
    return u != null && fS(u, l), l
}
...
class hS extends pn {
    constructor(t) {
        super(), this.apiClient = t, this.list = async (l = {}) => new ri(dn.PAGED_ITEM_CACHED_CONTENTS, a => this.listInternal(a), await this.listInternal(l), l)
    }
    async create(t) {
        var l, a, u, f;
        let m, g = "",
...
function Pt(i, t, l) {
    ...
    function m(C) {
        return function(U) {
            return Promise.resolve(U).then(C, S)
        }
    }
    ...
    function E(C, U) {
        C(U), f.shift(), f.length && y(f[0][0], f[0][1])
    }
}
...
function Bt(i) {
    ...
    var t = i[Symbol.asyncIterator],
        l;
    return t ? t.call(i) : (i = typeof sh == "function" ? sh(i) : i[Symbol.iterator](), l = {}, a("next"), a("throw"), a("return"), l[Symbol.asyncIterator] = function() {
        return this
    }, l);
...
function rh(i) {
    ...
    for (; a < l;)
        if (i[a].role === "user") t.push(i[a]), a++;
            ...
            const u = [];
            let f = !0;
            for (; a < l && i[a].role === "model";) u.push(i[a]), f && !kh(i[a]) && (f = !1), a++;
            f ? t.push(...u) : t.pop()
        } return t
}
class vS {
    ...
    create(t) {
        return new TS(this.apiClient, this.modelsModule, t.model, t.config, structuredClone(t.history))
    }
}
class TS {
    constructor(t, l, a, u = {}, f = []) {
        this.apiClient = t, this.modelsModule = l, this.model = a, this.config = u, this.history = f, this.sendPromise = Promise.resolve(), yS(f)
    }
    async sendMessage(t) {
        var l;
        await this.sendPromise;
        const a = nt(t.message),
    ...
    getHistory(t = !1) {
        const l = t ? rh(this.history) : this.history;
    ...
    processStreamResponse(t, l) {
        return Pt(this, arguments, function*() {
            ...
            const v = [];
            try {
                for (var S = !0, E = Bt(t), C; C = yield oe(E.next()), u = C.done, !u; S = !0) {
                    g = C.value, S = !1;
                    const U = g;
                    if (gS(U)) {
                        const H = (h = (y = U.candidates) === null || y === void 0 ? void 0 : y[0]) === null || h === void 0 ? void 0 : h.content;
                        H !== void 0 && v.push(H)
                    }
                    yield yield oe(U)
                }
    ...
    recordHistory(t, l, a) {
        ...
        l.length > 0 && l.every(f => f.role !== void 0) ? u = l : u.push({
            role: "model",
            parts: []
        }), a && a.length > 0 ? this.history.push(...rh(a)) : this.history.push(t), this.history.push(...u)
    }
}
/**
 * @license
...
class wa extends Error {
    constructor(t) {
        super(t.message), this.name = "ApiError", this.status = t.status, Object.setPrototypeOf(this, wa.prototype)
    }
}
/**
 * @license
...
function _S(i) {
    const t = {},
        l = r(i, ["name"]);
    return l != null && c(t, ["_url", "file"], Gh(l)), t
}
...
class IS extends pn {
    constructor(t) {
        super(), this.apiClient = t, this.list = async (l = {}) => new ri(dn.PAGED_ITEM_FILES, a => this.listInternal(a), await this.listInternal(l), l)
    }
    async upload(t) {
...
function DS(i) {
    ...
    if (l != null) {
        let u = l;
        Array.isArray(u) && (u = u.map(f => YS(f))), c(t, ["parts"], u)
    }
    const a = r(i, ["role"]);
    return a != null && c(t, ["role"], a), t
}
...
function bS(i) {
    ...
    U != null && c(t, ["responseModalities"], U);
    const H = r(i, ["responseSchema"]);
    H != null && c(t, ["responseSchema"], H);
    const b = r(i, ["routingConfig"]);
    b != null && c(t, ["routingConfig"], b);
    const P = r(i, ["seed"]);
    P != null && c(t, ["seed"], P);
    const X = r(i, ["speechConfig"]);
    X != null && c(t, ["speechConfig"], X);
    const k = r(i, ["stopSequences"]);
    k != null && c(t, ["stopSequences"], k);
    const K = r(i, ["temperature"]);
...
function HS(i, t) {
    ...
    t !== void 0 && S != null && c(t, ["setup", "generationConfig", "speechConfig"], wu(S));
    ...
    const U = r(i, ["systemInstruction"]);
    t !== void 0 && U != null && c(t, ["setup", "systemInstruction"], DS(nt(U)));
    const H = r(i, ["tools"]);
    if (t !== void 0 && H != null) {
        let te = ji(H);
        Array.isArray(te) && (te = te.map(F => XS(Wi(F)))), c(t, ["setup", "tools"], te)
    }
    const b = r(i, ["sessionResumption"]);
    t !== void 0 && b != null && c(t, ["setup", "sessionResumption"], JS(b));
    const P = r(i, ["inputAudioTranscription"]);
    t !== void 0 && P != null && c(t, ["setup", "inputAudioTranscription"], P);
    const X = r(i, ["outputAudioTranscription"]);
    t !== void 0 && X != null && c(t, ["setup", "outputAudioTranscription"], X);
    const k = r(i, ["realtimeInputConfig"]);
    t !== void 0 && k != null && c(t, ["setup", "realtimeInputConfig"], k);
    const K = r(i, ["contextWindowCompression"]);
...
function qS(i, t) {
    const l = {},
        a = r(i, ["generationConfig"]);
    t !== void 0 && a != null && c(t, ["setup", "generationConfig"], bS(a));
    const u = r(i, ["responseModalities"]);
    t !== void 0 && u != null && c(t, ["setup", "generationConfig", "responseModalities"], u);
    const f = r(i, ["temperature"]);
    t !== void 0 && f != null && c(t, ["setup", "generationConfig", "temperature"], f);
    ...
    t !== void 0 && C != null && c(t, ["setup", "generationConfig", "enableAffectiveDialog"], C);
    const U = r(i, ["systemInstruction"]);
    t !== void 0 && U != null && c(t, ["setup", "systemInstruction"], nt(U));
    const H = r(i, ["tools"]);
    if (t !== void 0 && H != null) {
        let F = ji(H);
        Array.isArray(F) && (F = F.map(he => KS(Wi(he)))), c(t, ["setup", "tools"], F)
    }
    const b = r(i, ["sessionResumption"]);
    t !== void 0 && b != null && c(t, ["setup", "sessionResumption"], b);
    const P = r(i, ["inputAudioTranscription"]);
    t !== void 0 && P != null && c(t, ["setup", "inputAudioTranscription"], P);
    const X = r(i, ["outputAudioTranscription"]);
    t !== void 0 && X != null && c(t, ["setup", "outputAudioTranscription"], X);
...
function VS(i, t) {
    ...
    const u = r(t, ["config"]);
    return u != null && c(l, ["config"], HS(u, l)), l
}
...
function zS(i, t) {
    ...
    a != null && c(l, ["setup", "model"], Te(i, a));
    const u = r(t, ["config"]);
    return u != null && c(l, ["config"], qS(u, l)), l
}
...
function kS(i) {
    ...
    if (l != null) {
        let h = xh(l);
        Array.isArray(h) && (h = h.map(v => Ra(v))), c(t, ["mediaChunks"], h)
    }
    const a = r(i, ["audio"]);
    a != null && c(t, ["audio"], Ra(wh(a)));
    const u = r(i, ["audioStreamEnd"]);
    u != null && c(t, ["audioStreamEnd"], u);
    const f = r(i, ["video"]);
    f != null && c(t, ["video"], Ra(Uh(f)));
    const m = r(i, ["text"]);
    m != null && c(t, ["text"], m);
...
function OS(i) {
    ...
    const a = r(i, ["audio"]);
    a != null && c(t, ["audio"], wh(a));
    const u = r(i, ["audioStreamEnd"]);
    u != null && c(t, ["audioStreamEnd"], u);
    const f = r(i, ["video"]);
    f != null && c(t, ["video"], Uh(f));
    const m = r(i, ["text"]);
    m != null && c(t, ["text"], m);
    const g = r(i, ["activityStart"]);
    g != null && c(t, ["activityStart"], g);
...
function YS(i) {
    ...
    u != null && c(t, ["executableCode"], u);
    const f = r(i, ["fileData"]);
    f != null && c(t, ["fileData"], xS(f));
    const m = r(i, ["functionCall"]);
    m != null && c(t, ["functionCall"], US(m));
    const g = r(i, ["functionResponse"]);
    g != null && c(t, ["functionResponse"], g);
    const y = r(i, ["inlineData"]);
    y != null && c(t, ["inlineData"], Ra(y));
    const h = r(i, ["text"]);
    h != null && c(t, ["text"], h);
    const v = r(i, ["thought"]);
    v != null && c(t, ["thought"], v);
...
function XS(i) {
    ...
    if (m != null && c(t, ["codeExecution"], m), r(i, ["enterpriseWebSearch"]) !== void 0) throw new Error("enterpriseWebSearch parameter is not supported in Gemini API.");
    const g = r(i, ["googleMaps"]);
    g != null && c(t, ["googleMaps"], LS(g));
    const y = r(i, ["googleSearch"]);
    y != null && c(t, ["googleSearch"], GS(y));
    const h = r(i, ["urlContext"]);
    return h != null && c(t, ["urlContext"], h), t
}
...
function KS(i) {
    ...
    if (l != null) {
        let S = l;
        Array.isArray(S) && (S = S.map(E => wS(E))), c(t, ["functionDeclarations"], S)
    }
    const a = r(i, ["retrieval"]);
    a != null && c(t, ["retrieval"], a);
    const u = r(i, ["googleSearchRetrieval"]);
...
function QS(i) {
    ...
    if (y != null) {
        let C = y;
        Array.isArray(C) && (C = C.map(U => U)), c(t, ["promptTokensDetails"], C)
    }
    const h = r(i, ["cacheTokensDetails"]);
    if (h != null) {
        let C = h;
        Array.isArray(C) && (C = C.map(U => U)), c(t, ["cacheTokensDetails"], C)
    }
    const v = r(i, ["candidatesTokensDetails"]);
    if (v != null) {
        let C = v;
        Array.isArray(C) && (C = C.map(U => U)), c(t, ["responseTokensDetails"], C)
    }
    const S = r(i, ["toolUsePromptTokensDetails"]);
    if (S != null) {
        let C = S;
        Array.isArray(C) && (C = C.map(U => U)), c(t, ["toolUsePromptTokensDetails"], C)
    }
...
function $S(i) {
    ...
    l != null && c(t, ["content"], l);
    const a = r(i, ["citationMetadata"]);
    a != null && c(t, ["citationMetadata"], WS(a));
    const u = r(i, ["tokenCount"]);
    u != null && c(t, ["tokenCount"], u);
    const f = r(i, ["finishReason"]);
    f != null && c(t, ["finishReason"], f);
...
function tE(i) {
    ...
    return a != null && c(t, ["statistics"], nE(a)), t
}
...
function ba(i) {
    ...
    if (l != null) {
        let u = l;
        Array.isArray(u) && (u = u.map(f => f_(f))), c(t, ["parts"], u)
    }
    const a = r(i, ["role"]);
    return a != null && c(t, ["role"], a), t
}
...
function lE(i, t) {
    ...
    t !== void 0 && a != null && c(t, ["systemInstruction"], nt(a));
    const u = r(i, ["tools"]);
    if (t !== void 0 && u != null) {
        let m = u;
        Array.isArray(m) && (m = m.map(g => Jh(g))), c(t, ["tools"], m)
    }
    const f = r(i, ["generationConfig"]);
    return t !== void 0 && f != null && c(t, ["generationConfig"], ZE(f)), l
}
...
function aE(i, t) {
    ...
    if (u != null) {
        let m = Gt(u);
        Array.isArray(m) && (m = m.map(g => ba(g))), c(l, ["contents"], m)
    }
    const f = r(t, ["config"]);
    return f != null && oE(f), l
}
...
function mE(i, t) {
    ...
    t !== void 0 && U != null && c(t, ["parameters", "outputOptions", "mimeType"], U);
    const H = r(i, ["outputCompressionQuality"]);
    t !== void 0 && H != null && c(t, ["parameters", "outputOptions", "compressionQuality"], H);
    const b = r(i, ["addWatermark"]);
    t !== void 0 && b != null && c(t, ["parameters", "addWatermark"], b);
    const P = r(i, ["labels"]);
    t !== void 0 && P != null && c(t, ["labels"], P);
    const X = r(i, ["editMode"]);
    t !== void 0 && X != null && c(t, ["parameters", "editMode"], X);
    const k = r(i, ["baseSteps"]);
    return t !== void 0 && k != null && c(t, ["parameters", "editConfig", "baseSteps"], k), l
}
...
function hE(i, t) {
    ...
    if (f != null) {
        let g = f;
        Array.isArray(g) && (g = g.map(y => y_(y))), c(l, ["instances[0]", "referenceImages"], g)
    }
    const m = r(t, ["config"]);
    return m != null && mE(m, l), l
}
...
function gE(i) {
    ...
    if (a != null) {
        let u = a;
        Array.isArray(u) && (u = u.map(f => La(f))), c(t, ["generatedImages"], u)
    }
    return t
}
...
function _E(i) {
    ...
    if (a != null) {
        let f = a;
        Array.isArray(f) && (f = f.map(m => tE(m))), c(t, ["embeddings"], f)
    }
    const u = r(i, ["metadata"]);
    return u != null && c(t, ["metadata"], u), t
}
...
function IE(i, t, l) {
    const a = {},
        u = r(t, ["systemInstruction"]);
    l !== void 0 && u != null && c(l, ["systemInstruction"], ba(nt(u)));
    const f = r(t, ["temperature"]);
    f != null && c(a, ["temperature"], f);
    const m = r(t, ["topP"]);
    m != null && c(a, ["topP"], m);
    ...
    if (l !== void 0 && k != null) {
        let Ee = k;
        Array.isArray(Ee) && (Ee = Ee.map(Be => v_(Be))), c(l, ["safetySettings"], Ee)
    }
    const K = r(t, ["tools"]);
    if (l !== void 0 && K != null) {
        let Ee = ji(K);
        Array.isArray(Ee) && (Ee = Ee.map(Be => R_(Wi(Be)))), c(l, ["tools"], Ee)
    }
    const ee = r(t, ["toolConfig"]);
    if (l !== void 0 && ee != null && c(l, ["toolConfig"], A_(ee)), r(t, ["labels"]) !== void 0) throw new Error("labels parameter is not supported in Gemini API.");
    const te = r(t, ["cachedContent"]);
    l !== void 0 && te != null && c(l, ["cachedContent"], mn(i, te));
    const F = r(t, ["responseModalities"]);
    F != null && c(a, ["responseModalities"], F);
...
function DE(i, t, l) {
    const a = {},
        u = r(t, ["systemInstruction"]);
    l !== void 0 && u != null && c(l, ["systemInstruction"], nt(u));
    const f = r(t, ["temperature"]);
    f != null && c(a, ["temperature"], f);
    const m = r(t, ["topP"]);
    m != null && c(a, ["topP"], m);
    ...
    P != null && c(a, ["responseSchema"], xu(P));
    const X = r(t, ["responseJsonSchema"]);
    X != null && c(a, ["responseJsonSchema"], X);
    const k = r(t, ["routingConfig"]);
    k != null && c(a, ["routingConfig"], k);
    const K = r(t, ["modelSelectionConfig"]);
    K != null && c(a, ["modelConfig"], K);
    const ee = r(t, ["safetySettings"]);
    if (l !== void 0 && ee != null) {
        let L = ee;
        Array.isArray(L) && (L = L.map(O => O)), c(l, ["safetySettings"], L)
    }
    const te = r(t, ["tools"]);
    if (l !== void 0 && te != null) {
        let L = ji(te);
        Array.isArray(L) && (L = L.map(O => Jh(Wi(O)))), c(l, ["tools"], L)
    }
    ...
    l !== void 0 && W != null && c(l, ["cachedContent"], mn(i, W));
    ...
    Ge != null && c(a, ["speechConfig"], Uu(Ge));
    const Ee = r(t, ["audioTimestamp"]);
    Ee != null && c(a, ["audioTimestamp"], Ee);
    const Be = r(t, ["thinkingConfig"]);
    Be != null && c(a, ["thinkingConfig"], Be);
    const st = r(t, ["imageConfig"]);
    if (st != null && c(a, ["imageConfig"], n_(st)), r(t, ["enableEnhancedCivicAnswers"]) !== void 0) throw new Error("enableEnhancedCivicAnswers parameter is not supported in Vertex AI.");
    return a
}
...
function uh(i, t) {
    ...
    const f = r(t, ["config"]);
    return f != null && c(l, ["generationConfig"], IE(i, f, l)), l
}
...
function ch(i, t) {
    ...
    const f = r(t, ["config"]);
    return f != null && c(l, ["generationConfig"], DE(i, f, l)), l
}
...
function fh(i) {
    ...
    if (a != null) {
        let y = a;
        Array.isArray(y) && (y = y.map(h => $S(h))), c(t, ["candidates"], y)
    }
    const u = r(i, ["modelVersion"]);
    u != null && c(t, ["modelVersion"], u);
    const f = r(i, ["promptFeedback"]);
...
function UE(i, t) {
    ...
    const P = r(i, ["labels"]);
    t !== void 0 && P != null && c(t, ["labels"], P);
    const X = r(i, ["imageSize"]);
    t !== void 0 && X != null && c(t, ["parameters", "sampleImageSize"], X);
    const k = r(i, ["enhancePrompt"]);
    return t !== void 0 && k != null && c(t, ["parameters", "enhancePrompt"], k), l
}
...
function LE(i) {
    ...
    if (a != null) {
        let f = a;
        Array.isArray(f) && (f = f.map(m => JE(m))), c(t, ["generatedImages"], f)
    }
    const u = r(i, ["positivePromptSafetyAttributes"]);
    return u != null && c(t, ["positivePromptSafetyAttributes"], Fh(u)), t
}
...
function GE(i) {
    ...
    if (a != null) {
        let f = a;
        Array.isArray(f) && (f = f.map(m => La(m))), c(t, ["generatedImages"], f)
    }
    const u = r(i, ["positivePromptSafetyAttributes"]);
    return u != null && c(t, ["positivePromptSafetyAttributes"], Yh(u)), t
}
...
function HE(i, t) {
    ...
    t !== void 0 && v != null && c(t, ["instances[0]", "lastFrame"], Ga(v));
    const S = r(i, ["referenceImages"]);
    if (t !== void 0 && S != null) {
        let E = S;
        Array.isArray(E) && (E = E.map(C => V_(C))), c(t, ["instances[0]", "referenceImages"], E)
    }
...
function qE(i, t) {
    ...
    const U = r(i, ["generateAudio"]);
    t !== void 0 && U != null && c(t, ["parameters", "generateAudio"], U);
    const H = r(i, ["lastFrame"]);
    t !== void 0 && H != null && c(t, ["instances[0]", "lastFrame"], kt(H));
    const b = r(i, ["referenceImages"]);
    if (t !== void 0 && b != null) {
        let k = b;
        Array.isArray(k) && (k = k.map(K => z_(K))), c(t, ["instances[0]", "referenceImages"], k)
    }
    const P = r(i, ["mask"]);
    t !== void 0 && P != null && c(t, ["instances[0]", "mask"], q_(P));
    const X = r(i, ["compressionQuality"]);
    return t !== void 0 && X != null && c(t, ["parameters", "compressionQuality"], X), l
}
...
function VE(i) {
    ...
    f != null && c(t, ["error"], f);
    const m = r(i, ["response", "generateVideoResponse"]);
    return m != null && c(t, ["response"], kE(m)), t
}
...
function zE(i) {
    ...
    f != null && c(t, ["error"], f);
    const m = r(i, ["response"]);
    return m != null && c(t, ["response"], OE(m)), t
}
...
function PE(i, t) {
    ...
    u != null && c(l, ["instances[0]", "prompt"], u);
    const f = r(t, ["image"]);
    f != null && c(l, ["instances[0]", "image"], Ga(f));
    const m = r(t, ["video"]);
    m != null && c(l, ["instances[0]", "video"], Xh(m));
    const g = r(t, ["source"]);
    g != null && FE(g, l);
    const y = r(t, ["config"]);
    return y != null && HE(y, l), l
}
...
function BE(i, t) {
    ...
    u != null && c(l, ["instances[0]", "prompt"], u);
    const f = r(t, ["image"]);
    f != null && c(l, ["instances[0]", "image"], kt(f));
    const m = r(t, ["video"]);
    m != null && c(l, ["instances[0]", "video"], Kh(m));
    const g = r(t, ["source"]);
    g != null && YE(g, l);
    const y = r(t, ["config"]);
    return y != null && qE(y, l), l
}
...
function kE(i) {
    ...
    if (l != null) {
        let f = l;
        Array.isArray(f) && (f = f.map(m => KE(m))), c(t, ["generatedVideos"], f)
    }
    const a = r(i, ["raiMediaFilteredCount"]);
    a != null && c(t, ["raiMediaFilteredCount"], a);
    const u = r(i, ["raiMediaFilteredReasons"]);
...
function OE(i) {
    ...
    if (l != null) {
        let f = l;
        Array.isArray(f) && (f = f.map(m => QE(m))), c(t, ["generatedVideos"], f)
    }
    const a = r(i, ["raiMediaFilteredCount"]);
    a != null && c(t, ["raiMediaFilteredCount"], a);
    const u = r(i, ["raiMediaFilteredReasons"]);
...
function FE(i, t) {
    ...
    const u = r(i, ["image"]);
    t !== void 0 && u != null && c(t, ["instances[0]", "image"], Ga(u));
    const f = r(i, ["video"]);
    return t !== void 0 && f != null && c(t, ["instances[0]", "video"], Xh(f)), l
}
...
function YE(i, t) {
    ...
    t !== void 0 && a != null && c(t, ["instances[0]", "prompt"], a);
    const u = r(i, ["image"]);
    t !== void 0 && u != null && c(t, ["instances[0]", "image"], kt(u));
    const f = r(i, ["video"]);
    return t !== void 0 && f != null && c(t, ["instances[0]", "video"], Kh(f)), l
}

function JE(i) {
    const t = {},
        l = r(i, ["_self"]);
    l != null && c(t, ["image"], i_(l));
    const a = r(i, ["raiFilteredReason"]);
    a != null && c(t, ["raiFilteredReason"], a);
    const u = r(i, ["_self"]);
    return u != null && c(t, ["safetyAttributes"], Fh(u)), t
}

function La(i) {
    const t = {},
        l = r(i, ["_self"]);
    l != null && c(t, ["image"], Oh(l));
    const a = r(i, ["raiFilteredReason"]);
    a != null && c(t, ["raiFilteredReason"], a);
    const u = r(i, ["_self"]);
    u != null && c(t, ["safetyAttributes"], Yh(u));
    const f = r(i, ["prompt"]);
...
function KE(i) {
    const t = {},
        l = r(i, ["video"]);
    return l != null && c(t, ["video"], G_(l)), t
}

function QE(i) {
    const t = {},
        l = r(i, ["_self"]);
    return l != null && c(t, ["video"], H_(l)), t
}
...
function Ga(i) {
    ...
    l != null && c(t, ["bytesBase64Encoded"], Bn(l));
    const a = r(i, ["mimeType"]);
    return a != null && c(t, ["mimeType"], a), t
}
...
function kt(i) {
    ...
    a != null && c(t, ["bytesBase64Encoded"], Bn(a));
    const u = r(i, ["mimeType"]);
    return u != null && c(t, ["mimeType"], u), t
}
...
function o_(i, t, l) {
    ...
    return l !== void 0 && g != null && c(l, ["_url", "models_url"], Hh(i, g)), a
}
...
function a_(i, t) {
    const l = {},
        a = r(t, ["config"]);
    return a != null && o_(i, a, l), l
}

function s_(i, t) {
    const l = {},
        a = r(t, ["config"]);
    return a != null && l_(i, a, l), l
}
...
function r_(i) {
    ...
    if (u != null) {
        let f = qh(u);
        Array.isArray(f) && (f = f.map(m => gu(m))), c(t, ["models"], f)
    }
    return t
}
...
function u_(i) {
    ...
    if (u != null) {
        let f = qh(u);
        Array.isArray(f) && (f = f.map(m => yu(m))), c(t, ["models"], f)
    }
    return t
}
...
function gu(i) {
    ...
    const m = r(i, ["_self"]);
    m != null && c(t, ["tunedModelInfo"], M_(m));
    ...
    const C = r(i, ["topK"]);
    C != null && c(t, ["topK"], C);
    const U = r(i, ["thinking"]);
    return U != null && c(t, ["thinking"], U), t
}
...
function yu(i) {
    ...
    if (m != null) {
        let S = m;
        Array.isArray(S) && (S = S.map(E => CE(E))), c(t, ["endpoints"], S)
    }
    const g = r(i, ["labels"]);
    g != null && c(t, ["labels"], g);
    const y = r(i, ["_self"]);
    y != null && c(t, ["tunedModelInfo"], N_(y));
...
function f_(i) {
    ...
    u != null && c(t, ["executableCode"], u);
    const f = r(i, ["fileData"]);
    f != null && c(t, ["fileData"], AE(f));
    const m = r(i, ["functionCall"]);
    m != null && c(t, ["functionCall"], RE(m));
    const g = r(i, ["functionResponse"]);
    g != null && c(t, ["functionResponse"], g);
    const y = r(i, ["inlineData"]);
    y != null && c(t, ["inlineData"], ZS(y));
    const h = r(i, ["text"]);
    h != null && c(t, ["text"], h);
    const v = r(i, ["thought"]);
    v != null && c(t, ["thought"], v);
...
function d_(i) {
    const t = {},
        l = r(i, ["productImage"]);
    return l != null && c(t, ["image"], kt(l)), t
}
...
function h_(i) {
    ...
    if (l != null) {
        let a = l;
        Array.isArray(a) && (a = a.map(u => La(u))), c(t, ["generatedImages"], a)
    }
    return t
}
...
function g_(i, t) {
    ...
    t !== void 0 && u != null && c(t, ["instances[0]", "personImage", "image"], kt(u));
    const f = r(i, ["productImages"]);
    if (t !== void 0 && f != null) {
        let m = f;
        Array.isArray(m) && (m = m.map(g => d_(g))), c(t, ["instances[0]", "productImages"], m)
    }
    return l
}
...
function y_(i) {
    ...
    l != null && c(t, ["referenceImage"], kt(l));
    ...
    f != null && c(t, ["maskImageConfig"], c_(f));
    const m = r(i, ["controlImageConfig"]);
    m != null && c(t, ["controlImageConfig"], iE(m));
...
function __(i) {
    ...
    if (l != null) {
        let a = l;
        Array.isArray(a) && (a = a.map(u => XE(u))), c(t, ["generatedMasks"], a)
    }
    return t
}
...
function C_(i, t) {
    ...
    return t !== void 0 && f != null && c(t, ["instances[0]", "scribble"], T_(f)), l
}

function A_(i) {
    const t = {},
        l = r(i, ["functionCallingConfig"]);
    l != null && c(t, ["functionCallingConfig"], ME(l));
    const a = r(i, ["retrievalConfig"]);
    return a != null && c(t, ["retrievalConfig"], a), t
}
...
function R_(i) {
    ...
    if (m != null && c(t, ["codeExecution"], m), r(i, ["enterpriseWebSearch"]) !== void 0) throw new Error("enterpriseWebSearch parameter is not supported in Gemini API.");
    const g = r(i, ["googleMaps"]);
    g != null && c(t, ["googleMaps"], jE(g));
    const y = r(i, ["googleSearch"]);
    y != null && c(t, ["googleSearch"], e_(y));
    const h = r(i, ["urlContext"]);
    return h != null && c(t, ["urlContext"], h), t
}
...
function Jh(i) {
    ...
    if (l != null) {
        let S = l;
        Array.isArray(S) && (S = S.map(E => NE(E))), c(t, ["functionDeclarations"], S)
    }
    const a = r(i, ["retrieval"]);
    a != null && c(t, ["retrieval"], a);
    const u = r(i, ["googleSearchRetrieval"]);
...
function J_(i) {
    ...
    f != null && c(t, ["error"], f);
    const m = r(i, ["response"]);
    return m != null && c(t, ["response"], K_(m)), t
}
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const eC = "Content-Type",
    tC = "X-Server-Timeout",
    nC = "User-Agent",
    vu = "x-goog-api-client",
    iC = "1.34.0",
    oC = `google-genai-sdk/${iC}`,
    lC = "v1beta1",
    aC = "v1beta";
class sC {
    constructor(t) {
        ...
        const u = {};
        this.clientOptions.vertexai ? (u.apiVersion = (l = this.clientOptions.apiVersion) !== null && l !== void 0 ? l : lC, u.baseUrl = this.baseUrlFromProjectLocation(), this.normalizeAuthParameters()) : (u.apiVersion = (a = this.clientOptions.apiVersion) !== null && a !== void 0 ? a : aC, u.baseUrl = "https://generativelanguage.googleapis.com/"), u.headers = this.getDefaultHeaders(), this.clientOptions.httpOptions = u, t.httpOptions && (this.clientOptions.httpOptions = this.patchHttpOptions(u, t.httpOptions))
    }
    ...
    async includeExtraHttpOptionsToRequestInit(t, l, a, u) {
        ...
        return l && l.extraBody !== null && rC(t, l.extraBody), t.headers = await this.getHeadersInternal(l, a), t
    }
    async unaryApiCall(t, l, a) {
        return this.apiCall(t.toString(), Object.assign(Object.assign({}, l), {
            method: a
        })).then(async u => (await ph(u), new pu(u))).catch(u => {
    ...
    async streamApiCall(t, l, a) {
        return this.apiCall(t.toString(), Object.assign(Object.assign({}, l), {
            method: a
        })).then(async u => (await ph(u), this.processStreamResponse(u))).catch(u => {
            throw u instanceof Error ? u : new Error(JSON.stringify(u))
        })
    }
...
`];
                for (;;) {
                    ...
                    try {
                        ...
                        if ("error" in U) {
                            const H = JSON.parse(JSON.stringify(U.error)),
                                b = H.status,
                                P = H.code,
                                X = `got status: ${b}. ${JSON.stringify(U)}`;
                            if (P >= 400 && P < 600) throw new wa({
                                message: X,
                                status: P
                            })
                        }
                    } catch (U) {
                        if (U.name === "ApiError") throw U
                    }
                    m += S;
                    let E = -1,
                        C = 0;
                    for (;;) {
                        ...
                        const H = U.trim();
                        if (H.startsWith(g)) {
                            const b = H.substring(g.length).trim();
                            try {
                                const P = new Response(b, {
                                    headers: t == null ? void 0 : t.headers,
                                    status: t == null ? void 0 : t.status,
                                    statusText: t == null ? void 0 : t.statusText
                                });
                                yield yield oe(new pu(P))
                            } catch (P) {
                                throw new Error(`exception parsing stream chunk ${b}. ${P}`)
                            }
                        }
                    }
                }
    ...
    getDefaultHeaders() {
        ...
        return t[nC] = l, t[vu] = l, t[eC] = "application/json", t
    }
    async getHeadersInternal(t, l) {
        const a = new Headers;
        if (t && t.headers) {
            for (const [u, f] of Object.entries(t.headers)) a.append(u, f);
            t.timeout && t.timeout > 0 && a.append(tC, String(Math.ceil(t.timeout / 1e3)))
        }
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const uC = "mcp_used/unknown";
let cC = !1;

function Zh(i) {
    for (const t of i)
        if (fC(t) || typeof t == "object" && "inputSchema" in t) return !0;
    return cC
}

function $h(i) {
    var t;
    const l = (t = i[vu]) !== null && t !== void 0 ? t : "";
    i[vu] = (l + ` ${uC}`).trimStart()
}
...
function dC(i) {
    return Pt(this, arguments, function*(l, a = 100) {
        let u, f = 0;
        for (; f < a;) {
...
class bu {
    ...
    async initialize() {
        ...
        for (const v of this.mcpClients) try {
            for (var g = !0, y = (l = void 0, Bt(dC(v))), h; h = await y.next(), t = h.done, !t; g = !0) {
                u = h.value, g = !1;
                const S = u;
                m.push(S);
                const E = S.name;
    ...
    async tool() {
        return await this.initialize(), F0(this.mcpTools, this.config)
    }
    async callTool(t) {
    ...
    async connect(t) {
        ...
        const v = new Promise(k => {
            ...
            U = {
                ...
                onerror: (l = S == null ? void 0 : S.onerror) !== null && l !== void 0 ? l : function(k) {},
                onclose: (a = S == null ? void 0 : S.onclose) !== null && a !== void 0 ? a : function(k) {}
            },
            H = this.webSocketFactory.create(y, gC(m), U);
        H.connect(), await v;
        const X = {
            setup: {
        ...
        return H.send(JSON.stringify(X)), new hC(H, this.apiClient)
    }
}
class hC {
    constructor(t, l) {
    ...
    play() {
        this.sendPlaybackControl(Ki.PLAY)
    }
    pause() {
        this.sendPlaybackControl(Ki.PAUSE)
    }
    stop() {
        this.sendPlaybackControl(Ki.STOP)
    }
    resetContext() {
        this.sendPlaybackControl(Ki.RESET_CONTEXT)
    }
    close() {
        this.conn.close()
    }
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const vC = "FunctionResponse request must have an `id` field from the response of a ToolCall.FunctionalCalls in Google AI.";
async function TC(i, t, l) {
    const a = new G0;
    let u;
...
class SC {
    constructor(t, l, a) {
        this.apiClient = t, this.auth = l, this.webSocketFactory = a, this.music = new mC(this.apiClient, this.auth, this.webSocketFactory)
    }
    async connect(t) {
        var l, a, u, f, m, g;
        ...
        t.config && t.config.tools && Zh(t.config.tools) && $h(S);
        const E = AC(S);
        ...
        const U = new Promise(W => {
            ...
            k = this.webSocketFactory.create(v, CC(E), X);
        k.connect(), await U;
        ...
        return this.apiClient.isVertexAI() ? ee = zS(this.apiClient, he) : ee = VS(this.apiClient, he), delete ee.config, k.send(JSON.stringify(ee)), new _C(k, this.apiClient)
    }
    isCallableTool(t) {
...
class _C {
    ...
    tLiveClientContent(t, l) {
        if (l.turns !== null && l.turns !== void 0) {
            let a = [];
            try {
                a = Gt(l.turns), t.isVertexAI() || (a = a.map(u => ba(u)))
            } catch {
    ...
    tLiveClienttToolResponse(t, l) {
        ...
        for (const f of a) {
            ...
            if (!t.isVertexAI() && !("id" in f)) throw new Error(vC)
        }
        return {
            toolResponse: {
                functionResponses: a
    ...
    sendClientContent(t) {
        t = Object.assign(Object.assign({}, EC), t);
...
function RC(i) {
    var t, l, a;
    return (a = (l = (t = i.config) === null || t === void 0 ? void 0 : t.tools) === null || l === void 0 ? void 0 : l.some(u => $i(u))) !== null && a !== void 0 ? a : !1
}
...
class MC extends pn {
    constructor(t) {
        super(), this.apiClient = t, this.generateContent = async l => {
            ...
            if (this.maybeMoveToResponseJsonSchem(l), !RC(l) || hh(l.config)) return await this.generateContentInternal(y);
            const h = gh(l);
            if (h.length > 0) {
                const H = h.map(b => `tools[${b}]`).join(", ");
            ...
            let v, S;
            const E = Gt(y.contents),
                C = (f = (u = (a = y.config) === null || a === void 0 ? void 0 : a.automaticFunctionCalling) === null || u === void 0 ? void 0 : u.maximumRemoteCalls) !== null && f !== void 0 ? f : mh;
            let U = 0;
            for (; U < C && (v = await this.generateContentInternal(y), !(!v.functionCalls || v.functionCalls.length === 0));) {
                const H = v.candidates[0].content,
                    b = [];
                for (const P of (g = (m = l.config) === null || m === void 0 ? void 0 : m.tools) !== null && g !== void 0 ? g : [])
                    if ($i(P)) {
                        const k = await P.callTool(v.functionCalls);
                        b.push(...k)
                    } U++, S = {
                    role: "user",
                    parts: b
                }, y.contents = Gt(y.contents), y.contents.push(H), y.contents.push(S), yh(y.config) && (E.push(H), E.push(S))
            }
            return yh(y.config) && (v.automaticFunctionCallingHistory = E), v
        }, this.generateContentStream = async l => {
            var a, u, f, m, g;
            if (this.maybeMoveToResponseJsonSchem(l), hh(l.config)) {
            ...
            return new ri(dn.PAGED_ITEM_MODELS, g => this.listInternal(g), await this.listInternal(m), m)
    ...
    async processParamsMaybeAddMcpUsage(t) {
        ...
        if (!f) return t;
        const m = await Promise.all(f.map(async y => $i(y) ? await y.tool() : y)),
            g = {
                model: t.model,
                contents: t.contents,
        ...
        if (g.config.tools = m, t.config && t.config.tools && Zh(t.config.tools)) {
            const y = (u = (a = t.config.httpOptions) === null || a === void 0 ? void 0 : a.headers) !== null && u !== void 0 ? u : {};
            let h = Object.assign({}, y);
            Object.keys(h).length === 0 && (h = this.apiClient.getDefaultHeaders()), $h(h), g.config.httpOptions = Object.assign(Object.assign({}, t.config.httpOptions), {
                headers: h
            })
        }
        return g
    ...
    async processAfcStream(t) {
        var l, a, u;
        const f = (u = (a = (l = t.config) === null || l === void 0 ? void 0 : l.automaticFunctionCalling) === null || a === void 0 ? void 0 : a.maximumRemoteCalls) !== null && u !== void 0 ? u : mh;
        let m = !1,
            g = 0;
        const y = await this.initAfcToolsMap(t);
        return (function(h, v, S) {
            return Pt(this, arguments, function*() {
                for (var E, C, U, H, b, P; g < f;) {
                    m && (g++, m = !1);
                    const ee = yield oe(h.processParamsMaybeAddMcpUsage(S)), te = yield oe(h.generateContentStreamInternal(ee)), F = [], he = [];
                    try {
                        for (var X = !0, k = (C = void 0, Bt(te)), K; K = yield oe(k.next()), E = K.done, !E; X = !0) {
                            H = K.value, X = !1;
                            const W = H;
                            if (yield yield oe(W), W.candidates && (!((b = W.candidates[0]) === null || b === void 0) && b.content)) {
                        ...
                        try {
                            !X && !E && (U = k.return) && (yield oe(U.call(k)))
                        } finally {
                            if (C) throw C.error
                        }
                    }
                    if (F.length > 0) {
                        ...
                        const Ce = Gt(S.contents).concat(de);
                        S.contents = Ce
                    } else break
                }
            })
        ...
        if (this.apiClient.isVertexAI()) {
            ...
            return g = J("{model}:streamGenerateContent?alt=sse", h._url), y = h._query, delete h._url, delete h._query, m = this.apiClient.requestStream({
                ...
                return Pt(this, arguments, function*() {
                    var E, C, U, H;
                    try {
                        for (var b = !0, P = Bt(S), X; X = yield oe(P.next()), E = X.done, !E; b = !0) {
                            H = X.value, b = !1;
                            const k = H,
                                K = dh(yield oe(k.json()));
                            K.sdkHttpResponse = {
                                headers: k.headers
                            };
                            const ee = new $o;
                        ...
                        try {
                            !b && !E && (U = P.return) && (yield oe(U.call(P)))
                        } finally {
                            if (C) throw C.error
                        }
                    }
    ...
    async get(t) {
        ...
        if (this.apiClient.isVertexAI()) {
            ...
            return g = J("{name}", h._url), y = h._query, delete h._url, delete h._query, m = this.apiClient.request({
                ...
                httpOptions: (l = t.config) === null || l === void 0 ? void 0 : l.httpOptions,
                abortSignal: (a = t.config) === null || a === void 0 ? void 0 : a.abortSignal
            }).then(v => v.json()), m.then(v => yu(v))
        } else {
            const h = $E(this.apiClient, t);
            return g = J("{name}", h._url), y = h._query, delete h._url, delete h._query, m = this.apiClient.request({
                path: g,
                queryParams: y,
                body: JSON.stringify(h),
...
function DC(i) {
    ...
    if (l != null) {
        let u = l;
        Array.isArray(u) && (u = u.map(f => VC(f))), c(t, ["parts"], u)
    }
    const a = r(i, ["role"]);
    return a != null && c(t, ["role"], a), t
}
...
function xC(i, t, l) {
    ...
    l !== void 0 && g != null && c(l, ["bidiGenerateContentSetup"], qC(i, g));
...
function UC(i, t) {
    const l = {},
        a = r(t, ["config"]);
    return a != null && c(l, ["config"], xC(i, a, l)), l
}
...
function HC(i, t) {
    ...
    t !== void 0 && C != null && c(t, ["setup", "generationConfig", "enableAffectiveDialog"], C);
    const U = r(i, ["systemInstruction"]);
    t !== void 0 && U != null && c(t, ["setup", "systemInstruction"], DC(nt(U)));
    const H = r(i, ["tools"]);
    if (t !== void 0 && H != null) {
        let te = ji(H);
        Array.isArray(te) && (te = te.map(F => PC(Wi(F)))), c(t, ["setup", "tools"], te)
    }
    const b = r(i, ["sessionResumption"]);
    t !== void 0 && b != null && c(t, ["setup", "sessionResumption"], zC(b));
    const P = r(i, ["inputAudioTranscription"]);
    t !== void 0 && P != null && c(t, ["setup", "inputAudioTranscription"], P);
    const X = r(i, ["outputAudioTranscription"]);
    t !== void 0 && X != null && c(t, ["setup", "outputAudioTranscription"], X);
...
function qC(i, t) {
    ...
    a != null && c(l, ["setup", "model"], Te(i, a));
    const u = r(t, ["config"]);
    return u != null && c(l, ["config"], HC(u, l)), l
}
...
function VC(i) {
    ...
    u != null && c(t, ["executableCode"], u);
    const f = r(i, ["fileData"]);
    f != null && c(t, ["fileData"], wC(f));
    const m = r(i, ["functionCall"]);
    m != null && c(t, ["functionCall"], bC(m));
    const g = r(i, ["functionResponse"]);
    g != null && c(t, ["functionResponse"], g);
    const y = r(i, ["inlineData"]);
    y != null && c(t, ["inlineData"], IC(y));
    const h = r(i, ["text"]);
    h != null && c(t, ["text"], h);
    const v = r(i, ["thought"]);
    v != null && c(t, ["thought"], v);
...
function PC(i) {
    ...
    if (m != null && c(t, ["codeExecution"], m), r(i, ["enterpriseWebSearch"]) !== void 0) throw new Error("enterpriseWebSearch parameter is not supported in Gemini API.");
    const g = r(i, ["googleMaps"]);
    g != null && c(t, ["googleMaps"], LC(g));
    const y = r(i, ["googleSearch"]);
    y != null && c(t, ["googleSearch"], GC(y));
    const h = r(i, ["urlContext"]);
    return h != null && c(t, ["urlContext"], h), t
}
/**
...
class ZC extends pn {
    constructor(t) {
        super(), this.apiClient = t, this.list = async l => new ri(dn.PAGED_ITEM_DOCUMENTS, a => this.listInternal({
            parent: l.parent,
            config: a.config
 ...
 */
class $C extends pn {
    constructor(t, l = new ZC(t)) {
        super(), this.apiClient = t, this.documents = l, this.list = async (a = {}) => new ri(dn.PAGED_ITEM_FILE_SEARCH_STORES, u => this.listInternal(u), await this.listInternal(a), a)
    }
...
let Wh = function() {
    ...
    if (i != null && i.randomUUID) return Wh = i.randomUUID.bind(i), i.randomUUID();
...
class at extends Ht {
    constructor(t, l, a, u) {
        super(`${at.makeMessage(t,l,a)}`), this.status = t, this.headers = u, this.error = l
    }
    ...
    static generate(t, l, a, u) {
        if (!t || !u) return new Ha({
            message: a,
            cause: Su(l)
        });
        const f = l;
        return t === 400 ? new eg(t, f, a, u) : t === 401 ? new tg(t, f, a, u) : t === 403 ? new ng(t, f, a, u) : t === 404 ? new ig(t, f, a, u) : t === 409 ? new og(t, f, a, u) : t === 422 ? new lg(t, f, a, u) : t === 429 ? new ag(t, f, a, u) : t >= 500 ? new sg(t, f, a, u) : new at(t, f, a, u)
    }
}
class Eu extends at {
    constructor({
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const jC = /^[a-z][a-z0-9+.-]*:/i,
    eA = i => jC.test(i);
let _u = i => (_u = Array.isArray, _u(i));
const tA = _u;
let nA = tA;
const vh = nA;
...
const lA = (i, t) => {
        if (typeof t != "number" || !Number.isInteger(t)) throw new Ht(`${i} must be an integer`);
        if (t < 0) throw new Ht(`${i} must be a positive integer`);
        return t
    },
    aA = i => {
        try {
...
const uA = () => {
    ...
    if (f === "deno") return {
        "X-Stainless-Lang": "js",
        "X-Stainless-Package-Version": Xi,
        "X-Stainless-OS": Sh(Deno.build.os),
        "X-Stainless-Arch": Th(Deno.build.arch),
    ...
    if (f === "node") return {
        "X-Stainless-Lang": "js",
        "X-Stainless-Package-Version": Xi,
        "X-Stainless-OS": Sh((l = globalThis.process.platform) !== null && l !== void 0 ? l : "unknown"),
        "X-Stainless-Arch": Th((a = globalThis.process.arch) !== null && a !== void 0 ? a : "unknown"),
...
const Th = i => i === "x32" ? "x32" : i === "x86_64" || i === "x64" ? "x64" : i === "arm" ? "arm" : i === "aarch64" || i === "arm64" ? "arm64" : i ? `other:${i}` : "unknown",
    Sh = i => (i = i.toLowerCase(), i.includes("ios") ? "iOS" : i === "android" ? "Android" : i === "darwin" ? "MacOS" : i === "win32" ? "Windows" : i === "freebsd" ? "FreeBSD" : i === "openbsd" ? "OpenBSD" : i === "linux" ? "Linux" : i ? `Other:${i}` : "Unknown");
let Ta;
const fA = () => Ta ?? (Ta = uA());
/**
 * @license
...
function uu(i, t, l) {
    return cg(), new File(i, t ?? "unknown_file", l)
}
...
const yA = i => i != null && typeof i == "object" && typeof i[Symbol.asyncIterator] == "function";
/**
 * @license
 * Copyright 2025 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
const fg = i => i != null && typeof i == "object" && typeof i.size == "number" && typeof i.type == "string" && typeof i.text == "function" && typeof i.slice == "function" && typeof i.arrayBuffer == "function",
    vA = i => i != null && typeof i == "object" && typeof i.name == "string" && typeof i.lastModified == "number" && fg(i),
    TA = i => i != null && typeof i == "object" && typeof i.url == "string" && typeof i.blob == "function";
async function SA(i, t, l) {
    if (cg(), i = await i, vA(i)) return i instanceof File ? i : uu([await i.arrayBuffer()], i.name);
    if (TA(i)) {
        const u = await i.blob();
        return t || (t = new URL(i.url).pathname.split(/[\\/]/).pop()), uu(await Cu(u), t, l)
    }
    const a = await Cu(i);
    if (t || (t = gA(i)), !(l != null && l.type)) {
...
async function Cu(i) {
    ...
    if (typeof i == "string" || ArrayBuffer.isView(i) || i instanceof ArrayBuffer) m.push(i);
    else if (fg(i)) m.push(i instanceof Blob ? i : await i.arrayBuffer());
    else if (yA(i)) try {
        for (var g = !0, y = Bt(i), h; h = await y.next(), t = h.done, !t; g = !0) {
            u = h.value, g = !1;
            const v = u;
            m.push(...await Cu(v))
        }
        ...
        throw new Error(`Unexpected data type: ${typeof i}${v?`; constructor: ${v}`:""}${EA(i)}`)
    }
    return m
}
...
const Eh = Object.freeze(Object.create(null)),
    _A = (i = pg) => (function(l, ...a) {
        ...
        const f = [],
            m = l.reduce((v, S, E) => {
                ...
                /[?#]/.test(S) && (u = !0);
                const b = a[E];
                let P = (u ? encodeURIComponent : i)("" + b);
                return E !== a.length && (b == null || typeof b == "object" && b.toString === ((H = Object.getPrototypeOf((U = Object.getPrototypeOf((C = b.hasOwnProperty) !== null && C !== void 0 ? C : Eh)) !== null && U !== void 0 ? U : Eh)) === null || H === void 0 ? void 0 : H.toString)) && (P = b + "", f.push({
                    start: v.length + S.length,
                    length: P.length,
                    error: `Value of type ${Object.prototype.toString.call(b).slice(8,-1)} is not a valid path parameter`
                })), v + S + (E === a.length ? "" : P)
            }, ""),
            g = m.split(/[?#]/, 1)[0],
        ...
        if (f.sort((v, S) => v.start - S.start), f.length > 0) {
            ...
            const S = f.reduce((E, C) => {
                const U = " ".repeat(C.start - v),
                    H = "^".repeat(C.length);
                return v = C.start + C.length, E + U + H
            }, "");
...
class mg extends dg {
    create(t, l) {
        ...
        } = t, f = Da(t, ["api_version"]);
        if ("model" in f && "agent_config" in f) throw new Ht("Invalid request: specified `model` and `agent_config`. If specifying `model`, use `generation_config`.");
        if ("agent" in f && "generation_config" in f) throw new Ht("Invalid request: specified `agent` and `generation_config`. If specifying `agent`, use `agent_config`.");
        return this._client.post(Sa`/${u}/interactions`, Object.assign(Object.assign({
            body: f
        }, l), {
    ...
    delete(t, l = {}, a) {
        ...
        return this._client.delete(Sa`/${u}/interactions/${t}`, a)
    }
    cancel(t, l = {}, a) {
        const {
            api_version: u = this._client.apiVersion
        } = l ?? {};
        return this._client.post(Sa`/${u}/interactions/${t}/cancel`, a)
    }
    get(t, l = {}, a) {
        var u;
        const f = l ?? {},
            ...
            g = Da(f, ["api_version"]);
        return this._client.get(Sa`/${m}/interactions/${t}`, Object.assign(Object.assign({
            query: g
        }, a), {
...
mg._key = Object.freeze(["interactions"]);
class hg extends mg {}
/**
 * @license
 * Copyright 2025 Google LLC
...
function Lu(i) {
    let t;
    return (Ea ?? (t = new globalThis.TextEncoder, Ea = t.encode.bind(t)))(i)
}
let _a;

function _h(i) {
    let t;
    return (_a ?? (t = new globalThis.TextDecoder, _a = t.decode.bind(t)))(i)
}
/**
 * @license
 * Copyright 2025 Google LLC
...
class qa {
    ...
    decode(t) {
        if (t == null) return [];
        const l = t instanceof ArrayBuffer ? new Uint8Array(t) : typeof t == "string" ? Lu(t) : t;
        this.buffer = CA([this.buffer, l]);
        const a = [];
        let u;
        for (;
            (u = AA(this.buffer, this.carriageReturnIndex)) != null;) {
            ...
            if (this.carriageReturnIndex != null && (u.index !== this.carriageReturnIndex + 1 || u.carriage)) {
                a.push(_h(this.buffer.subarray(0, this.carriageReturnIndex - 1))), this.buffer = this.buffer.subarray(this.carriageReturnIndex), this.carriageReturnIndex = null;
                continue
            }
            const f = this.carriageReturnIndex !== null ? u.preceding - 1 : u.preceding,
                m = _h(this.buffer.subarray(0, f));
...
const xa = {
    ...
    Ch = (i, t, l) => {
        if (i) {
            if (oA(xa, i)) return i;
            lt(l).warn(`${t} was set to ${JSON.stringify(i)}, expected one of ${JSON.stringify(Object.keys(xa))}`)
        }
    };
...
function Ca(i, t, l) {
    return !t || xa[i] > xa[l] ? el : t[i].bind(t)
}
const MA = {
    error: el,
    warn: el,
...
class Qi {
    ...
    static fromSSEResponse(t, l, a) {
        let u = !1;
        const f = a ? lt(a) : console;

        function m() {
            return Pt(this, arguments, function*() {
                var y, h, v, S;
                if (u) throw new Ht("Cannot iterate over a consumed stream, use `.tee()` to split the stream.");
                u = !0;
                let E = !1;
                try {
                    try {
                        for (var C = !0, U = Bt(NA(t, l)), H; H = yield oe(U.next()), y = H.done, !y; C = !0) {
                            S = H.value, C = !1;
                            const b = S;
                            if (!E)
                                if (b.data.startsWith("[DONE]")) {
                                    ...
                                    yield yield oe(JSON.parse(b.data))
                                } catch (P) {
                                    throw f.error("Could not parse message into JSON:", b.data), f.error("From chunk:", b.raw), P
                                }
                        }
                    } catch (b) {
                        h = {
                        ...
                        try {
                            !C && !y && (v = U.return) && (yield oe(v.call(U)))
                        } finally {
                            if (h) throw h.error
                        }
                    }
                    ...
                    if (Tu(b)) return yield oe(void 0);
                    throw b
                } finally {
                    E || l.abort()
                }
    ...
    static fromReadableStream(t, l, a) {
        ...
        function f() {
            return Pt(this, arguments, function*() {
                ...
                const E = new qa,
                    C = ug(t);
                try {
                    for (var U = !0, H = Bt(C), b; b = yield oe(H.next()), y = b.done, !y; U = !0) {
                        S = b.value, U = !1;
                        const P = S;
                        for (const X of E.decode(P)) yield yield oe(X)
                    }
                } catch (P) {
                    h = {
                        error: P
                    ...
                    try {
                        !U && !y && (v = H.return) && (yield oe(v.call(H)))
                    } finally {
                        if (h) throw h.error
                    }
                }
        ...
        function m() {
            return Pt(this, arguments, function*() {
                ...
                try {
                    try {
                        for (var C = !0, U = Bt(f()), H; H = yield oe(U.next()), y = H.done, !y; C = !0) {
                            S = H.value, C = !1;
                            const b = S;
                            E || b && (yield yield oe(JSON.parse(b)))
                        }
                    } catch (b) {
                        h = {
                            error: b
    ...
    tee() {
        ...
        return [new Qi(() => u(t), this.controller, this.client), new Qi(() => u(l), this.controller, this.client)]
    }
    toReadableStream() {
        const t = this;
        let l;
...
function NA(i, t) {
    return Pt(this, arguments, function*() {
        var a, u, f, m;
        if (!i.body) throw t.abort(), typeof globalThis.navigator < "u" && globalThis.navigator.product === "ReactNative" ? new Ht("The default react-native fetch implementation does not support streaming. Please use expo/fetch: https://docs.expo.dev/versions/latest/sdk/expo/#expofetch-api") : new Ht("Attempted to iterate over a response with no body");
        const g = new DA,
            y = new qa,
            h = ug(i.body);
        try {
            for (var v = !0, S = Bt(IA(h)), E; E = yield oe(S.next()), a = E.done, !a; v = !0) {
                m = E.value, v = !1;
                const C = m;
                for (const U of y.decode(C)) {
                    const H = g.decode(U);
                    H && (yield yield oe(H))
                }
            }
...
function IA(i) {
    return Pt(this, arguments, function*() {
        ...
        try {
            for (var g = !0, y = Bt(i), h; h = yield oe(y.next()), l = h.done, !l; g = !0) {
                f = h.value, g = !1;
                const v = f;
                if (v == null) continue;
                const S = v instanceof ArrayBuffer ? new Uint8Array(v) : typeof v == "string" ? Lu(v) : v;
                let E = new Uint8Array(m.length + S.length);
                E.set(m), E.set(S, m.length), m = E;
                let C;
                for (;
                    (C = RA(m)) !== -1;) yield yield oe(m.slice(0, C)), m = m.slice(C)
            }
        } catch (v) {
            a = {
                error: v
...
async function UA(i, t) {
    const {
        ...
        var g;
        if (t.options.stream) return lt(i).debug("response", l.status, l.url, l.headers, l.body), t.options.__streamClass ? t.options.__streamClass.fromSSEResponse(l, t.controller, i) : Qi.fromSSEResponse(l, t.controller, i);
    ...
    return lt(i).debug(`[${a}] response parsed`, si({
        retryOfRequestLogID: u,
        url: l.url,
        status: l.status,
        body: m,
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
class Gu extends Promise {
    constructor(t, l, a = UA) {
        super(u => {
            u(null)
        }), this.responsePromise = l, this.parseResponse = a, this.client = t
    }
    _thenUnwrap(t) {
        return new Gu(this.client, this.responsePromise, async (l, a) => t(await this.parseResponse(l, a), a))
    }
    asResponse() {
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
const gg = Symbol("brand.privateNullableHeaders");
...
function* wA(i) {
    ...
    let t = !1,
        l;
    i instanceof Headers ? l = i.entries() : vh(i) ? l = i : (t = !0, l = Object.entries(i ?? {}));
    for (let a of l) {
        const u = a[0];
        if (typeof u != "string") throw new TypeError("expected header name to be a string");
        const f = vh(a[1]) ? a[1] : [a[1]];
        let m = !1;
...
const cu = i => {
    var t, l, a, u, f, m;
    if (typeof globalThis.process < "u") return (a = (l = (t = o0) === null || t === void 0 ? void 0 : t[i]) === null || l === void 0 ? void 0 : l.trim()) !== null && a !== void 0 ? a : void 0;
...
class Va {
    constructor(t) {
        var l, a, u, f, m, g, y, {
                baseURL: h = cu("GEMINI_NEXT_GEN_API_BASE_URL"),
                apiKey: v = (l = cu("GEMINI_API_KEY")) !== null && l !== void 0 ? l : null,
                apiVersion: S = "v1beta"
            } = t,
            E = Da(t, ["baseURL", "apiKey", "apiVersion"]);
        ...
        this.baseURL = C.baseURL, this.timeout = (a = C.timeout) !== null && a !== void 0 ? a : Va.DEFAULT_TIMEOUT, this.logger = (u = C.logger) !== null && u !== void 0 ? u : console;
        const U = "warn";
        this.logLevel = U, this.logLevel = (m = (f = Ch(C.logLevel, "ClientOptions.logLevel", this)) !== null && f !== void 0 ? f : Ch(cu("GEMINI_NEXT_GEN_API_LOG"), "process.env['GEMINI_NEXT_GEN_API_LOG']", this)) !== null && m !== void 0 ? m : U, this.fetchOptions = C.fetchOptions, this.maxRetries = (g = C.maxRetries) !== null && g !== void 0 ? g : 2, this.fetch = (y = C.fetch) !== null && y !== void 0 ? y : dA(), this.encoder = hA, this._options = C, this.apiKey = v, this.apiVersion = S, this.clientAdapter = C.clientAdapter
    }
    withOptions(t) {
    ...
    validateHeaders({
        ...
        if (!(t.has("authorization") || t.has("x-goog-api-key")) && !(this.apiKey && t.get("x-goog-api-key")) && !l.has("x-goog-api-key")) throw new Error('Could not resolve authentication method. Expected the apiKey to be set. Or for the "x-goog-api-key" headers to be explicitly omitted')
    }
    async authHeaders(t) {
        const l = Wo([t.headers]);
        if (!(l.values.has("authorization") || l.values.has("x-goog-api-key"))) {
            if (this.apiKey) return Wo([{
                "x-goog-api-key": this.apiKey
            }]);
            if (this.clientAdapter.isVertexAI()) return Wo([await this.clientAdapter.getAuthHeaders()])
        }
    }
    stringifyQuery(t) {
        return Object.entries(t).filter(([l, a]) => typeof a < "u").map(([l, a]) => {
            ...
            throw new Ht(`Cannot stringify type ${typeof a}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`)
        }).join("&")
    }
    getUserAgent() {
        return `${this.constructor.name}/JS ${Xi}`
    }
    defaultIdempotencyKey() {
        return `stainless-node-retry-${WC()}`
    }
    makeStatusError(t, l, a, u) {
        return at.generate(t, l, a, u)
    }
    buildURL(t, l, a) {
        const u = !this.baseURLOverridden() && a || this.baseURL,
            f = eA(t) ? new URL(t) : new URL(u + (u.endsWith("/") && t.startsWith("/") ? t.slice(1) : t)),
            m = this.defaultQuery();
        return iA(m) || (l = Object.assign(Object.assign({}, m), l)), typeof l == "object" && l && !Array.isArray(l) && (f.search = this.stringifyQuery(l)), f.toString()
    }
    async prepareOptions(t) {
        if (this.clientAdapter && this.clientAdapter.isVertexAI() && !t.path.startsWith(`/${this.apiVersion}/projects/`)) {
            ...
            t.path = `/${this.apiVersion}/projects/${this.clientAdapter.getProject()}/locations/${this.clientAdapter.getLocation()}${l}`
        }
    }
    ...
    request(t, l = null) {
        return new Gu(this, this.makeRequest(t, l, void 0))
    }
    async makeRequest(t, l, a) {
        ...
        const E = "log_" + (Math.random() * (1 << 24) | 0).toString(16).padStart(6, "0"),
            ...
            U = Date.now();
        if (lt(this).debug(`[${E}] sending request`, si({
                retryOfRequestLogID: a,
                method: g.method,
                url: v,
                options: g,
                headers: h.headers
            })), !((f = g.signal) === null || f === void 0) && f.aborted) throw new Eu;
        const H = new AbortController,
            b = await this.fetchWithTimeout(v, h, S, H).catch(Su),
            P = Date.now();
        if (b instanceof globalThis.Error) {
            const k = `retrying, ${l} attempts remaining`;
            if (!((m = g.signal) === null || m === void 0) && m.aborted) throw new Eu;
            const K = Tu(b) || /timed? ?out/i.test(String(b) + ("cause" in b ? String(b.cause) : ""));
            if (l) return lt(this).info(`[${E}] connection ${K?"timed out":"failed"} - ${k}`), lt(this).debug(`[${E}] connection ${K?"timed out":"failed"} (${k})`, si({
                retryOfRequestLogID: a,
                url: v,
                durationMs: P - U,
                message: b.message
            })), this.retryRequest(g, l, a ?? E);
            throw lt(this).info(`[${E}] connection ${K?"timed out":"failed"} - error; no more retries left`), lt(this).debug(`[${E}] connection ${K?"timed out":"failed"} (error; no more retries left)`, si({
                retryOfRequestLogID: a,
                url: v,
                durationMs: P - U,
                message: b.message
        ...
        const X = `[${E}${C}] ${h.method} ${v} ${b.ok?"succeeded":"failed"} with status ${b.status} in ${P-U}ms`;
        if (!b.ok) {
            const k = await this.shouldRetry(b);
            if (l && k) {
                const W = `retrying, ${l} attempts remaining`;
                return await mA(b.body), lt(this).info(`${X} - ${W}`), lt(this).debug(`[${E}] response error (${W})`, si({
                    retryOfRequestLogID: a,
                    url: b.url,
                    status: b.status,
                    headers: b.headers,
                    durationMs: P - U
                })), this.retryRequest(g, l, a ?? E, b.headers)
            }
            const K = k ? "error; no more retries left" : "error; not retryable";
            lt(this).info(`${X} - ${K}`);
            const ee = await b.text().catch(W => Su(W).message),
                te = aA(ee),
                F = te ? void 0 : ee;
            throw lt(this).debug(`[${E}] response error (${K})`, si({
                retryOfRequestLogID: a,
                url: b.url,
                status: b.status,
                headers: b.headers,
            ...
            })), this.makeStatusError(b.status, te, F, b.headers)
        }
        return lt(this).info(X), lt(this).debug(`[${E}] response start`, si({
            retryOfRequestLogID: a,
            url: b.url,
            status: b.status,
            headers: b.headers,
    ...
    async retryRequest(t, l, a, u) {
        ...
        return await sA(m), this.makeRequest(t, l - 1, a)
    }
    ...
    async buildRequest(t, {
        ...
        "timeout" in m && lA("timeout", m.timeout), m.timeout = (a = m.timeout) !== null && a !== void 0 ? a : this.timeout;
        const {
            bodyHeaders: E,
            body: C
        } = this.buildBody({
    ...
    async buildHeaders({
        ...
        const m = await this.authHeaders(t);
        let g = Wo([f, Object.assign(Object.assign({
            Accept: "application/json",
            "User-Agent": this.getUserAgent(),
            "X-Stainless-Retry-Count": String(u)
        }, t.timeout ? {
            "X-Stainless-Timeout": String(Math.trunc(t.timeout / 1e3))
        } : {}), fA()), this._options.defaultHeaders, a, t.headers, m]);
...
Va.DEFAULT_TIMEOUT = 6e4;
class Qe extends Va {
    constructor() {
        super(...arguments), this.interactions = new hg(this)
    }
}
yg = Qe;
Qe.GeminiNextGenAPIClient = yg;
Qe.GeminiNextGenAPIClientError = Ht;
Qe.APIError = at;
Qe.APIConnectionError = Ha;
Qe.APIConnectionTimeoutError = jh;
Qe.APIUserAbortError = Eu;
Qe.NotFoundError = ig;
Qe.ConflictError = og;
Qe.RateLimitError = ag;
Qe.BadRequestError = eg;
Qe.AuthenticationError = tg;
Qe.InternalServerError = sg;
Qe.PermissionDeniedError = ng;
Qe.UnprocessableEntityError = lg;
Qe.toFile = SA;
Qe.Interactions = hg;
/**
 * @license
...
function VA(i, t, l) {
    ...
    if (u === void 0 && (u = "SUPERVISED_FINE_TUNING"), u === "SUPERVISED_FINE_TUNING") {
        ...
        t !== void 0 && C != null && c(t, ["supervisedTuningSpec"], Rh(C))
    } else if (u === "PREFERENCE_TUNING") {
        const C = r(i, ["validationDataset"]);
        t !== void 0 && C != null && c(t, ["preferenceOptimizationSpec"], Rh(C))
    }
...
function YA(i, t) {
    const l = {},
        a = r(i, ["config"]);
    return a != null && OA(a, l), l
}

function JA(i, t) {
    const l = {},
        a = r(i, ["config"]);
    return a != null && FA(a, l), l
}
...
function XA(i, t) {
    ...
    if (f != null) {
        let m = f;
        Array.isArray(m) && (m = m.map(g => vg(g))), c(l, ["tuningJobs"], m)
    }
    return l
}
...
function KA(i, t) {
    ...
    if (f != null) {
        let m = f;
        Array.isArray(m) && (m = m.map(g => Au(g))), c(l, ["tuningJobs"], m)
    }
    return l
}
...
function vg(i, t) {
    ...
    const E = r(i, ["_self"]);
    return E != null && c(l, ["tunedModel"], QA(E)), l
}
...
function Au(i, t) {
    ...
    const b = r(i, ["preferenceOptimizationSpec"]);
    b != null && c(l, ["preferenceOptimizationSpec"], b);
    const P = r(i, ["tuningDataStats"]);
    P != null && c(l, ["tuningDataStats"], P);
    const X = r(i, ["encryptionSpec"]);
    X != null && c(l, ["encryptionSpec"], X);
    const k = r(i, ["partnerModelTuningSpec"]);
    k != null && c(l, ["partnerModelTuningSpec"], k);
    const K = r(i, ["customBaseModel"]);
...
class jA extends pn {
    constructor(t) {
        super(), this.apiClient = t, this.list = async (l = {}) => new ri(dn.PAGED_ITEM_TUNING_JOBS, a => this.listInternal(a), await this.listInternal(l), l), this.get = async l => await this.getInternal(l), this.tune = async l => {
            var a;
            if (this.apiClient.isVertexAI())
...
const tR = 1024 * 1024 * 8,
    nR = 3,
    iR = 1e3,
    oR = 2,
    Ua = "x-goog-upload-status";
async function lR(i, t, l) {
    var a;
    const u = await Tg(i, t, l),
...
async function Tg(i, t, l) {
    var a, u;
    let f = 0,
        m = 0,
        g = new pu(new Response),
        y = "upload";
    for (f = i.size; m < f;) {
        const h = Math.min(tR, f - m),
            v = i.slice(m, m + h);
        m + h >= f && (y += ", finalize");
        let S = 0,
            E = iR;
        for (; S < nR && (g = await l.request({
                path: "",
                body: v,
                httpMethod: "POST",
                httpOptions: {
            ...
            }), !(!((a = g == null ? void 0 : g.headers) === null || a === void 0) && a[Ua]));) S++, await rR(E), E = E * oR;
...
class uR {
    async upload(t, l, a) {
        ...
        return await lR(t, l, a)
    }
    async uploadToFileSearchStore(t, l, a) {
        if (typeof t == "string") throw new Error("File path is not supported in browser uploader.");
        return await aR(t, l, a)
    }
    async stat(t) {
        if (typeof t == "string") throw new Error("File path is not supported in browser uploader.");
        return await sR(t)
...
class Sg {
    ...
    constructor(t) {
        ...
        const a = r0(t.httpOptions, t.vertexai, void 0, void 0);
        a && (t.httpOptions ? t.httpOptions.baseUrl = a : t.httpOptions = {
            baseUrl: a
        }), this.apiVersion = t.apiVersion, this.httpOptions = t.httpOptions;
        const u = new dR(this.apiKey);
        this.apiClient = new sC({
            auth: u,
            apiVersion: this.apiVersion,
            apiKey: this.apiKey,
            vertexai: this.vertexai,
            httpOptions: this.httpOptions,
            userAgentExtra: pR + "web",
            uploader: new uR,
            downloader: new eR
        }), this.models = new MC(this.apiClient), this.live = new SC(this.apiClient, u, new cR), this.batches = new qT(this.apiClient), this.chats = new vS(this.models, this.apiClient), this.caches = new hS(this.apiClient), this.files = new IS(this.apiClient), this.operations = new NC(this.apiClient), this.authTokens = new OC(this.apiClient), this.tunings = new jA(this.apiClient), this.fileSearchStores = new $C(this.apiClient)
    }
}
const mR = async (i, t = "dreamy and poetic") => {
    const l = new Sg({
        apiKey: "PLACEHOLDER_API_KEY"
    });
    try {
        return (await l.models.generateContent({
            model: "gemini-3-flash-preview",
            contents: `You are a professional music publicist. Enhance the following indie-pop duo biography to be more ${t}, while keeping it concise (under 150 words). Current bio: "${i}"`,
            config: {
                temperature: .8,
                maxOutputTokens: 300
            }
        ...
        return console.error("Gemini AI error:", a), i
    }
}, hR = async (i, t, l) => {
    const a = new Sg({
        apiKey: "PLACEHOLDER_API_KEY"
    ...
    try {
        return (await a.models.generateContent({
            model: "gemini-3-flash-preview",
            contents: `Create a short, punchy email pitch (1-2 paragraphs) for a music editor about the indie-pop duo "${i}". Genre: ${t}. Bio context: ${l}. Include a subject line.`
        })).text || "Could not generate pitch."
    } catch (u) {
        return console.error("Gemini AI error:", u), "Error generating pitch."
    }
}, gR = () => {
    const [i, t] = jo.useState({
        name: "Lumina & Sky",
        genre: "Dreamy Indie-Pop",
        location: "Stockholm / Brooklyn",
        bio: "Formed amidst the neon glow of nocturnal cityscapes, Lumina & Sky blend ethereal synths with driving rhythmic pulses. Their sound captures the bittersweet nostalgia of late-summer sunsets and the quiet intimacy of morning light."
    }), [l, a] = jo.useState(!1), [u, f] = jo.useState(""), [m, g] = jo.useState(!1), y = [{
        id: "1",
        title: "Velvet Horizon",
        duration: "3:42",
        albumArt: "https://images.unsplash.com/photo-1614613535308-eb5fbd3d2c17?auto=format&fit=crop&q=80&w=300"
    }, {
        id: "2",
        title: "Neon Whispers",
        duration: "4:15",
        albumArt: "https://images.unsplash.com/photo-1493225255756-d9584f8606e9?auto=format&fit=crop&q=80&w=300"
    }, {
        id: "3",
        title: "Static Dreams",
        duration: "3:58",
        albumArt: "https://images.unsplash.com/photo-1459749411177-042180ce673c?auto=format&fit=crop&q=80&w=300"
    }], h = async () => {
        a(!0);
        const S = await mR(i.bio);
        t(E => ({
            ...E,
            bio: S
        })), a(!1)
        ...
        g(!0);
        const S = await hR(i.name, i.genre, i.bio);
        f(S), g(!1)
    };
    return B.jsxs("div", {
        className: "min-h-screen bg-pastel-pink/20 p-4 md:p-8 lg:p-12 font-light text-slate-800",
        children: [B.jsx(i0, {}), B.jsxs("div", {
            className: "max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch",
            children: [B.jsxs("div", {
                className: "lg:col-span-8 bg-white/60 backdrop-blur-xl rounded-[2.5rem] p-8 md:p-14 flex flex-col justify-between border border-white/40 shadow-sm overflow-hidden relative group",
                children: [B.jsx("div", {
                    className: "absolute top-0 right-0 w-80 h-80 bg-rose-200/30 blur-[100px] rounded-full -mr-20 -mt-20 group-hover:bg-rose-300/40 transition-colors duration-1000"
                }), B.jsxs("div", {
                    ...
                    children: [B.jsxs("div", {
                        ...
                        children: [B.jsxs("div", {
                            children: [B.jsx("span", {
                                className: "text-[10px] font-bold tracking-[0.5em] uppercase text-pink-500 mb-3 block",
                                children: "EPK Portfolio 2024"
                            }), B.jsxs("h1", {
                                className: "text-7xl md:text-9xl font-extralight tracking-tighter lowercase leading-[0.85]",
                                children: ["Lumina ", B.jsx("span", {
                                    className: "italic font-serif text-pink-300",
                                    children: "&"
                                }), " ", B.jsx("br", {}), " Sky"]
                            })]
                        }), B.jsxs("div", {
                            ...
                            children: [B.jsx("p", {
                                ...
                                className: "text-xs uppercase tracking-[0.3em] text-slate-400 mt-2",
                                children: i.location
                            })]
                        })]
                    }), B.jsx("div", {
                        ...
                        children: B.jsxs("div", {
                            ...
                            children: [B.jsx("textarea", {
                                ...
                                className: "w-full bg-transparent border-none focus:ring-0 text-2xl md:text-3xl leading-relaxed font-extralight text-slate-600 resize-none h-auto min-h-[180px] placeholder:text-slate-300",
                                ...
                                children: [B.jsxs("button", {
                                    onClick: h,
                                    disabled: l,
                                    className: "px-6 py-2.5 bg-white/80 text-pink-600 rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-pink-100 transition-all flex items-center gap-2 border border-pink-100",
                                    children: [B.jsx("span", {
                                        className: l ? "animate-pulse" : "",
                                        children: "✨"
                                    }), l ? "Refining..." : "AI Refine Bio"]
                                }), B.jsx("button", {
                                    onClick: v,
                                    disabled: m,
                                    className: "px-6 py-2.5 bg-slate-900 text-white rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-slate-700 transition-all shadow-lg shadow-slate-200",
                                    children: m ? "Drafting..." : "Quick Pitch"
                                })]
                            })]
                        })
                    })]
                }), B.jsxs("div", {
                    className: "relative z-10 mt-16 flex items-center gap-8 border-t border-slate-100 pt-10",
                    children: [B.jsxs("div", {
                        className: "flex -space-x-5",
                        children: [B.jsx("img", {
                            src: "https://images.unsplash.com/photo-1516726817505-f5ed17467134?auto=format&fit=crop&q=80&w=150",
                        ...
                        children: [B.jsx("p", {
                            ...
                            children: "hello@luminasky.com"
                        })]
                    })]
                })]
            }), B.jsxs("div", {
                className: "lg:col-span-4 bg-pastel-blue/40 backdrop-blur-xl rounded-[2.5rem] p-10 border border-white/40 shadow-sm flex flex-col",
                children: [B.jsx("h2", {
                    className: "text-[10px] font-bold uppercase tracking-[0.5em] text-blue-500 mb-10",
                    children: "Essential Tracks"
                }), B.jsx("div", {
                    className: "space-y-8 flex-grow",
                    children: y.map(S => B.jsxs("div", {
                        className: "flex items-center gap-5 group cursor-pointer",
                        children: [B.jsxs("div", {
                            className: "w-16 h-16 rounded-2xl overflow-hidden relative shadow-sm transition-transform group-hover:scale-105",
                            children: [B.jsx("img", {
                                src: S.albumArt,
                                ...
                                children: B.jsx("div", {
                                    ...
                                    children: B.jsx("div", {
                                        className: "w-0 h-0 border-t-[4px] border-t-transparent border-l-[7px] border-l-slate-900 border-b-[4px] border-b-transparent ml-0.5"
                                    })
                                })
                            })]
                        }), B.jsxs("div", {
                            children: [B.jsx("h3", {
                                ...
                                className: "text-[10px] uppercase tracking-widest text-slate-400 mt-1.5",
                                children: S.duration
                            })]
                        })]
                    }, S.id))
                }), B.jsx("button", {
                    className: "mt-10 w-full py-4 bg-white/60 text-slate-900 text-[10px] font-bold uppercase tracking-[0.4em] rounded-2xl border border-white hover:bg-white transition-all shadow-sm",
                    children: "Listen on Spotify"
                })]
            }), B.jsxs("div", {
                className: "lg:col-span-7 grid grid-cols-2 md:grid-cols-3 gap-4 h-full min-h-[500px]",
                children: [B.jsx("div", {
                    className: "col-span-2 row-span-2 rounded-[2rem] overflow-hidden group shadow-sm border border-white/20",
                    children: B.jsx("img", {
                    ...
                    className: "rounded-[2rem] overflow-hidden group shadow-sm border border-white/20",
                    children: B.jsx("img", {
                        src: "https://images.unsplash.com/photo-1526218626217-dc65a29bb444?auto=format&fit=crop&q=80&w=400",
                ...
                className: "lg:col-span-5 bg-white/60 rounded-[2.5rem] p-5 border border-white/40 shadow-sm overflow-hidden flex flex-col gap-5",
                children: [B.jsxs("div", {
                    ...
                    className: "h-40 bg-pastel-purple/40 rounded-[2rem] flex items-center justify-around px-8",
                    children: [B.jsxs("div", {
                        className: "text-center",
                        children: [B.jsx("p", {
                            className: "text-3xl font-extralight italic font-serif text-purple-600",
                            children: "1.5M"
                        }), B.jsx("p", {
                            className: "text-[8px] font-bold uppercase tracking-widest text-slate-400 mt-1",
                            children: "Streams"
                        })]
                    }), B.jsx("div", {
                        className: "w-[1px] h-12 bg-purple-200"
                    }), B.jsxs("div", {
                        className: "text-center",
                        children: [B.jsx("p", {
                            className: "text-3xl font-extralight italic font-serif text-purple-600",
                ...
                className: "lg:col-span-12 bg-slate-900 rounded-[3rem] p-10 md:p-14 text-white flex flex-col md:flex-row items-center justify-between gap-12 overflow-hidden relative",
                children: [B.jsx("div", {
                    className: "absolute left-0 bottom-0 w-64 h-64 bg-rose-500/10 blur-[100px] rounded-full"
                }), B.jsxs("div", {
                    className: "max-w-2xl relative z-10",
                    children: [B.jsx("h2", {
                        className: "text-[10px] font-bold uppercase tracking-[0.5em] text-pink-400 mb-8",
                        children: "Selected Press"
                    }), B.jsx("p", {
                        className: "text-3xl md:text-4xl font-extralight italic leading-tight mb-4",
                        children: '"Lumina & Sky create a sonic landscape that feels both intimate and infinite. A definitive voice in modern dream-pop."'
                    }), B.jsx("span", {
                        className: "text-[10px] uppercase tracking-[0.4em] text-slate-500",
                        children: "— Rolling Stone Online"
                    })]
                }), B.jsxs("div", {
                    className: "flex flex-col items-center md:items-end gap-10 relative z-10",
                    children: [B.jsx("div", {
                        className: "flex gap-6",
                        children: ["Instagram", "Spotify", "Youtube", "Twitter"].map(S => B.jsx("a", {
                            href: "#",
                            className: "text-[9px] font-bold uppercase tracking-[0.3em] text-slate-400 hover:text-white transition-all border-b border-transparent hover:border-slate-400 pb-1",
                            children: S
                        }, S))
                    }), B.jsxs("div", {
                        className: "flex items-center gap-4",
                        children: [B.jsx("span", {
                            className: "text-[8px] uppercase tracking-widest text-slate-500",
                            children: "Official Links"
                        }), B.jsx("div", {
                            className: "w-12 h-[1px] bg-slate-700"
                        })]
                    })]
                })]
            }), u && B.jsx("div", {
                className: "lg:col-span-12 animate-in fade-in slide-in-from-top-4 duration-700",
                children: B.jsxs("div", {
                    className: "bg-white/80 backdrop-blur-md rounded-[2.5rem] p-10 border border-blue-100 relative overflow-hidden shadow-xl",
                    children: [B.jsx("div", {
                        className: "absolute top-0 right-0 p-6",
                        children: B.jsx("button", {
                            onClick: () => f(""),
                            className: "w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-400 hover:bg-slate-200 transition-all text-xs",
                            children: "✕"
                        })
                    }), B.jsxs("div", {
                        ...
                        children: [B.jsx("span", {
                            ...
                            className: "text-[10px] font-bold tracking-[0.4em] uppercase text-blue-500",
                            children: "Drafted Publicist Pitch"
                        })]
                    }), B.jsx("div", {
                        className: "text-sm md:text-base font-mono text-slate-600 leading-relaxed max-w-5xl whitespace-pre-wrap bg-blue-50/30 p-8 rounded-3xl border border-blue-50",
                        children: u
                    }), B.jsx("button", {
                        className: "mt-8 px-8 py-3 bg-blue-500 text-white rounded-full text-[10px] font-bold uppercase tracking-widest hover:bg-blue-600 transition-all shadow-lg shadow-blue-200",
                        children: "Copy To Clipboard"
                    })]
                })
            })]
        }), B.jsx("footer", {
            className: "mt-20 text-center opacity-30 pb-12",
            children: B.jsxs("p", {
                className: "text-[8px] uppercase tracking-[1em]",
                children: ["Designed for Lumina & Sky • ", new Date().getFullYear()]
            })
        })]
    })
}, Eg = document.getElementById("root");
if (!Eg) throw new Error("Could not find root element to mount to");
const yR = n0.createRoot(Eg);
yR.render(B.jsx(Kv.StrictMode, {
    children: B.jsx(gR, {})
}));